...
function Notification_tab_parents(props) {
    ...
    const membership1 = () => {
        ...
        fetch(api + "/api/v1/parentsallcounts", requestOptions)
        ...
        <>
            <ul>
                <li className={props.subtab == "interview-invite" ? "active" : ""} onClick={e => {
                    ...
                    </svg> Interview Invites  ({recom.invitation})</li>
                <li className={props.subtab == "job-application" ? "active" : ""} onClick={e => {
                    window.scrollTo({ top: 0, behavior: 'smooth' })
                    ...
                    </svg> Job Applications ({recom.jobapplication})</li>
                <li className={props.subtab == "new-recommendation" ? "active" : ""} onClick={e => {
                    ...
                    </svg>Recommendation requests ({recom.recommendation})</li>
                <li className={props.subtab == "shared-document" ? "active" : ""} onClick={e => {
                    window.scrollTo({ top: 0, behavior: 'smooth' })
                    ...
                    </svg> Shared documents ({recom.shareddocument}) </li>
                ...
                <li className={props.subtab == "new-reviews" ? "active" : ""} onClick={e => {
                    ...
                    </svg> New Reviews ({recom.review})</li>
                <li className={props.subtab == "Loyalty-notification" ? "active" : ""} onClick={e => {
                    ...
                    </svg> SensCare Loyalty ({recom.loyalty})</li>
                <li className={props.subtab == "recent-profile-visitor" ? "active" : ""} onClick={e => {
                    ...
                    </svg> Recent profile visitors ({recom.visitor})</li>
            </ul>
        </>
    )
}

export default Notification_tab_parents
