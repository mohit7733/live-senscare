...
function Create_parent_profile() {
    ...
    var today = new Date();
    var fixdate = today.getFullYear() + "-" + String(today.getMonth() + 1).padStart(2, '0') + "-" + String(today.getDate()).padStart(2, '0')
    ...
    const profile_update = (a) => {
        ...
        detailparents.jobs != "" ? formdata.append("jobs[0][title]", detailparents.jobs) : formdata.append("about", detailparents.about);
        detailparents.jobs != "" ? formdata.append("jobs[0][description]", detailparents.jobs_description) : formdata.append("about", detailparents.about);
        detailparents.jobs != "" ? formdata.append("jobs[0][plateformonsocialmedia]", jobalready.plateformonsocialmedia) : formdata.append("about", detailparents.about);
        detailparents.jobs != "" ? formdata.append("jobs[0][job_type]", Object.values(detail.service_type)[0]) : formdata.append("about", detailparents.about);
        detailparents.jobs != "" ? formdata.append("jobs[0][job_id]", jobalready.id) : formdata.append("about", detailparents.about);
        detailparents.jobs2 != "" ? formdata.append("jobs[1][title]", detailparents.jobs2) : formdata.append("about", detailparents.about);
        detailparents.jobs_description2 != "" ? formdata.append("jobs[1][description]", detailparents.jobs_description2) : formdata.append("about", detailparents.about);

        jobalready.id2 != "" ? formdata.append("jobs[1][job_id]", jobalready.id2) : formdata.append("about", detailparents.about);
        detailparents.jobs2 != "" ? formdata.append("jobs[1][job_type]", Object.values(detail.service_type)[1]) : formdata.append("about", detailparents.about);
        detailparents.jobs2 != "" ? formdata.append("jobs[1][plateformonsocialmedia]", jobalready.plateformonsocialmedia2) : formdata.append("about", detailparents.about);
    ...
    const profile_data = () => {
        ...
        fetch(api + "/api/v1/details", requestOptions)
            ...
            .then(result => {
                ...
                result.data?.job[0] ?
                    setTimeout(() => {
                        setdetailparents({ ...detailparents, jobs: result.data.job[0].title, jobs_description: result.data.job[0].description, jobs2: result.data.job[1].title ? result.data.job[1].title : "", jobs_description2: result.data.job[1].description ? result.data.job[1].description : "" })
                        setjobalready({ ...jobalready, id: result.data.job[0].id, id2: result.data.job[1].id ? result.data.job[1].id : "", plateformonsocialmedia: result.data.job[0].plateformonsocialmedia != "" ? result.data.job[0].plateformonsocialmedia : "Yes", plateformonsocialmedia2: result.data.job[1].plateformonsocialmedia ? result.data.job[1].plateformonsocialmedia : "Yes" })
                    }, 900) : setjobalready({ ...jobalready })
                setstap(result.data.step != null ? parseInt(result.data.step) <= 7 ? result.data.job[0].plateformonsocialmedia ? 1 : parseInt(result.data.step) : 1 : 1)
            })
        ...
        switch (name) {
            ...
            case 'file_path':
                errorfield.file_path =
                    detailparents.file_path != '' ? "" : "required";
                break;
            ...
            case 'candidatespeaks':
                errorfield.candidatespeaks =
                    (oralspeak.English != "" || oralspeak.Spanish != "" || oralspeak.French != "" || oralspeak.Chinese != "" || oralspeak.German != "" || oralspeak.Italian != "" || oralspeak.Other != "")
                        ? ""
                        : "required";
                break;
    ...
    useEffect(() => {
        if (count) {
            profile_data()
            setcount(false)
            localStorage.getItem("user_type") == "parents" ? localStorage.getItem("user_type") : window.location.replace("/complete-provider-profile")
        }

        console.log(detailparents);
                    ...
                    <div className='Profile_complete'>
                        <div className='left'>
                            ...
                            <ul style={window.screen.width < 767 ? { transform: "translateX(" + mobile + "% )" } : {}}>
                                <li onClick={e => {
                                    if (detail.job[0].plateformonsocialmedia && detail.job[0].plateformonsocialmedia) {
                                        setstap(1)
                                    }
                        ...
                        <div className='right'>
                            <div className='detail parents1 stap1' style={stap == 1 ? {} : { "display": "none" }}>
                                <h2 className='border'>Welcome <span>{detail.username}</span>, please complete your profile </h2>
                                ...
                                <div className='form_group full'>
                                    ...
                                    <textarea rows={2} placeholder='Hello, we are a family of three and we love outdoor activities. We also have an adorable cat.' maxlength="150" name='message' defaultValue={detailparents.about} onChange={e => {
                                        setdetailparents({ ...detailparents, about: e.target.value })
                                        seterrorfield({ ...errorfield, about: "" })
                                    }} className={errorfield.about != "" ? "bordererror" : ""} ></textarea>
                                    {/* </textarea> */}
                                ...
                                <div className='form_group third'>
                                    ...
                                    <div className='upload'>
                                        <input type="file" placeholder="choose file" onChange={e => setdetailparents({ ...detailparents, video: e.target.files[0] })} accept="video/*" />
                            ...
                            {/**/}
                            <div className='detail job_performance your_kids stap2' style={stap == 2 ? {} : { "display": "none" }}>
                                <div className='left2'>
                                    <div className='form_group full'>
                                    ...
                                    <div className='form_group full'>
                                        ...
                                        <div className='text customselect '>
                                            {selectcat ?
                                                <span className='keyword' onClick={e => custom("cate", "over")} style={{
                                        ...
                                        <div className='customselect'>
                                            {/* <TranslateComponent text="Choose from the list" className='keyword' type="text" value={selectcat?.map((e) => {
                                                return e.name
                                            })} /> */}
                                            ...
                                            <div className='option' id='cate' onClick={e =>
                                                ...
                                                <p><input type="checkbox" checked={selectcat.filter((e) => e.name == "0 - 1 years")[0] ? true : false} onClick={a => selectoption("0 - 1 years")} /><h3 >
                                                    {"0 - 1 years"} </h3><span></span></p>
                                                <p><input type="checkbox" checked={selectcat.filter((e) => e.name == "1 - 3 years")[0] ? true : false} onClick={a => selectoption("1 - 3 years")} /><h3>
                                                    {"1 - 3 years"}</h3><span></span></p>
                                                <p><input type="checkbox" checked={selectcat.filter((e) => e.name == "4 - 7 years")[0] ? true : false} onClick={a => selectoption("4 - 7 years")} /><h3>
                                                    {"4 - 7 years"}</h3><span></span></p>
                                                <p><input type="checkbox" checked={selectcat.filter((e) => e.name == "8 - 10 years")[0] ? true : false} onClick={a => selectoption("8 - 10 years")} /><h3>
                                                    {"8 - 10 years"}  </h3><span></span></p>
                                                <p><input type="checkbox" checked={selectcat.filter((e) => e.name == "11 - 15 years")[0] ? true : false} onClick={a => selectoption("11 - 15 years")} /><h3>
                                                    {"11 - 15 years"} </h3><span></span></p>
                                                <p><input type="checkbox" checked={selectcat.filter((e) => e.name == "16+  years")[0] ? true : false} onClick={a => selectoption("16+  years")} /><h3>
                                                    {"16+  years"} </h3><span></span></p>
                                    ...
                                    {detailparents.childsocialneed == "Yes" ?
                                        <div className='form_group full'>
                                            ...
                                            <div className='text customselect '>
                                                {children_age ?
                                                    <span className='keyword' onClick={e => custom("cate2", "over2")} style={{
                                                        cursor: "pointer", whiteSpace: "nowrap",
                                                        overflow: "hidden"
                                                    }}>
                                                        {children_age.map((e, index) => {
                                            ...
                                            <div className='customselect inp'>
                                                ...
                                                <div className='overflow' id='over2' onClick={e => custom("cate2", "over2")}></div>
                                    ...
                                    <div className='form_group full'>
                                        ...
                                        <div className='checkbox create'>
                                            ...
                                            {detailparents.childmedicalcondition == "Yes" ? <>
                                                <textarea rows="2" maxlength="300" name="message" onChange={e => {
                                                    seterrorfield({ ...errorfield, childmedicaldescription: "" })
                                                    setdetailparents({ ...detailparents, childmedicaldescription: e.target.value })
                                                }} placeholder='Short description' defaultValue={detailparents.childmedicaldescription} className={errorfield.childmedicaldescription != "" ? "bordererror" : ""}></textarea>
                                    ...
                                    <div className='form_group full'>
                                        ...
                                        <div className='checkbox create'>
                                            ...
                                            {detailparents.childanyallergies == "Yes" ? <>
                                                ...
                                                }} placeholder='Short description' defaultValue={detailparents.childallergiesdescription} className={errorfield.childallergiesdescription != "" ? "bordererror" : ""}></textarea>
                                ...
                                <div className='button'>
                                    ...
                                    <button onClick={e => {
                                        if ((children > 0 || children == "twins") && selectcat[0] && detailparents.childsocialneed != "" && (detail.service_type && detail.service_type.tab2 ? detailparents.childneediep != "" : selectcat[0]) && detailparents.childmedicalcondition != "" && (detailparents.childmedicalcondition == "Yes" ? detailparents.childmedicaldescription != "" : selectcat[0]) && detailparents.childanyallergies != "" && (detailparents.childanyallergies == "Yes" ? detailparents.childallergiesdescription != "" : selectcat[0]) && (detailparents.childsocialneed == "Yes" ? children_age[0] : detailparents.childsocialneed != "")) {
                                            setmobile(-20)
                                            stapset(3)
                                            window.scrollTo({ top: 0 });
                                            profile_update(false)
                            ...
                            {/**/}
                            <div className='detail preferences   work-experience job_performance setp3' style={stap == 3 ? {} : { "display": "none" }}>
                                ...
                                {detail.service_type && detail.service_type.tab3 ?
                                    <div className='special_education big'>
                                        ...
                                        <div className='form_group full'>
                                            <label>Rate per hour {detail.country == "Serbia" ? "(RSD)" : "(USD)"}<span className={errorfield.seperhrrate != "" ? "starred" : ""}>*</span></label>
                                            {detail && detail.country == "Serbia" ?
                                                <div class="wrapper rang">
                                                    <div class="container_slide">
                                                        <div class="slider-track">
                                                        ...
                                                        <input type="range" min="0" max="5" id="slider-1" value={usd4.min / 10}
                                                            onChange={e => {
                                                                if ((usd4.max > 0 ? usd4.max : 60) > (e.target.value == 5 ? 60 : e.target.value * 10)) {
                                                                    ...
                                                                    seterrorfield({ ...errorfield, seperhrrate: "" })
                                                                }
                                                            }} />
                                ...
                                {detail.service_type && detail.service_type.tab4 ?
                                    <div className='tutor parents'>
                                        ...
                                        <div className='form_group full'>
                                            <label>Rate per hour {detail.country == "Serbia" ? "(RSD)" : "(USD)"}<span className={errorfield.tutorperhrrate != "" ? "starred" : ""}>*</span></label>
                                            {detail && detail.country == "Serbia" ?
                                                <div class="wrapper rang">
                                                    <div class="container_slide">
                                                        <div class="slider-track">
                                                        ...
                                                        <input type="range" min="0" max="5" id="slider-1" value={usd2.min / 10}
                                                            onChange={e => {
                                                                if ((usd2.max > 0 ? usd2.max : 60) > (e.target.value == 5 ? 60 : e.target.value * 10)) {
                                                                    ...
                                                                    seterrorfield({ ...errorfield, tutorperhrrate: "" })
                                                                }
                                                            }} />
                                ...
                                <div className='general_info tutor  preferred_school_jobs parents2'>
                                            ...
                                            {detailparents.tutorexp != "" ?
                                                <>
                                                    <select onChange={e => {
                                                        ...
                                                        <option disabled={true} selected style={{ display: "none" }}>
                                                            {detailparents.tutorexp != "" ? detailparents.tutorexp : ""}</option>
                                                        <option value={"0 - 1 years"} onClick={e => {
                                                            setdetailparents({ ...detailparents, tutorexp: "0 - 1 years" })
                                                        }}>0 - 1 years</option>
                                                        <option value={"1 - 2 years"} onClick={e => {
                                                            setdetailparents({ ...detailparents, tutorexp: "1 - 2 years" })
                                                        }}>1 - 2 years</option>
                                                        <option value={"2 - 4 years"} onClick={e => {
                                                            setdetailparents({ ...detailparents, tutorexp: "2 - 4 years" })
                                                        }}>2 - 4 years</option>
                                                        <option value={"More than 4 years"} onClick={e => {
                                                            setdetailparents({ ...detailparents, tutorexp: "More than 4 years" })
                                                        }}>More than 4 years</option>
                                                    </select>
                                                </>
                                                : <>
                                                    <select onChange={e => {
                                                        ...
                                                        <option disabled={true} selected style={{ display: "none" }}>
                                                            {detailparents.tutorexp != "" ? detailparents.tutorexp : ""}</option>
                                                        <option value={"0 - 1 years"} onClick={e => {
                                                            setdetailparents({ ...detailparents, tutorexp: "" })
                                                            setTimeout(() => {
                                                                setdetailparents({ ...detailparents, tutorexp: "0 - 1 years" })
                                                            }, 1000);
                                                        }}>0 - 1 years</option>
                                        ...
                                        <div class="select">
                                            {detailparents.preferredageofprovider != "" ?
                                                <select onChange={e => {
                                                    ...
                                                    <option disabled={true} selected style={{ display: "none" }}>
                                                        {detailparents.preferredageofprovider != "" ? detailparents.preferredageofprovider : ""}</option>
                                    ...
                                    <div className='form_group full'>
                                        <label>Frequency<span className={errorfield.tutorintrestedin != "" ? "starred" : ""}>*</span></label>
                                        <div className='checkbox create'>
                                ...
                                <div className='button'>
                                    ...
                                    <button onClick={e => {
                                        if ((detail.service_type && detail.service_type.tab1 ? detailparents.liveinnany != "" && usd.max > 5 : detailparents.tutorexp != "") && (detail.service_type && detail.service_type.tab4 ? (qualifications.English || qualifications.Serbian || qualifications.Mathematics || qualifications.Physics || qualifications.Chemistry || qualifications.Other) && detailparents.tutorintrestedonlinecls != "" && usd2.max > 5 : detailparents.tutorexp != "") && detailparents.tutorexp != "" && detailparents.preferredageofprovider != "" && detailparents.tutorstartdate != "" && detailparents.tutorintrestedin && (detail.service_type && detail.service_type.tab2 ? (usd3.max > 5) : detailparents.tutorintrestedin) && (detail.service_type && detail.service_type.tab3 ? (usd4.max > 5) : detailparents.tutorintrestedin)) {
                                            stapset(4)
                                            setmobile(-32)
                                            window.scrollTo({ top: 0 });
                                            profile_update(false)
                            ...
                            {/**/}
                            <div className='detail availability setp5' style={stap == 4 ? {} : { "display": "none" }}>
                                <div className='form_group full'>
                                ...
                                <div className='button'>
                                    ...
                                    <button onClick={e => {
                                        if (detailparents.fulltime != "" || detailparents.beforeschool != "" || detailparents.afterschool != "" || detailparents.weekends != "" || detailparents.overnight != "") {
                                            setmobile(-46)
                                            stapset(5)
                                            window.scrollTo({ top: 0 });
                                            profile_update(false)
                            ...
                            {/**/}
                            <div className='detail  additional_info info_parents setp6' style={stap == 5 ? {} : { "display": "none" }}>
                                <div className='form_group border qualification'>
                                    <label>Our ideal candidate can speak<span className={errorfield.candidatespeaks == "" ? "" : "starred"}>*</span></label>
                                    <div className='checkbox create setredio vertical'>
                                        <ul onClick={e => seterrorfield({ ...errorfield, candidatespeaks: "" })}>
                                            <li><input type="radio" name="" checked={oralspeak.English == "English" ? true : false} onClick={e => {
                                                if (e.target.checked) {
                                            ...
                                            <li><input type="radio" name="" checked={oralspeak.Spanish == "Spanish" ? true : false} onClick={e => {
                                                if (e.target.checked) {
                                            ...
                                            <li><input type="radio" name="" checked={oralspeak.French == "French" ? true : false} onClick={e => {
                                                if (e.target.checked) {
                                            ...
                                            <li><input type="radio" name="" checked={oralspeak.Chinese == "Chinese" ? true : false} onClick={e => {
                                                if (e.target.checked) {
                                            ...
                                            <li><input type="radio" name="" checked={oralspeak.German == "German" ? true : false} onClick={e => {
                                                if (e.target.checked) {
                                            ...
                                            <li><input type="radio" name="" checked={oralspeak.Italian == "Italian" ? true : false} onClick={e => {
                                                if (e.target.checked) {
                                            ...
                                            <li><input type="radio" name="" /><span>Other<input type="text" placeholder="Type here" defaultValue={oralspeak.Other} onChange={e => {
                                        ...
                                        {detailparents.workingabroad == "Yes" ?
                                            <>
                                                    ...
                                                    <div class="select">
                                                        {detailparents.preferredcountry != "" ?
                                                            <select onChange={e => {
                                                                ...
                                                                <option disabled={true} selected style={{ display: "none" }}>{detailparents.preferredcountry != "" ? detailparents.preferredcountry :
                                                                    "Choose from the list"}</option>
                                                                {
                                                                    country.data.map((e) => {
                                                ...
                                                <div className='form_group full'>
                                                    ...
                                                    <div class="text"><input type="text" placeholder="typehere" onChange={e => {
                                ...
                                <div className='button'>
                                    ...
                                    <button onClick={e => {
                                        if ((oralspeak.English != "" || oralspeak.Spanish || oralspeak.French || oralspeak.Chinese || oralspeak.German || oralspeak.Italian || oralspeak.Other) && (detail.service_type && detail.service_type.tab1 && Object.keys(detail.service_type).length == 1 ? habit.licence && habit.family && habit.housework && habit.kids : detailparents.workingabroad != "") && detailparents.workingabroad != "" && (detailparents.workingabroad == "Yes" ? detailparents.preferredcountry != "" && detailparents.preferredcity != "" : detailparents.workingabroad != "")) {
                                            stapset(6)
                                            setmobile(-60)
                                            window.scrollTo({ top: 0 });
                                            profile_update(false)
                            ...
                            {/**/}
                            <div className='detail  verification  setp7' style={stap == 6 ? {} : { "display": "none" }}>
                                ...
                                <div className='form_group fs'>
                                    <label><strong>Verify your phone number<span className={errorfield.phone != "" && veri == "" ? "starred" : ""}>*</span></strong>Please enter your phone number for  <a>verification</a><span className='smallpop'>We are asking for the phone number verification to ensure additional security for our members. For more information please visit <Link to='/safety-center'>Safety center</Link>.</span> purposes</label>
                                    <div className='verification_number '>
                                        <div className='number profilecretate'>
                                            <div className='country_flag' onClick={e => codeselect()}><img src={contact_code.flag} /> {contact_code.code != "" ? contact_code.code : ("+" + detailparents.countrycode)}
                                            ...
                                            <input type="number" placeholder="enter your number" className={error.phone && error.phone.length > 2 ? "bordererror" : ""} onChange={e => {
                                            ...
                                            }} defaultValue={detailparents.phone != null ? detailparents.phone : ""} />

                                            <button onClick={e => mobileverify()} style={detail.phoneVerifiedStatus != null && detail.phoneVerifiedStatus == 1 ? { display: "none" } : {}}>{dis ?
                                                "Wait" : "Get code"}</button>
                                        </div>
                                        <br />
                                        <br />
                                        <label>Enter your verification code</label>
                                        <div className='number'>
                                            <input type="number" placeholder="enter your number" className={error.otperror && error.otperror.length > 2 ? "bordererror" : ""} onChange={e => {
                            ...
                            {/**/}
                            <div className='detail work-experience job_performance job_post setp4' style={stap == 7 ? {} : { "display": "none" }}>

                                <div className='form_group full'>
                                    <label><strong>Details for {detail.service_type ? Object.values(detail.service_type)[0] : ""} position</strong></label>
                                    <br />
                                    <label>Job post title<span className={errorfield.jobs != "" ? "starred" : ""}>*</span></label>
                                    <textarea className={errorfield.jobs != "" ? "bordererror" : ""} rows={2} maxlength="70" name='message' onChange={e => {
                                        seterrorfield({ ...errorfield, jobs: "" })
                                        setdetailparents({ ...detailparents, jobs: e.target.value })
                                        setjobalready({ ...jobalready, job_type: Object.values(detail.service_type)[0] })
                                    }} placeholder={"Experienced " + (detail.service_type ? Object.values(detail.service_type)[0] : "") + " with 10 years of experience"} defaultValue={typeof detailparents.jobs == "string" ? detailparents.jobs : ""}>
                                    </textarea>
                                    {/* <div className='errorfield'>{error.message}</div>*/}
                                    <span>Number of characters {(70 - (detailparents.jobs != "" && detailparents.jobs != null ? detailparents.jobs.length : 0))}</span>
                                </div>
                                <div className='form_group full sec'>
                                    <label>Job description<span className={errorfield.jobs_description != "" ? "starred" : ""}>*</span></label>
                                    {detail.service_type ?
                                        <textarea className={errorfield.jobs_description != "" ? "bordererror" : ""} placeholder={
                                            Object.keys(detail.service_type)[0] == "tab1" ?
                                                ...
                                                Object.keys(detail.service_type)[0] == "tab2" ?
                                                    "My name is Jelena and I am looking for a reliable, responsible and passionate special education teacher to work with for my 3-year-old son. We are an easy going family of 3 members, and we love to engage in outdoor activities. We need someone to work with our son in the development of fine motor and language skills." : Object.keys(detail.service_type)[0] == "tab3" ?
                                                        "My name is Jelena and I am looking for a reliable, responsible and passionate special education paraprofessional to work with for my 3-year-old son. We are an easy going family of 3 members, and we love to engage in outdoor activities. We need someone to work with our son in the development of fine motor and language skills and possibly accompany him to the school                   .                                            " : Object.keys(detail.service_type)[0] == "tab4" ?
                                        ...
                                        } maxlength="300" name='message' onChange={e => {
                                            seterrorfield({ ...errorfield, jobs_description: "" })
                                            setdetailparents({ ...detailparents, jobs_description: e.target.value })
                                        }} rows={4} defaultValue={detailparents.jobs_description} ></textarea>
                                        : ""}
                                    {/* <div className='errorfield'>{error.message}</div>*/}
                                    <span>Number of characters {(300 - (detailparents.jobs_description != "" && detailparents.jobs_description != null && detailparents.jobs_description != undefined ? detailparents?.jobs_description?.length : 0))}</span>

                                </div>
                                <div class="form_group full socialpost border">
                                    <label>I give my consent for this job to be shared by SensCare platform on social media<span className={jobalready.plateformonsocialmedia == "" ? "starred" : ""}>*</span></label><div class="checkbox create">
                                        <ul>
                                            <li style={{ width: "25% !important" }}>
                                                <input type="radio" name="e" onClick={e => setjobalready({ ...jobalready, plateformonsocialmedia: "Yes" })} checked={jobalready.plateformonsocialmedia == "Yes" ? true : false} /><span>Yes </span></li>
                                            <li><input type="radio" name="e" onClick={e => setjobalready({ ...jobalready, plateformonsocialmedia: "No" })} checked={jobalready.plateformonsocialmedia == "No" ? true : false} /><span>No </span></li>
                                        </ul>
                                    </div>
                                </div>
                                {detail.service_type && Object.keys(detail.service_type).length == 2 ?
                                    <>
                                        <div className='form_group full'>
                                            <label><strong>Details for {Object.values(detail.service_type)[1]} position</strong></label>
                                            <br />
                                            <label>Job post title<span className={errorfield.jobs2 != "" ? "starred" : ""}>*</span></label>
                                            <textarea className={errorfield.jobs2 != "" ? "bordererror" : ""} placeholder={"Experienced " + Object.values(detail.service_type)[1] + " with 10 years of experience"} type="textarea" rows={2} maxlength="70" name='message' onChange={e => {
                                                seterrorfield({ ...errorfield, jobs2: "" })
                                                setjobalready({ ...jobalready, job_type2: Object.values(detail.service_type)[1] })
                                                setdetailparents({ ...detailparents, jobs2: e.target.value })
                                            }} defaultValue={detailparents.jobs2}></textarea>

                                            {/* <div className='errorfield'>{error.message}</div>*/}
                                            <span>Number of characters {(70 - detailparents?.jobs2?.length)}</span>
                                        </div>
                                        <div className='form_group full sec'>
                                            <label>Job description<span className={errorfield.jobs_description2 != "" ? "starred" : ""}>*</span></label>
                                            {detail.service_type ?
                                                <textarea className={errorfield.jobs_description2 != "" ? "bordererror" : ""} placeholder={
                                                    detail.service_type ? Object.keys(detail.service_type)[1] == "tab1" ? "My name is Jelena and I am looking for a reliable, responsible and passionate nanny for my 3-year-old son. We are an easy going family of 3 members, and we love to engage in outdoor activities. Nanny would care for my son when I run errands, help with meal preparation for him and take him to the local park (walking distance). We need a nanny for Monday through Friday from 8 A.M. to 12 P.M." :
                                                        Object.keys(detail.service_type)[1] == "tab2" ? "My name is Jelena and I am looking for a reliable, responsible and passionate special education teacher to work with for my 3-year-old son. We are an easy going family of 3 members, and we love to engage in outdoor activities. We need someone to workwith our son in the development of fine motor and language skills.  " : Object.keys(detail.service_type)[1] == "tab3" ?
                                                            "My name is Jelena and I am looking for a reliable, responsible and passionate special education paraprofessional to work with for my 3-year-old son. We are an easy going family of 3 members, and we love to engage in outdoor activities. We need someone to work with our son in the development of fine motor and language skills and possibly accompany him to the school                   .                                            " : Object.keys(detail.service_type)[1] == "tab4" ?
                                                                "My name is Jelena and I am looking for a reliable, responsible and experienced English tutor for my 9-year-old son. Our son needs help in reading and writing. Also, we are open for online classes.    " : "" : ""
                                                } rows={4} maxlength="300" name='message' onChange={e => {
                                                    seterrorfield({ ...errorfield, jobs_description2: "" })
                                                    setdetailparents({ ...detailparents, jobs_description2: e.target.value })
                                                }} defaultValue={detailparents.jobs_description2}></textarea>
                                                : ""}

                                            {/* <div className='errorfield'>{error.message}</div>*/}
                                            <span>Number of characters {(300 - detailparents?.jobs_description2?.length)}</span>

                                        </div>
                                        <div class="form_group full socialpost">
                                            <label>I give my consent for this job to be shared by SensCare platform on social media<span className={jobalready.plateformonsocialmedia2 == "" ? "starred" : ""}>*</span></label><div class="checkbox create">
                                                <ul>
                                                    <li style={{ width: "25% !important" }}>
                                                        <input type="radio" name="ke" onClick={e => setjobalready({ ...jobalready, plateformonsocialmedia2: "Yes" })} checked={jobalready.plateformonsocialmedia2 == "Yes" ? true : false} /><span>Yes </span></li>
                                                    <li><input type="radio" name="ke" onClick={e => setjobalready({ ...jobalready, plateformonsocialmedia2: "No" })} checked={jobalready.plateformonsocialmedia2 == "No" ? true : false} /><span>No </span></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </>
                                ...
                                <div className='button'>
                                    ...
                                    <button disabled={dis} onClick={e => {
                                        if (detailparents.jobs != "" && detailparents.jobs_description != "" && (detail.service_type && Object.keys(detail.service_type).length == 2 ? detailparents.jobs2 != "" && detailparents.jobs_description2 != "" && jobalready.plateformonsocialmedia2 && jobalready.plateformonsocialmedia : detailparents.jobs != "")) {
                                            profile_update(true)
                                            setTimeout(() => {
                                                setShowflogin(true)
                                            }, 1000);
                            ...
                            <Modal show={showflogin} onHide={handleCloselogin_first}>
                                <Modal.Body>
                                    <div className='promocode_content login_first'>
                                        ...
                                        <h2>Congratulations! Your post is live now.</h2>
                                        <img src='./images/create_profile.png' />
                                        <p className='pro'>SensCare wishes you to find the best provider! See your post <Link to={"/profile-parents/" + localStorage.getItem("id")}> here</Link>.</p>
