    ...
    const profile_data = () => {
        ...
        fetch(api + "/api/v1/details", requestOptions)
            ...
            .then(result => {
                ...
                setinactiveprofessional2(result.data.inactive_service != null ? result.data.inactive_service : {})
                setTimeout(() => {
                ...
                <Modal show={showflogin} className="professional_select profchange" onHide={handleCloselogin_first}>
                    <Modal.Body>
                        <div className={'describe more_about '}>
                            ...
                            <h2>It looks like you are ready to change your profession.</h2>
                            <p> Please choose from the menu below which profession you would like to deactivate first as only two professions can be active simultaneously.</p>
                                ...
                                <ul>
                                    <li className={describe && describe.tab1 == "Nanny" ? "active" : "" + nonselect == '' ? "" : "bordererror"} >
                                        ...
                                        <div class="personal_preferences">
                                            <label class="switchedit">
                                                <input type="checkbox" onClick={e => {
                                                    if (describe && Object.keys(describe).length != 2 || describe.tab1) {
                                                        setShow(true)
                                                        setdisabled(1)
                                                    }
                                                }} checked={Object.keys(describe).filter((e) => e == "tab1")[0] ? true : false} />
                                    ...
                                    <li className={describe && describe.tab2 == "Special Education Teacher" ? "active" : "" + nonselect == '' ? "" : "bordererror"} >
                                        ...
                                        <div class="personal_preferences">
                                            <label class="switchedit">
                                                <input type="checkbox" onClick={e => {
                                                    if (describe && Object.keys(describe).length != 2 || describe.tab2) {
                                                        setShow(true)
                                                        setdisabled(2)
                                                    }
                                                }} checked={Object.keys(describe).filter((e) => e == "tab2")[0] ? true : false} />
                                                <span class="slideredit roundedit"></span>
                                            </label>
                                        </div>
                                    </li>
                                    <li className={describe && describe.tab3 == "Special Education Paraprofessional" ? "active" : "" + nonselect == '' ? "" : "bordererror"} >
                                        ...
                                        <div class="personal_preferences">
                                            <label class="switchedit">
                                                <input type="checkbox" onClick={e => {
                                                    if (describe && Object.keys(describe).length != 2 || describe.tab3) {
                                                        setShow(true)
                                                        setdisabled(3)
                                                    }
                                                }} checked={Object.keys(describe).filter((e) => e == "tab3")[0] ? true : false} />
                                                <span class="slideredit roundedit"></span>
                                            </label>
                                        </div>
                                    </li>
                                    <li className={describe && describe.tab4 == "Tutor" ? "active" : "" + nonselect == '' ? "" : "bordererror"}  >
                                        {/* <div className='checkededit'>
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M0.5 10C0.5 4.75329 4.75329 0.5 10 0.5C15.2467 0.5 19.5 4.75329 19.5 10C19.5 15.2467 15.2467 19.5 10 19.5C4.75329 19.5 0.5 15.2467 0.5 10Z" fill="white" stroke="#636363" stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                        ...
                                        <div class="personal_preferences">
                                            <label class="switchedit">
                                                <input type="checkbox" onClick={e => {
                                                    if (describe && Object.keys(describe).length != 2 || describe.tab4) {
                                                        setShow(true)
                                                        setdisabled(4)
                                                    }
                                                }} checked={Object.keys(describe).filter((e) => e == "tab4")[0] ? true : false} />
                                                <span class="slideredit roundedit"></span>
                                            </label>
                                        </div>
                                    </li>
                            ...
                            <button className='back_sign' onClick={e => {
                                ...
                                newprofession.tab3 ? setprofessional(true) : setprofessional(false);
                ...
                <Modal show={show} onHide={handleClose}>
                    <Modal.Body>
                        <div className='promocode_content younger statuschange'>
                            ...
                            <h5>Change the status of profession</h5>
                            <p style={{ marginBottom: "0" }}><b>Do you want to make the selected profession active / inactive?</b></p>
                            <div className='graybg'>
                                <p>While SensCare understands that due to evolving life situations such as graduation, career change, etc. you may want to change profession, we do not recommend doing it frequently. You are allowed to change a profession two times per year.</p>
                        ...
                        <Modal.Body>
                            <div className='younger'>
                                            ...
                                            <div className='col-6'>
                                                <div className='iconsec'>
                                                    <div className='form_group full'>
                                                        <label>Years of work experience<span className={errorfield.nanyyearexp != "" ? "starred" : ""}>*</span></label>
                                                ...
                                                <div className='iconsec'>
                                                    <div className='iconsec' style={{ width: "100%" }}>
                                                        <br />
                                                        <h3>Additional info <span className={errorfield.smoke != "" || errorfield.carorlicence != "" || errorfield.cooking != "" || errorfield.lighthousework != "" || errorfield.traveling != "" ? "starred" : ""}>*</span></h3>
                                                        <br />
                                                        <div className='icon'>
                                                            <ul>

                                                                <li onClick={e => seterrorfield({ ...errorfield, smoke: "" })} >Do you smoke?
                                                                    <div className='icons'>
                                                                ...
                                                                <li onClick={e => seterrorfield({ ...errorfield, carorlicence: "" })} >Do you own a car or licence?
                                                                    <div className='icons'>
                                                                ...
                                                                <li onClick={e => seterrorfield({ ...errorfield, cooking: "" })} >Cooking for kids
                                                                    <div className='icons'>
                                                                ...
                                                                <li onClick={e => seterrorfield({ ...errorfield, traveling: "" })} >Traveling with family
                                                                    <div className='icons'>
                                                    ...
                                                    <div className='form_group full space'>
                                                        ...
                                                        <div className='checkbox'>
                                                            <ul onClick={w => seterrorfield({ ...errorfield, nanynewbornexp: "" })}>
                                                                <li><input type="radio" name="quality" checked={detailprovider.nanynewbornexp == "Yes" ? true : false} onClick={e => setdetailprovider({ ...detailprovider, nanynewbornexp: "Yes" })} /><span>Yes </span></li>
                                                                <li><input type="radio" name="quality" checked={detailprovider.nanynewbornexp == "No" ? true : false} onClick={e => setdetailprovider({ ...detailprovider, nanynewbornexp: "No" })} /><span>No </span></li>
                                                            </ul>
                                                        </div>
                                                        {/* <div className='errorfield'>{error.message}</div>*/}
                                                    </div>
                                                    <div className='form_group full'>
                                                        <label>Would you living with the family?<span className={errorfield.livewithfamily != "" ? "starred" : ""}>*</span></label>
                                                        <div className='checkbox create'>
                                                            <ul onClick={e => seterrorfield({ ...errorfield, livewithfamily: "" })}>
                                                                <li><input type="radio" name="family" onClick={e => setdetailprovider({ ...detailprovider, livewithfamily: "Yes" })} checked={detailprovider.livewithfamily == "Yes" ? true : false} /><span> Yes</span></li>
                                                                <li><input type="radio" name="family" onClick={e => setdetailprovider({ ...detailprovider, livewithfamily: "No" })} checked={detailprovider.livewithfamily == "No" ? true : false} /><span> No</span></li>
                                                                <li><input type="radio" name="family" onClick={e => setdetailprovider({ ...detailprovider, livewithfamily: "Open to offers" })} checked={detailprovider.livewithfamily == "Open to offers" ? true : false} /><span> Open to offers</span></li>
                                                            </ul>
                                                        </div>
                                                        {/* <div className='errorfield'>{error.message}</div>*/}
                                                    </div>
                                                    <div className='form_group full space'>
                                                        ...
                                                        <div className='checkbox'>
                                                            <ul onClick={e => seterrorfield({ ...errorfield, nanyexpwithkid: "" })}>
                                                                <li><input type="radio" name="quality2" checked={detailprovider.nanyexpwithkid == "Yes" ? true : false} onClick={e => setdetailprovider({ ...detailprovider, nanyexpwithkid: "Yes" })} /><span> Yes</span></li>
                                                                <li><input type="radio" name="quality2" checked={detailprovider.nanyexpwithkid == "No" ? true : false} onClick={e => setdetailprovider({ ...detailprovider, nanyexpwithkid: "No" })} /><span> No</span></li>
                                                            </ul>
                                                        </div>
                                                        {/* <div className='errorfield'>{error.message}</div>*/}
                                                    </div>
                                ...
                                <div className='button'>
                                    ...
                                    <button onClick={e => {
                                        if (detailprovider.nanyyearexp > 0 && (usd.min > 5 || usd.max > 5) && (habit.smoke != "" && habit.licence != "" && habit.kids != "" && habit.housework != "" && habit.family != "") && detailprovider.nanynewbornexp != "" && detailprovider.livewithfamily != "" && detailprovider.nanyexpwithkid != "") {
                                            window.scrollTo({ top: 0 });
                                            handleClose1()
                                            profile_update(true)
                                            setlivenow(true)
                        ...
                        <Modal.Body>
                            <div className='younger'>
                                    ...
                                    <div className='detail work-experience your_kids  setp3'>
                                        <div className='special_education'>
                                            ...
                                            <div className='col-6'>
                                                <div className='iconsec'>
                                                    <div className='form_group full'>
                                                        <label>Years of work experience<span className={errorfield.setyearexp != "" ? "starred" : ""}>*</span></label>
                                                        <div className='rang' style={{ minWidth: "375px" }}>
                                                ...
                                                <div className='iconsec'>
                                                    <div className='form_group full qualification methad'>
                                                        <label>Experience with following methods<span className={errorfield.setexpmethods != "" ? "starred" : ""}>*</span></label>
                                                        <div className='checkbox'>
                                                    ...
                                                    <div className='form_group full'>
                                                        ...
                                                        <div className='checkbox'>
                                                            <ul onClick={e => seterrorfield({ ...errorfield, setexpiep: "" })}>
                                                                <li><input type="radio" name="quality6" checked={detailprovider.setexpiep == "Yes" ? true : false} onClick={e => setdetailprovider({ ...detailprovider, setexpiep: "Yes" })} /><span>Yes </span></li>
                                                                <li><input type="radio" name="quality6" checked={detailprovider.setexpiep == "No" ? true : false} onClick={e => setdetailprovider({ ...detailprovider, setexpiep: "No" })} /><span>No </span></li>
                                                            </ul>
                                                        </div>
                                                        {/* <div className='errorfield'>{error.message}</div>*/}
                                                    </div>
                                                    ...
                                                    <div className='job_performance'>
                                                        <div className='form_group' style={{ width: "100%" }}>
                                                            ...
                                                            <div className='customselect inp'>
                                                                ...
                                                                <div className='overflow' id='over22' onClick={e => custom("cate88", "over22")} style={{
                                                                    bottom: "100%", top: "auto"
                                                                }}></div>

                                                                <div className='option' id='cate88' onClick={e => seterrorfield({ ...errorfield, setallapplicable: "" })} style={{
                                                                    bottom: "100%", top: "auto"
                                                                }}>
                                ...
                                <div className='button'>
                                    ...
                                    <button onClick={e => {
                                        if (range > 0 && usd3.max > 0 && (methods.setexpmethods != "" || methods.setexpmethods2 != "" || methods.setexpmethods3 != "" || methods.setexpmethods4 != "") && detailprovider.setexpiep != "" && setallapplicable2[0]) {
                                            window.scrollTo({ top: 0 });
                                            handleClose3()
                                            profile_update(true)
                                            setlivenow(true)
                        ...
                        <Modal.Body>
                            <div className='younger'>
                                    ...
                                    <div className='special_education'>
                                        <div className='detail work-experience your_kids  setp3'>
                                            ...
                                            <div className='col-6'>
                                                <div className='iconsec'>
                                                    <div className='form_group full'>
                                                        <label>Years of work experience<span className={errorfield.sepworkexp != "" ? "starred" : ""}>*</span></label>
                                                        <div className='rang' style={{ minWidth: "375px" }}>
                                                ...
                                                <div className='iconsec space'>
                                                    <div className='form_group full'>
                                                        <label>Experience with following methods<span className={errorfield.sepexpmethods != "" ? "starred" : ""}>*</span></label>
                                                        <div className='checkbox'>
                                                            <ul onClick={e => seterrorfield({ ...errorfield, sepexpmethods: "" })}>
                                                                <li><input type="radio" name="quality4" checked={detailprovider.sepexpmethods && detailprovider.sepexpmethods == "ABA" ? true : false} onClick={e => setdetailprovider({ ...detailprovider, sepexpmethods: "ABA" })} /><span>ABA </span></li>
                                                                <li><input type="radio" name="quality4" checked={detailprovider.sepexpmethods && detailprovider.sepexpmethods == "PECS" ? true : false} onClick={e => setdetailprovider({ ...detailprovider, sepexpmethods: "PECS" })} /><span> PECS</span></li>
                                                                <li><input type="radio" name="quality4" checked={detailprovider.sepexpmethods && detailprovider.sepexpmethods == "Floortime" ? true : false} onClick={e => setdetailprovider({ ...detailprovider, sepexpmethods: "Floortime" })} /><span>Floortime </span></li>
                                                                <li><input type="radio" name="quality4" checked={detailprovider.sepexpmethods && detailprovider.sepexpmethods == "None" ? true : false} onClick={e => setdetailprovider({ ...detailprovider, sepexpmethods: "None" })} /><span>None </span></li>
                                                            </ul>
                                                        </div>
                                                        {/* <div className='errorfield'>{error.message}</div>*/}
                                                    </div>
                                                    ...
                                                    <div className='form_group full'>
                                                        ...
                                                        <div className='checkbox'>
                                                            <ul onClick={e => seterrorfield({ ...errorfield, sepexpwithkid: "" })}>
                                                                <li><input type="radio" name="quality3" checked={detailprovider.sepexpwithkid == "Yes" ? true : false} onClick={e => setdetailprovider({ ...detailprovider, sepexpwithkid: "Yes" })} /><span>Yes </span></li>
                                                                <li><input type="radio" name="quality3" checked={detailprovider.sepexpwithkid == "No" ? true : false} onClick={e => setdetailprovider({ ...detailprovider, sepexpwithkid: "No" })} /><span>No </span></li>
                                                            </ul>
                                                        </div>
                                                        {/* <div className='errorfield'>{error.message}</div>*/}
                                                    </div>
                                ...
                                <div class="button text-center">
                                    ...
                                    <div class="pull-right">
                                        <button class="btn confirm" onClick={e => {
                                            if (sepworkexp > 0 && detailprovider.sepexpmethods != "" && usd4.max > 5 && detailprovider.sepexpwithkid != "") {
                                                handleClose2()
                                                window.scrollTo({ top: 0 });
                                                profile_update(true)
                                                setlivenow(true)
                        ...
                        <Modal.Body>
                            <div className='younger'>
                                            ...
                                            <div className='col-6'>
                                                ...
                                                <div className='iconsec'>
                                                    <div className='form_group full qualification tutorteach'>
                                                        <label>What classes would you teach?<span className={errorfield.tutorliketoteach == "" ? "" : "starred"}>*</span></label>
                                                        <div className='checkbox'>
                                                            <ul onClick={e => seterrorfield({ ...errorfield, tutorliketoteach: "" })}>
                                                                <li><input type="checkbox" name="" checked={qualifications.English == "English" ? true : false} onClick={e => {
                                                                    if (e.target.checked) {
                                                                ...
                                                                <li><input type="checkbox" name="" checked={qualifications.Serbian == "Serbian" ? true : false} onClick={e => {
                                                                    if (e.target.checked) {
                                                                ...
                                                                <li><input type="checkbox" name="" checked={qualifications.Mathematics == "Mathematics" ? true : false} onClick={e => {
                                                                    if (e.target.checked) {
                                                                ...
                                                                <li><input type="checkbox" name="" checked={qualifications.Physics == "Physics" ? true : false} onClick={e => {
                                                                    if (e.target.checked) {
                                                                ...
                                                                <li><input type="checkbox" name="" checked={qualifications.Chemistry == "Chemistry" ? true : false} onClick={e => {
                                                                    if (e.target.checked) {
                                                    ...
                                                    <div className='form_group full'>
                                                        ...
                                                        <div className='checkbox create'>
                                                            <ul onClick={e => seterrorfield({ ...errorfield, tutorintrestedonlinecls: "" })}>
                                                                <li><input type="radio" name="yes" checked={detailprovider.tutorintrestedonlinecls == "Yes" ? true : false} onClick={e => setdetailprovider({ ...detailprovider, tutorintrestedonlinecls: "Yes" })} /><span>Yes </span></li>
                                                                <li><input type="radio" name="yes" checked={detailprovider.tutorintrestedonlinecls == "No" ? true : false} onClick={e => setdetailprovider({ ...detailprovider, tutorintrestedonlinecls: "No" })} /><span>No </span></li>
                                                            </ul>
                                                        </div>
                                                        {/* <div className='errorfield'>{error.message}</div>*/}
                                                    </div>
                                ...
                                <div class="button text-center">
                                    ...
                                    <div class="pull-right">
                                        <button class="btn confirm" onClick={e => {
                                            if (utorexperience > 0 && (qualifications.English || qualifications.Serbian || qualifications.Mathematics || qualifications.Physics || qualifications.Chemistry || qualifications.Other) && tutorusd.max > 5 && detailprovider.tutorintrestedonlinecls != "" && detailprovider.sepexpwithkid != "") {
                                                handleClose4()
                                                profile_update(true)
                                                setlivenow(true)
                                            } else {
