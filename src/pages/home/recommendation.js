                                    ...
                                    return (
                                        <tr class={data.read_status == 0 ? "unread" : ""} >
                                            <td class="view-message  dont-show">
                                                ...
                                                <span class="username-text" onClick={e => setview(data.id)}> {data.ProviderName} </span> has just sent you an interview invite.
                                            </td>
                                            <td class="view-message  text-right">{month[new Date(data.updated_at).getMonth() + 1] + " " + new Date(data.updated_at).getDate()}</td>
                                        </tr>
                                    )
                                })
                            }
