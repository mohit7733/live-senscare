...
export default function Job_application() {
    ...
    const list = () => {
        ...
        fetch(api + "/api/v1/jobapplicationsnotification?" + (refine.threedays != "" ? "threedays=" + refine.threedays : refine.withinweek != "" ? "withinweek=" + refine.withinweek : refine.twofourday != "" ? "twofourday=" + refine.twofourday : refine.withinmonth != "" ? "withinmonth=" + refine.withinmonth : ""), requestOptions)
                ...
                <>
                    <div class="main-header">
                        ...
                        <div class="mail-header-bar">
                            <p>{interview.length} Applications  </p>
                                            ...
                                            <td class="view-message  dont-show">
                                                ...
                                                <span onClick={e => {
                                                    ...
                                                    <span class="username-text" onClick={e => {
                                                        navigate("/search-parents/" + slugdata.id + "/" + data.id)
                                                        setview(data.id)
                                                    }}> {data.Appliedusername} </span> has just applied to your  <span class="username-text" > job post.  </span>
                                                </span>
                                            </td>
