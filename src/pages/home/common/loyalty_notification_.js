...
import Loyalty_detail from './loyalty_notification_detail';


export default function Loyality_notification() {
    ...
    const list = () => {
        ...
        fetch(api + '/api/v1/membershipnotifications?' + (refine.threedays != "" ? "threedays=" + refine.threedays : refine.withinweek != "" ? "withinweek=" + refine.withinweek : refine.twofourday != "" ? "twofourday=" + refine.twofourday : refine.withinmonth != "" ? "withinmonth=" + refine.withinmonth : "")

            , requestOptions)
            .then(response => response.json())
            .then(result => setinterview(result.data.getNotification))
    ...
    const delete_in = () => {
        ...
        fetch(api + "/api/v1/membershipnotificationsdelete", requestOptions)
            ...
            {view == "" ?
                <>
                    <div class="main-header">
                        <h2 className='border'>SensCare Loyalty Program</h2>
                        <div class="mail-header-bar">
                            <p>{interview.length} New Notification </p>
                                        ...
                                        <tr class={data.read_status == 0 ? "unread" : ""} >
                                            <td class="view-message  dont-show" >
                                                ...
                                                <span onClick={e => {
                                                    ...
                                                    <span class="username-text" >  </span>{data.type != "plans" ?
                                                        "Congratulations, your friend has just joined the SensCare family!" :
                                                        "Congratulations! SensCare just awarded you discount of 500 dinars on the monthly membership"}
                                                </span>
                                            </td>
