...
function Who_visit_me() {
    ...
    const profile_data = (a) => {
        ...
        fetch(api + "/api/v1/whovisitedme?profile_search=" + (a != undefined ? a : recived), requestOptions)
            .then(response => response.json())
            .then(result => {
    ...
    return (
        <>
            <div class="main-header">
                <h2 className='border'>Who Visited Me</h2>
                                                ...
                                                <div class="interested_fam_box">
                                                    <div class="image_sec">
                                                        <div class="heart_sec delete">
                                                            <svg onClick={e =>
                                                                favourite_selectapi(data?.user_id)
                                                        ...
                                                        <div class="heart_sec">
                                                            {localStorage.getItem("user_type") != "parents" && recived == "Parents" ?
                                                                ...
                                                                : <Favorite_profile id={data.id} username={data.first_name} heart2={data.favOrnot} whovisitedme={data.first_name} />
                                                            }
                                                    ...
                                                    <div class="general_sec">
                                                        ...
                                                        >{data.first_name + " " + data.last_name}</Link></h4>
                                                        {data.reviewAvg >= 0 ?
                                                            <>
                                                        ...
                                                        <div class="detail_sec">
                                                            ...
                                                            <p>{data.nanyyearexp != null ? data.nanyyearexp : data.setyearexp != null ? data.setyearexp : data.tutorexp != null ? data.tutorexp : data.yearofexpasteacher != null ? data.yearofexpasteacher : "0"} {recived == "Parents" ? "" : "Years"} of exp </p></div>
            ...
            <div className='upgared hight2'>
                ...
                <p>{interview.length} more people visited your profile. Please upgrade to <br />view their profiles and connect.</p>
                <Link to={""
