    ...
    return (
        <>
                        ...
                        <div className='detail_invit'>
                            <p>
                                ...
                                {list && list[0] && list[0].read_status == 0 ?
                                    ...
                                    : ""}
                                {job && job[0] && job[0].title != null ? job[0].title : ""} </p>
                            <h2>Dear <span>{message}</span> congratulations!
                            </h2> <h2><Link to={"/profile-parents/" + list[0]?.user_id}>{list && list[0] && list[0].first_name}</Link> invited you to an Interview. </h2>
                            <p>Read more about job below and accept interview invite if you are interested.</p>
                        </div>
                                        ...
                                        return (
                                            <div class="looking_for_candidate_boxs">
                                                <div class="looking_for_candidate_box">
                                                    <div class="first_sec">
                                                        <div class="image_sec">
                                                            <img src={data.file_path != null ? api + "/public/assets/images/users/" + data.file_path : window.location.origin + window.location.origin + "/img/nany_img.png"} alt="" />
                                                            <div class="heart_sec">
                                                    ...
                                                    <div class="second_sec">
                                                        <div class="heading">
                                                            <h3>{job && job[0] && job[0].title != null ? job[0].title : ""} </h3>
                                                            {job && job[0] && job[0].plateformonsocialmedia == "Yes" ?
                                                        ...
                                                        <div class="post_general">
                                                            ...
                                                            <p onClick={e => {
                                                                if (rating.checkreviewstatus != true || data.checkapplyornot == true) {
                                                                    setreviewmodel(true)
                                                                }
                                                            }}>
                                                                {rating.reviewAvg >= 0 ?
                                                        ...
                                                        <div class="post_detail">
                                                            <div class="post">
                                                                ...
                                                                {
                                                                    data.jobType != null ? data.jobType == "Nanny" ? <img src={window.location.origin + "/images/nany_post.svg"} alt="" /> : data.jobType == "Special Education Teacher" ? <img src={window.location.origin + "/images/teacher_post.svg"} alt="" /> : data.jobType == "Special Education Paraprofessional" ? <img src={window.location.origin + "/images/education_post.svg"} alt="" /> : data.jobType == "Tutor" ? <img src={window.location.origin + "/images/tutor_post.svg"} alt="" /> : "" : ""
                                                                }
                                                                <h5>{data.jobType != null ? data.jobType
                                                                    : ""}
                                                                </h5>
                                                            </div>
                                                            <div class="vi"></div>
                                                        ...
                                                        <p id={"half" + index} >{job && job[0] && job[0].description != null ? (job && job[0] && job[0].description.substr(0, 100)
                                                        ) : ""} {job && job[0] && job[0].description != null && job && job[0] && job[0].description.length > 100 ? <span onClick={e => pmore("half" + index, "full" + index, "plink" + index)}>...more</span> : ""} </p>
                                                        <p id={"full" + index} className="hide">{job && job[0] && job[0].description}  <span onClick={e => pmore("full" + index, "half" + index, "plink" + index)}>  less</span></p>
                                                    ...
                                                    <div className='find_search'>
                                                        ...
                                                        </svg> Search for similar jobs</Link>
                                                    </div>
                                                    <div class="view_profile_btn">
                                                        {
                                                            data.status == 1 ?
                                                                <button onClick={e => setview(data.user_id)} >
                                                                    {"Send message"} </button>
                                                                :
                                                                <button style={data.status == 2 || status == 2 ? { opacity: "0.5" } : {}} onClick={e => setdelete(true)} disabled={data.status == 2 || status == 2 ? true : false} >{status == 2 || data.status == 2 ? "Declined" : "Decline"}</button>
                                                        }
                                                        {
                                                            data.status == 1 ?
                                                                new Date(list && list[0] && list[0].created_at).getMonth() < new Date().getMonth() ? <Link to={""} onClick={e => {
                                                                    setnoactive(true)
                                                                }}>Visit profile</Link> :
                                                                    <Link to={"/profile-parents/" + data.user_id}>Visit profile</Link>
                                                                :

                                                                data.status == 2 || status == 2 ? <Link to={""} style={data.status == 2 || status == 2 ? { opacity: "0.5" } : {}} >Accept and visit profile</Link> :
                                                                    <Link to={""} disabled={data.status == 2 || status == 2 ? true : false} style={data.status == 2 || status == 2 ? { opacity: "0.5" } : {}} onClick={e => {
                                                                        localStorage.removeItem("search")
                                                                        localStorage.removeItem("search2")
                                                                        setdelete2(true)
                                                                    }}>Accept and visit profile </Link>
                                                ...
                                                <p>
                                                    {
                                                        data.childmedicalcondition != null && data.childmedicalcondition == "Yes" || data.childanyallergies != null && data.childanyallergies == "Yes" ?
                                                            <>
                                                    ...
                                                    <br />
                                                    Respond promptly or within 24h to the invitation and improve your chances to get hired. Please refer to our <Link to="/faq" target="_blank">FAQ</Link> and <Link to="/safety-center" target="_blank">Safety center</Link> to read safety tips. </p>
                                            </div>
                                        )
                                    }
                                    ) : ""}
                                                        ...
                                                        <div class="looking_for_candidate_boxs" style={{ display: "block" }}>
                                                            <div class="looking_for_candidate_box">
                                                                <div class="second_sec">
                                                                    ...
                                                                    <div class="post_general">
                                                                        <h6>{data.first_name != null ? data.first_name : ""} ({data.dob != undefined ? new Date().getFullYear() - parseInt(data.dob.substr(data.dob.lastIndexOf('\\') + 1).split('-')[0]) : ""})</h6>
                                                                        <p onClick={e => {
                                                                    ...
                                                                    <div class="post_detail">
                                                                        <div class="post">
                                                                            ...
                                                                            <h5>{JSON.parse(data.service_type) != null ? Object.values(JSON.parse(data.service_type))[0] ==
                                                                                ...
                                                                                "SPED Paraprofessional" : Object.values(JSON.parse(data.service_type))[0] ==
                                                                                    " Special Education Teacher " ?
                                                                                    "SPED teacher" : Object.values(JSON.parse(data.service_type))[0]
                                                                                : ""}
                                                                            </h5>
                                                                        </div>
                                                                        <div class="vi"></div>
                                                                ...
                                                                <div class="view_profile_btn visiterbtn ">
                                                                    ...
                                                                    {
                                                                        data.status == 1 ?
                                                                            <a onClick={e => setview(data.user_id)}>{"Send message"} </a>
                                                                            :
                                                                            <a style={data.status == 2 || status == 2 ? { opacity: "0.5" } : {}} onClick={e => {
                                                                                data.status == 2 || status == 2 ? setdelete(false) : setdelete(true)
                                                                            }} disabled={data.status == 2 || status == 2 ? true : false} >{status == 2 || data.status == 2 ? "Declined" : "Decline"}</a>
                                                                    }
                                                                    <br />
                                                                    <Link to="/search-parents" style={{
            ...
            }
            {
                reviewmodel ?
                    <Modal show={reviewmodel} onHide={e => setreviewmodel(false)
                        ...
                        <Modal.Body>
                            <Send_review setrequest={setreviewmodel} slugdata={list && list[0] && list[0].user_id} username={list && list[0] && list[0].first_name + " " + list && list[0] && list[0].last_name} />
                        </Modal.Body>
                    </Modal > : ""
            }
            {
                    ...
                    <Modal show={delete1} onHide={e => setdelete(false)} className="">
                        <Modal.Body>
                            <div className='promocode_content upload_document_delete'>
                                ...
                                <h2>Decline an Interview invite</h2>

                                <div className='gray'>
                                    <p style={{ borderBottom: "1px solid #B7B7B7" }}><span>Important!</span>  <b>If you decline an invite, it might lead to fewer invites in the future.</b></p>
                                    <p>Are you sure you want to decline an interview invite?</p>
                                    <button onClick={e => {
                                        setshowflogin(true)
                                        accept("2")
                                    }}>Yes</button>
                                    <button onClick={e => setdelete(false)}>No</button>
                                </div>
                            </div>
                        </Modal.Body>
                    </Modal>
                    ...
                    <Modal show={delete21} onHide={e => setdelete2(false)} className="">
                        <Modal.Body>
                            <div className='promocode_content upload_document_delete acceptinterview'>
                                <h2>Accept an Interview invite</h2>
                                <p>Are you sure you want to accept an invite?</p>
                                <button onClick={e => setdelete2(false)}>Decline</button>
                                <button onClick={e => accept("1")}><Link to={"/profile-parents/" + list[0].user_id} >Accept</Link></button>
                                <div className='gray'>
                                    <p>Please visit our <Link to="/faq" target="_blank">FAQ</Link> page and <Link to="/safety-center" target="_blank">Safety center</Link> to read our safety tips and prepare for the interview. </p>
                                </div>
                            </div>
                        </Modal.Body>
                    </Modal>
            ...
            <Modal show={showflogin} onHide={e => setshowflogin(false)}>
                <Modal.Body>
                    <div className='promocode_content login_first search_pop'>
                        ...
                        <h2>We are sorry you didn’t like this job.</h2>
                        <img src={window.location.origin + '/images/return.png'} />
                        <p style={{ color: "#7D2B8B" }}>Search other posts and find your perfect job.</p>
                        <button onClick={e => setshowflogin(false)}><Link to={"/search-parents"}><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M13.156 14.4283C11.7703 15.5369 10.0125 16.1998 8.0999 16.1998C3.62645 16.1998 0 12.5733 0 8.0999C0 3.62645 3.62645 0 8.0999 0C12.5733 0 16.1998 3.62645 16.1998 8.0999C16.1998 10.0123 15.5371 11.7699 14.4287 13.1555L17.7368 16.4636C18.0883 16.8151 18.0883 17.3849 17.7368 17.7364C17.3854 18.0879 16.8155 18.0879 16.4641 17.7364L13.156 14.4283ZM1.79998 8.0999C1.79998 4.62055 4.62055 1.79998 8.0999 1.79998C11.5792 1.79998 14.3998 4.62055 14.3998 8.0999C14.3998 9.79867 13.7274 11.3404 12.6343 12.4735C12.6047 12.4964 12.5763 12.5215 12.5491 12.5487C12.5219 12.5759 12.4969 12.6043 12.4739 12.6339C11.3408 13.7273 9.79887 14.3998 8.0999 14.3998C4.62055 14.3998 1.79998 11.5792 1.79998 8.0999Z" fill="white" />
                        </svg>Search jobs</Link ></button>
                    </div>
                </Modal.Body>
            </Modal>
            ...
            <Modal show={noactive} onHide={e => setnoactive(false)}>
                <Modal.Body>
                    <div className='promocode_content login_first search_pop'>
                        <Link to="" onClick={e => setnoactive(false)}>+ </Link>
                        <h2>Profile not found</h2>
                        <p><span style={{ color: "#A98D4B" }}>{list && list[0] && list[0].first_name} </span> has no longer an active profile with SensCare.</p>
                        <button style={{ padding: "10px 14px" }} onClick={e => setnoactive(false)}><Link to={"/search-parents"} ><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M13.156 14.4283C11.7703 15.5369 10.0125 16.1998 8.0999 16.1998C3.62645 16.1998 0 12.5733 0 8.0999C0 3.62645 3.62645 0 8.0999 0C12.5733 0 16.1998 3.62645 16.1998 8.0999C16.1998 10.0123 15.5371 11.7699 14.4287 13.1555L17.7368 16.4636C18.0883 16.8151 18.0883 17.3849 17.7368 17.7364C17.3854 18.0879 16.8155 18.0879 16.4641 17.7364L13.156 14.4283ZM1.79998 8.0999C1.79998 4.62055 4.62055 1.79998 8.0999 1.79998C11.5792 1.79998 14.3998 4.62055 14.3998 8.0999C14.3998 9.79867 13.7274 11.3404 12.6343 12.4735C12.6047 12.4964 12.5763 12.5215 12.5491 12.5487C12.5219 12.5759 12.4969 12.6043 12.4739 12.6339C11.3408 13.7273 9.79887 14.3998 8.0999 14.3998C4.62055 14.3998 1.79998 11.5792 1.79998 8.0999Z" fill="white" />
                        </svg>Find similar job posts </Link ></button>
                    </div>
                </Modal.Body>
            </Modal>
        </>
