                    ...
                    <div className='detail_invit bbnone'>
                        <p>
                            {list && list[0] && list[0].read_status == 0 ?
                                <span className='new'>NEW!</span> : ""}Your Job Post  <span className='date' style={{ display: "inherit", width: "auto", position: "inherit" }}>
                                You created it on  {list && list[0] && list[0].created_at ? new Date(list && list[0] && list[0].created_at).toLocaleDateString('en-US', { weekday: 'short' }) : ""}, {list && list[0] && list[0].created_at ? month[new Date(list && list[0] && list[0].created_at).getMonth()] : ""}, {new Date(list && list[0] && list[0].created_at).getDate()}, {new Date(list && list[0] && list[0].jobcreated_at).getFullYear()}, {new Date(list && list[0] && list[0].jobcreated_at).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</span></p>
                    </div>
                                        ...
                                        data.jobStatus == 0 ?
                                                ...
                                                <div class="looking_for_candidate_box">
                                                    ...
                                                    <div class="second_sec">
                                                        ...
                                                        <div class="post_detail">
                                                            <div class="post">
                                                                {
                                                                    data.job_type != null ? data.job_type == "Nanny" ? <img src={window.location.origin + "/images/nany_post.svg"} alt="" /> : data.job_type == "Special Education Teacher" ? <img src={window.location.origin + "/images/teacher_post.svg"} alt="" /> : data.job_type == "Special Education Paraprofessional" ? <img src={window.location.origin + "/images/education_post.svg"} alt="" /> : data.job_type == "Tutor" ? <img src={window.location.origin + "/images/tutor_post.svg"} alt="" /> : "" : ""
                                                                }
                                                                <h5>{data.job_type != null ? data.job_type
                                                                    : ""}
                                                    ...
                                                    <div class="view_profile_btn brownntn" style={{
                                                        float: "right",
                                                        width: "100%",
                                                        textAlign: "right",
                                                        display: "block"
                                                    }}>
                                                        <button style={{ marginRight: "6px" }} onClick={e => setdelete(true)}>
                                                            Close this Job</button>
                                            ...
                                            <div class={"looking_for_candidate_boxs graydata"} >
                                                <div class="looking_for_candidate_box">
                                                                ...
                                                                {data.reviewAvg >= 0 ?
                                                                    <>
                                                                        ...
                                                                        {[...Array(5 - data.reviewAvg)].map((star, index) => {
                                                                            index += 1;
                                                                            return (
                                                                                <svg width="12" height="12" viewBox="0 0 12 12" style={{ marginLeft: "0px" }} fill="none" xmlns="http://www.w3.org/2000/svg" className='blank_star'>
                                                                                    <path d="M7.59557 3.83638C7.66654 3.98687 7.80772 4.09219 7.97219 4.11735L11.4578 4.65058C11.4643 4.65157 11.4855 4.65971 11.4958 4.6931C11.5067 4.72833 11.4952 4.76275 11.4782 4.78004L8.95646 7.35073C8.8449 7.46445 8.79421 7.62453 8.81997 7.78173L9.41511 11.4135C9.42135 11.4516 9.40435 11.4812 9.38889 11.493L9.69151 11.891L9.38889 11.493C9.38189 11.4983 9.37628 11.4997 9.37253 11.4999C9.36881 11.5002 9.36417 11.4997 9.35814 11.4964L6.24111 9.78072C6.091 9.6981 5.90903 9.6981 5.75892 9.78072L2.64189 11.4964C2.63586 11.4997 2.63122 11.5002 2.6275 11.4999C2.62375 11.4997 2.61815 11.4983 2.61115 11.493L2.30852 11.891L2.61114 11.493C2.59568 11.4812 2.57868 11.4516 2.58492 11.4135L3.18006 7.78173C3.20582 7.62453 3.15513 7.46446 3.04358 7.35073L0.521824 4.78004C0.504873 4.76276 0.4933 4.72833 0.504215 4.6931C0.514559 4.65971 0.535772 4.65157 0.542192 4.65059L0.466582 4.15633L0.542193 4.65058L4.02785 4.11735C4.19232 4.09219 4.33349 3.98687 4.40447 3.83638L5.96313 0.531479C5.97646 0.503231 5.9951 0.5 6.00002 0.5C6.00494 0.5 6.02358 0.503231 6.0369 0.531479L7.59557 3.83638Z" stroke="#bbb " stroke-linecap="round" stroke-linejoin="round" fill="#fff" />
                                                                                </svg>
                                                                            );
                                                                        })}
                                                                    </>
                                                        ...
                                                        <div class="post_detail">
                                                            ...
                                                            <div class="post_pay">
                                                                <svg width="14" height="12" viewBox="0 0 14 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path d="M12.3536 2.57143H2.14286C1.90607 2.57143 1.71429 2.37964 1.71429 2.14286C1.71429 1.90607 1.90607 1.71429 2.14286 1.71429H12.4286C12.6654 1.71429 12.8571 1.5225 12.8571 1.28571C12.8571 0.575625 12.2815 0 11.5714 0H1.71429C0.767411 0 0 0.767411 0 1.71429V10.2857C0 11.2326 0.767411 12 1.71429 12H12.3536C13.1041 12 13.7143 11.4233 13.7143 10.7143V3.85714C13.7143 3.14812 13.1041 2.57143 12.3536 2.57143ZM11.1429 8.14286C10.6696 8.14286 10.2857 7.75902 10.2857 7.28571C10.2857 6.81241 10.6696 6.42857 11.1429 6.42857C11.6162 6.42857 12 6.81241 12 7.28571C12 7.75902 11.6162 8.14286 11.1429 8.14286Z" fill="#A98D4B" />
                                                                </svg>
                                                                {profile && profile.country == "Serbia" ? <h5>{data.nanyperhrrate != null ?
                                                                    data.nanyperhrrate.substr(data.nanyperhrrate.lastIndexOf('\\') + 1).split('-')[0] * 100
                                                                    + " - " +
                                                            ...
                                                            <div class="post_fet">
                                                                <svg width="12" height="10" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path d="M7.14287 5.71429H11.4286V8.92857C11.4286 9.52031 10.9489 10 10.3572 10H1.07143C0.479688 10 0 9.52031 0 8.92857V5.71429H4.28572V6.16071C4.28572 6.30864 4.40566 6.42857 4.55358 6.42857H6.87501C7.02294 6.42857 7.14287 6.30864 7.14287 6.16071V5.71429ZM11.4286 3.21429V5H0V3.21429C0 2.62254 0.479688 2.14286 1.07143 2.14286H2.85715V1.07143C2.85715 0.479688 3.33684 0 3.92858 0H7.50001C8.09176 0 8.57144 0.479688 8.57144 1.07143V2.14286H10.3572C10.9489 2.14286 11.4286 2.62254 11.4286 3.21429ZM7.14287 1.42857H4.28572V2.14286H7.14287V1.42857Z" fill="#A98D4B" />
                                                                </svg>
                                                                <h5>{data.tutorintrestedin != null ? data.tutorintrestedin : ""}</h5>
                                                            </div>
                                                            <div class="vi"></div>
                                                            <div class="post_cal">
                                                                <svg width="13" height="14" viewBox="0 0 13 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <path d="M11.9219 4.375H0.328125C0.147656 4.375 0 4.22734 0 4.04688V3.0625C0 2.33789 0.587891 1.75 1.3125 1.75H2.625V0.328125C2.625 0.147656 2.77266 0 2.95312 0H4.04688C4.22734 0 4.375 0.147656 4.375 0.328125V1.75H7.875V0.328125C7.875 0.147656 8.02266 0 8.20312 0H9.29688C9.47734 0 9.625 0.147656 9.625 0.328125V1.75H10.9375C11.6621 1.75 12.25 2.33789 12.25 3.0625V4.04688C12.25 4.22734 12.1023 4.375 11.9219 4.375ZM0.328125 5.25H11.9219C12.1023 5.25 12.25 5.39766 12.25 5.57812V12.6875C12.25 13.4121 11.6621 14 10.9375 14H1.3125C0.587891 14 0 13.4121 0 12.6875V5.57812C0 5.39766 0.147656 5.25 0.328125 5.25ZM3.5 10.8281C3.5 10.6477 3.35234 10.5 3.17188 10.5H2.07812C1.89766 10.5 1.75 10.6477 1.75 10.8281V11.9219C1.75 12.1023 1.89766 12.25 2.07812 12.25H3.17188C3.35234 12.25 3.5 12.1023 3.5 11.9219V10.8281ZM3.5 7.32812C3.5 7.14766 3.35234 7 3.17188 7H2.07812C1.89766 7 1.75 7.14766 1.75 7.32812V8.42188C1.75 8.60234 1.89766 8.75 2.07812 8.75H3.17188C3.35234 8.75 3.5 8.60234 3.5 8.42188V7.32812ZM7 10.8281C7 10.6477 6.85234 10.5 6.67188 10.5H5.57812C5.39766 10.5 5.25 10.6477 5.25 10.8281V11.9219C5.25 12.1023 5.39766 12.25 5.57812 12.25H6.67188C6.85234 12.25 7 12.1023 7 11.9219V10.8281ZM7 7.32812C7 7.14766 6.85234 7 6.67188 7H5.57812C5.39766 7 5.25 7.14766 5.25 7.32812V8.42188C5.25 8.60234 5.39766 8.75 5.57812 8.75H6.67188C6.85234 8.75 7 8.60234 7 8.42188V7.32812ZM10.5 10.8281C10.5 10.6477 10.3523 10.5 10.1719 10.5H9.07812C8.89766 10.5 8.75 10.6477 8.75 10.8281V11.9219C8.75 12.1023 8.89766 12.25 9.07812 12.25H10.1719C10.3523 12.25 10.5 12.1023 10.5 11.9219V10.8281ZM10.5 7.32812C10.5 7.14766 10.3523 7 10.1719 7H9.07812C8.89766 7 8.75 7.14766 8.75 7.32812V8.42188C8.75 8.60234 8.89766 8.75 9.07812 8.75H10.1719C10.3523 8.75 10.5 8.60234 10.5 8.42188V7.32812Z" fill="#A98D4B" />
                                                                </svg>
                                                                <h5>{data.tutorstartdate != null ? data.tutorstartdate : ""}</h5>
                                                            </div>
                                                            <div class="vi"></div>
                                                    ...
                                                    <div class="view_profile_btn" style={{
                                                        float: "right",
                                                        width: "100%",
                                                        textAlign: "right",
                                                        display: "block"
                                            ...
                                            data.jobStatus == 0 ?
                                                <div class="looking_for_candidate_boxs" style={{ display: "block" }}>
                                                    <div class="looking_for_candidate_box">
                                                        <div class="second_sec">
                                                            ...
                                                            <div class="post_detail">
                                                                <div class="post">
                                                                    ...
                                                                    <h5>{data.job_type != null ? data.job_type == "Special Education Paraprofessional" ? "SPED Paraprofessional" : data.job_type == "Special Education Teacher" ? "SPED teacher" : data.job_type
                                                                        : ""}
                                                        ...
                                                        <div class="second_sec">
                                                            <p id={"half" + index} >{data.description != null ? (data.description.substr(0, 100)
                                                            ) : ""}  {data.description != null && data.description.length > 100 ? <span onClick={e => pmore("half" + index, "full" + index, "plink" + index)}>
                                                                ...more</span> : ""} </p>
                                                            <p id={"full" + index} className="hide">{data.description} <span onClick={e => pmore("full" + index, "half" + index, "plink" + index)}> less</span></p>
                                                ...
                                                :
                                                <div class="looking_for_candidate_boxs graydata" style={{ display: "block" }}>
                                                    <div class="looking_for_candidate_box">
                                                        <div class="second_sec">
                                                            <div class="heading">
                                                                <h3>{data.title != null ? data.title : ""}</h3>
                                                        ...
                                                        <div class="view_profile_btn visiterbtn" style={{
                                                            width: "100%"
                                                        }}>
                ...
                <Modal show={delete1} onHide={e => setdelete(false)} className="">
                    <Modal.Body>
                        <div className='promocode_content changestatus'>
                            <h2>
                                Are you sure you want to close this job post?</h2>
                            <p><b>
                                This action will close an active job post and deactivate this profession on your profile.</b></p>
                            <p>
                                Are you sure you want to continue?</p>
                            <button onClick={e => accept()}>
                                Yes</button>
                            <button onClick={e => setdelete(false)}>
                                No</button>
                        </div>
                    </Modal.Body>
                </Modal> : ""}
                                ...
                                <div className='detail work-experience job_performance job_post setp4' >
                                    <div className='form_group full'>
                                        <label><strong>
                                            ...
                                            Details for {list ? list[0].job_type : ""} position</strong></label>


                                        <br />
                                        <label>
                                            Job post title<span >*</span></label>
                                        <textarea rows={2} placeholder={"Experienced " + (list ? list[0].job_type : "") + " with 10 years of experience"} maxlength="70" name='message' onChange={e => {
                                        ...
                                        <span>
                                            Number of characters {(70 - (list[0].title.length))}</span>
                                    </div>
                                    <div className='form_group full sec'>
                                        <label>
                                            Job description<span >*</span></label>
                                        <textarea rows={4} placeholder={
                                            list[0].job_type == "Nanny" ? "My name is Jelena and I am looking for a reliable, responsible and passionate nanny for my 3-year-old son. We are an easy going family of 3 members, and we love to engage in outdoor activities. Nanny would care for my son when I run errands, help with meal preparation for him and take him to the local park (walking distance). We need a nanny for Monday through Friday from 8 A.M. to 12 P.M." :
                                                list[0].job_type == "Special Education Teacher" ? "My name is Jelena and I am looking for a reliable, responsible and passionate special education teacher to work with for my 3-year-old son. We are an easy going family of 3 members, and we love to engage in outdoor activities. We need someone to work with our son in the development of fine motor and language skills.                                            "
                                                    : list[0].job_type == "Special Education Paraprofessional" ? "My name is Jelena and I am looking for a reliable, responsible and passionate special education paraprofessional to work with for my 3-year-old son. We are an easy going family of 3 members, and we love to engage in outdoor activities. We need someone to work with our son in the development of fine motor and language skills and possibly accompany him to the school                   .                                            "
                                                        : list[0].job_type == "Tutor" ? "My name is Jelena and I am looking for a reliable, responsible and experienced English tutor for my 9-year-old son. Our son needs help in reading and writing. Also, we are open for online classes.    " : ""
                                        ...
                                        <span>
                                            Number of characters {(300 - (list[0].description.length))}</span>
                                    ...
                                    <div className='job_note' id="job_note" >
                                        ...
                                        <p>
                                            ...
                                            Please update your profile <Link to="/search-parents" onClick={e => {
                                                localStorage.setItem("edittime", "editall")
                                                localStorage.setItem("search", "Profile")
                                            }} target={"_blank"}>
                                                here </Link>
                                            if you have had some changes in the meantime.
                                        </p>
                                    </div>
                                    <div class="form_group full socialpost ">
                                        <label>
                                            I give my consent for this job to be shared by SensCare platform on social media<span >*</span></label><div class="checkbox create">
                                            <ul>
                                                <li style={{ width: "25% !important" }}>
                                                    <input type="radio" name="e" onClick={e => {
                                                        setedit({ ...edit, plateformonsocialmedia: "Yes" })
                                                    }} defaultChecked={list[0].plateformonsocialmedia == "Yes" ? true : false} /><span>
                                                        Yes</span></li>
                                                <li><input type="radio" name="e" onClick={e => {
                                                    setedit({ ...edit, plateformonsocialmedia: "No" })
                                                }} defaultChecked={list[0].plateformonsocialmedia == "No" ? true : false} /><span>
                                                        No</span></li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <div class="button text-center">
                                ...
                                <div class="pull-right">
                                    <button class="btn confirm" onClick={e => {
                                        if (edit.title != "" && edit.description != "" && edit.plateformonsocialmedia) {
                                            editpost()
                                        }
                                    }}>
                                        Publish</button>
