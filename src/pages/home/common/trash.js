...
export default function Trash_list() {
    ...
    const list = () => {
        ...
        fetch(api + '/api/v1/trashnotifications?' + (refine.weekly != "" ? "weekly=" + refine.weekly : refine.monthly != "" ? "monthly=" + refine.monthly : "")
                                                    ...
                                                    <p >
                                                        ...
                                                        <strong style={{ marginBottom: "8px", display: "block" }} >
                                                            ...
                                                            {data.SenderUserName != null ? data.SenderUserName : ""}   <span>
                                                                {data.created_at ? new Date(data.created_at).toLocaleDateString('en-US', { weekday: 'short' }) + "," + month[new Date(data.created_at).getMonth()] + " " + new Date(data.created_at).getDate() : ""}
                                                                , {new Date(data.created_at).getFullYear()}, {new Date(data.created_at).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</span></strong>
