...
function Share_document_job() {
    ...
    const profile_data = () => {
        ...
        fetch(api + "/api/v1/shareddocumentslist?" + (refine.threedays != "" ? "threedays=" + refine.threedays : refine.withinweek != "" ? "withinweek=" + refine.withinweek : refine.twofourday != "" ? "twofourday=" + refine.twofourday : refine.withinmonth != "" ? "withinmonth=" + refine.withinmonth : ""), requestOptions)
                                    ...
                                    <>
                                        {data.back_doc != null ?
                                            <li>
                                                ...
                                                <span className='date'> {new Date(data.created_at).getDate()}/{new Date(data.created_at).getMonth() + 1}/{new Date(data.created_at).getFullYear()} </span>
