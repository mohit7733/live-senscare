                            ...
                            <div className='add_test'>
                                            ...
                                            {[...Array(5)].map((star, index) => {
                                                ...
                                                return (
                                                    <i
                                                        type="button"
                                                        key={index}
                                                        className={index <= (hover || form_logins.recommendValue) ? "on fa-solid fa-star" : "off fa-regular fa-star"}
                                                        onClick={() => setform_logins({ ...form_logins, recommendValue: index })}
                                        ...
                                        {[...Array(5)].map((star, index) => {
                                            ...
                                            return (
                                                <i
                                                    type="button"
                                                    key={index}
                                                    className={index <= (hover2 || form_logins.navigationValue) ? "on fa-solid fa-star" : "off fa-regular fa-star"}
                                                    onClick={() => setform_logins({ ...form_logins, navigationValue: index })}
                                ...
                                <div className='que1 border'>
                                    ...
                                    <div className='option'>
                                        <label><input type={"radio"} name="service" onClick={e => setform_logins({ ...form_logins, seeService: "Cleaning" })} /><span>Cleaning </span></label>
                                        <label><input type={"radio"} name="service" onClick={e => setform_logins({ ...form_logins, seeService: "Elderly care" })} /><span>Elderly care </span></label>
                                        <label><input type={"radio"} name="service" onClick={e => setform_logins({ ...form_logins, seeService: "Pet care" })} /><span>Pet care </span></label>
                                        <label><input type={"radio"} name="service" onClick={e => setform_logins({ ...form_logins, seeService: "Other" })} /><span>Other </span>
                                            <div className='comment'>
                                                <textarea rows={2} cols={5} placeholder="Type here..." onChange={e => { setform_logins({ ...form_logins, otherService: e.target.value }) }} />
                                        ...
                                        {[...Array(5)].map((star, index) => {
                                            ...
                                            return (
                                                <i
                                                    type="button"
                                                    key={index}
                                                    className={index <= (hover3 || form_logins.overallValue) ? "on fa-solid fa-star" : "off fa-regular fa-star"}
                                                    onClick={() => setform_logins({ ...form_logins, overallValue: index })}
                                ...
                                <div className='que1 border sec2'>
                                    ...
                                    <div className='comment'>
                                        <textarea rows={2} cols={5} onChange={e => { setform_logins({ ...form_logins, userReview: e.target.value }) }} />
                                        <span>Number of characters 70</span>
                                        <div className='errorfield' style={{ bottom: "5px" }}>{error.userReview}  </div>
                                    </div>
                                </div>
                                <div className='buttons'>
                                    <button className='rest' onClick={add_testmonial_api}>Send </button>
