...
import Recommendatins_profile from './recommendations_profile';
...
export default function Recommendations() {
    ...
    const list = () => {
        ...
        fetch(api + "/api/v1/providerrecommendation_notifications?" + (refine.threedays != "" ? "threedays=" + refine.threedays : refine.withinweek != "" ? "withinweek=" + refine.withinweek : refine.twofourday != "" ? "twofourday=" + refine.twofourday : refine.withinmonth != "" ? "withinmonth=" + refine.withinmonth : ""), requestOptions)
    ...
    const delete_in = () => {
        ...
        fetch(api + "/api/v1/providerrecommendation_delete", requestOptions)
            ...
            {view == "" ?
                <>
                    <div class="main-header">
                        <h2 className='border'>New recommendations</h2>
                                        ...
                                        <tr class={data.read_status == 0 ? "unread" : ""} >
                                            <td class="view-message  dont-show">
                                                ...
                                                <span onClick={e => {
                                                    ...
                                                    <span class="username-text" > {data.ParentName} </span> has just sent you a recommendation.
                                                </span>
                                            </td>
                ...
                <div class="main-header">
                    ...
                    <Recommendatins_profile id={view} />
                </div>
            }
        </div>
    )
