                ...
                <Modal show={remove} onHide={e => setremove(false)} >
                    <Modal.Body>
                        <div className='promocode_content signout invite favoritemod'>
                            ...
                            <p class="hidemod">
                            Please visit our    <Link to="/faq" target="_blank">FAQ</Link> and <Link target="_blank" to="/safety-center">Safety center</Link> to read more about SensCare platform and our safety tips.
                            </p>
                        </div>
                    </Modal.Body>
                </Modal >
