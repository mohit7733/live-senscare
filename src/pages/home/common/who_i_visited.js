...
function Who_i_visited() {
    ...
    const [recived, setrecived] = useState(localStorage.getItem("user_type") == "provider" ? "Parents" : "Provider")
    ...
    const profile_data = (a) => {
        ...
        fetch(api + "/api/v1/whoivisited?profile_search=" + (a != undefined ? a : recived), requestOptions)
            .then(response => response.json())
            .then(result => {
    ...
    console.log(detail.country, "hjvhuvhuhvuyvyuj")
    return (
        <>
            <div class="main-header">
                <h2 className='border'>Who I Visited</h2>
                                                ...
                                                <div class="interested_fam_box">
                                                    <div class="image_sec">
                                                        <div class="heart_sec delete">
                                                            <svg onClick={e => favourite_selectapi(data?.visitor_userid)} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M135.2 17.7L128 32H32C14.3 32 0 46.3 0 64S14.3 96 32 96H416c17.7 0 32-14.3 32-32s-14.3-32-32-32H320l-7.2-14.3C307.4 6.8 296.3 0 284.2 0H163.8c-12.1 0-23.2 6.8-28.6 17.7zM416 128H32L53.2 467c1.6 25.3 22.6 45 47.9 45H346.9c25.3 0 46.3-19.7 47.9-45L416 128z"></path></svg>
                                                        </div>
                                                        <img src={data.file_path != null ? api + "/public/assets/images/users/" + data.file_path : "img/nany_img.png"} alt="" />
                                                        <div class="heart_sec">
                                                            {localStorage.getItem("user_type") != "parents" && recived == "Parents" ?
                                                                <Favorite_select id={data?.jobsId?.JID} username={data.first_name} heart2={data.favOrnotjob} />
                                                    ...
                                                    <div class="general_sec">
                                                        ...
                                                        {(() => {
                                                                    try {
                                                                        const parsedData = JSON.parse(data.service_type);
                                                                        const serviceType = Object.values(parsedData)[0];

                                                                        if (serviceType === "Nanny" || serviceType === "Dadilja") {
                                                                            return <img src={window.location.origin + "/images/nany_post.svg"} alt="" />;
                                                                        } else if (serviceType === "Special Education Teacher") {
                                                                            return <img src={window.location.origin + "/images/teacher_post.svg"} alt="" />;
                                                                        } else if (serviceType === "Special Education Paraprofessional") {
                                                                            return <img src={window.location.origin + "/images/education_post.svg"} alt="" />;
                                                                        } else if (serviceType === "Tutor") {
                                                                            return <img src={window.location.origin + "/images/tutor_post.svg"} alt="" />;
                                                                        }
                                                                    } catch (error) {
                                                                ...
                                                                <p>
                                                                    {JSON.parse(data.service_type) != null ? Object.values(JSON.parse(data.service_type))[0] : ""}
                                                                </p>
                                                        </div>
                                                        <div class="detail_sec">
                                                        ...
                                                        <div class="detail_sec">
                                                            ...
                                                            <p>{data.nanyyearexp != null ? data.nanyyearexp : data.setyearexp != null ? data.setyearexp : data.tutorexp != null ? data.tutorexp : data.yearofexpasteacher != null ? data.ofexpasteacher : "0"} {recived == "Parents" ? "" : "Years"} of exp</p></div>
