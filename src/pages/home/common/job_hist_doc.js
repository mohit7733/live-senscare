...
function Job_history_tap_parents(props) {
            ...
            <ul>
                ...
                <li className={props.subtab == "job-applications" ? "active" : ""} onClick={e => {
                    ...
                    navigate("/search-parents/job-applications")
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M1.6 0H8L12.8 4.8V14.4C12.8 15.28 12.08 16 11.2 16H1.592C0.712 16 0 15.28 0 14.4V1.6C0 0.72 0.72 0 1.6 0ZM3.20001 12.8H9.60001V11.2H3.20001V12.8ZM9.60001 9.6H3.20001V8H9.60001V9.6ZM7.20001 1.20001V5.60001H11.6L7.20001 1.20001Z" fill="#636363" />
                    </svg> Job Applications</li>
                <li className={props.subtab ==
                    "interview-invites"  ? "active" : ""} onClick={e => {
                        window.scrollTo({ top: 0, behavior: 'smooth' })
                        props.setsubtab("interview-invites")
                        navigate("/search-parents/interview-invites")
                    }}><svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M10.4999 0.699996V6.99996C10.4999 7.38496 10.1849 7.69996 9.79994 7.69996H2.79998L0 10.4999V0.699996C0 0.314998 0.314998 0 0.699996 0H9.79994C10.1849 0 10.4999 0.314998 10.4999 0.699996ZM11.9001 2.79907H13.3001C13.685 2.79907 14 3.11407 14 3.49907V13.999L11.2001 11.199H3.50011C3.11511 11.199 2.80011 10.884 2.80011 10.499V9.09904H11.9001V2.79907Z" fill="#636363"></path></svg> Interview Invites</li>
                <li className={props.subtab == "recommendation-request" ? "active" : ""} onClick={e => {
                    window.scrollTo({ top: 0, behavior: 'smooth' })
                    ...
                    Recommendation requests </li>
                <li className={props.subtab == "shared-documents" ? "active" : ""} onClick={e => {
                    window.scrollTo({ top: 0, behavior: 'smooth' })
                    ...
                    </svg> Shared Documents</li>
            </ul>
        </>
    )
}

export default Job_history_tap_parents
