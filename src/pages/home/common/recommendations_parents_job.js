...
import Recommendations_parents_profile from './recommendations_parents_profile';
import { Link, useNavigate, useParams } from 'react-router-dom'


export default function Recommendations_profile_job() {
    ...
    const list = () => {
        ...
        fetch(api + "/api/v1/recommendationrequest_notification?" + (refine.threedays != "" ? "threedays=" + refine.threedays : refine.withinweek != "" ? "withinweek=" + refine.withinweek : refine.twofourday != "" ? "twofourday=" + refine.twofourday : refine.withinmonth != "" ? "withinmonth=" + refine.withinmonth : ""), requestOptions)
    ...
    const delete_in = () => {
        ...
        fetch(api + "/api/v1/multideleterecommendation", requestOptions)
            ...
            {view == "" ?
                <>
                    <div class="main-header">
                        <h2 className='border'>Recommendation requests</h2>
                        <div class="mail-header-bar">
                            <p>{interview.length} Recommendations </p>
...
<li onClick={e => {
                                            ...
                                            <td class="view-message  dont-show">
                                                ...
                                                <span onClick={e => {
                                                    ...
                                                    <span class="username-text" onClick={e => {
                                                        navigate("/search-parents/" + slugdata.id + "/" + data.id)
                                                        setview(data.id)
                                                    }}> {data.ProviderName} </span> has just requested a recommendation from you
                                                </span>
                                            </td>
                ...
                <div class="main-header">
                    ...
                    <Recommendations_parents_profile id={view} />
                </div>
            }
        </div>
    )
