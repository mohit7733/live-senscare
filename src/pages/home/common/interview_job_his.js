...
export default function Interview_job_his() {
    ...
    const list = () => {
        ...
        fetch(api + '/api/v1/interviewinvites_notification?' + (refine.threedays != "" ? "threedays=" + refine.threedays : refine.withinweek != "" ? "withinweek=" + refine.withinweek : refine.twofourday != "" ? "twofourdays=" + refine.twofourday : refine.withinmonth != "" ? "withinmonth=" + refine.withinmonth : "")
                                    ...
                                    return (
                                        <tr class={data.read_status == 1 ? "unread" : ""} >
                                            <td class="view-message  dont-show" >
                                                ...
                                                {/* <span class="username-text" onClick={e => setview(data.id)}> {data.ParentsName} </span> */}
                                                <b onClick={e => {
                                                    navigate("/search-providers/" + slugdata.id + "/" + data.id)
                                                    setview(data.id)
                                                }}>{data.title != null ? data.title : ""}   </b>{data.description != null ? data.description : ""}             </td>
