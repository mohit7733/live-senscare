...
function Visiter_detail(props) {
    ...
    const profile_data = () => {
        ...
        fetch(api + "/api/v1/visitorprofileview", requestOptions)
            .then(response => response.json())
            .then(result => {
                setlist([result.data.getProfile])
                ...
                <>
                    ...
                    <div className='detail_invit'>
                        <p>
                            ...
                            <span className='date'>{list && list[0] && list[0].Visitdate ? new Date(list && list[0] && list[0].Visitdate).toLocaleDateString('en-US', { weekday: 'short' }) : ""}, {list && list[0] && list[0].Visitdate ? month[new Date(list && list[0] && list[0].Visitdate).getMonth()] : ""}, {new Date(list && list[0] && list[0].Visitdate).getDate()}, {new Date(list && list[0] && list[0].Visitdate).getFullYear()}, {new Date(list && list[0] && list[0].Visitdate).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' })}</span>

                            {list && list[0] && list[0].read_status == 0 ?
                                <span className='new'>NEW! </span>
                                : ""}
                            {list && list[0] && list[0].profile_headline != null ? list && list[0] && list[0].profile_headline : job && job[0] && job[0].title} </p>
                        <h2>Dear <span>{message}</span>, </h2>
                        <h2 style={{ display: "block" }}>
                            Congratulations, you’ve got a new visitor. <Link to={list && list[0] && list[0].user_type == "provider" ? "/profile-provider/" + (list && list[0] && list[0].user_id) : "/profile-parents/" + (list && list[0] && list[0].user_id)}  > {" " + list && list[0] && list[0].first_name}</Link> visited your profile on {month[new Date(list && list[0] && list[0].Visitdate).getMonth()] + ", " + new Date(list && list[0] && list[0].Visitdate).getDate()}th, {new Date(list && list[0] && list[0].Visitdate).getFullYear()}.
                        </h2>
                    </div>
                                                ...
                                                <div class="looking_for_candidate_box">
                                                    <div class="first_sec">
                                                        <div class="image_sec">
                                                            ...
                                                            <div class="heart_sec">
                                                                <Favorite_profile id={data.id} username={data.first_name} />
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="second_sec">
                                                        <div class="heading">
                                                            <h3>{data.profile_headline != null ? data.profile_headline : job && job[0] && job[0].title} </h3>
                                                        ...
                                                        ) : job && job[0] && job[0].description}   {data.about != null && data.about.length > 100 ? <span onClick={e => pmore("half" + index, "full" + index, "plink" + index)}>...more</span> : job && job[0] && job[0].description} </p>
                                                    ...
                                                    <div class="view_profile_btn visiterbtn">
                                                        <Link to="/search-providers" onClick={e => setTimeout(() => {
                                                            window.location.reload()
                                                        }, 1000)}> <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                        ...
                                                        <Link to={list && list[0] && list[0].user_type == "provider" ? "/profile-provider/" + (list && list[0] && list[0].user_id) : "/profile-parents/" + (list && list[0] && list[0].user_id)} >Visit profile</Link>
                                                    </div>
                                                    <br />
                                                    <br />
                                                        ...
                                                        <div class="looking_for_candidate_box">
                                                            <div class="second_sec">
                                                                ...
                                                                <div class="post_detail">
                                                                    ...
                                                                    <div class="post_cal">
                                                                        <img src={window.location.origin + "/images/post_cal.svg"} alt="" />
                                                                        <h5>{data.nanystartdate != null ? data.nanystartdate : data.tutorintrestedin}</h5>
                                                                    </div>
                                                                    <div class="vi"></div>
                                                                    <div class="post_loc">
                                                                        <img src={window.location.origin + "/images/post_loc.svg"} alt="" />
