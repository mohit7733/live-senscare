...
export default function Document_requests_main() {
    ...
    const list = () => {
        ...
        fetch(api + "/api/v1/documentrequest_notifications?" + (refine.threedays != "" ? "threedays=" + refine.threedays : refine.withinweek != "" ? "withinweek=" + refine.withinweek : refine.twofourday != "" ? "twofourdays=" + refine.twofourday : refine.withinmonth != "" ? "withinmonth=" + refine.withinmonth : ""), requestOptions)
