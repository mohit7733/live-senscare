                            ...
                            <>
                                ...
                                <div className='detail_invit'>
                                    <p style={{ fontSize: "16px", fontWeight: "600" }}>
                                        ...
                                        <Link to={list[0].SenderUsertype == "parents" ? "/profile-parents/" + list[0]?.sender_userid : "/profile-provider/" + list[0]?.sender_userid} >{list && list[0] && list[0].SenderName}</Link> left you a review. </p>
                                                        ...
                                                        <div className='recommend'>
                                                            ...
                                                            <div className='detail'>
                                                                ...
                                                                <div className='buttonrec'>
                                                                    ...
                                                                    <button style={{ marginLeft: "10px" }} onClick={e => setall("hlo")}>See all Reviews</button>
