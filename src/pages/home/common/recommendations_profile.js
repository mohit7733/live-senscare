            ...
            {list && list[0] ?
                <>
                    ...
                    <div className='detail_invit recomend'>
                        ...
                        <h2 className='first'>Dear <span>{message}</span>,</h2> <h2 className='last'>
                        <Link to={"/profile-parents/" + list[0]?.recommendation_userid}>{list && list[0] && list[0].ParentName}</Link> has just sent you a recommendation file.
                        </h2>
                    </div>
                    <div className='doc'>
                        <p onClick={generatePDF}>
                            ...
                            Recommendation_ {list && list[0] && list[0].ParentName}.doc
                        </p>
                        <Link to="" onClick={e => setrequest(true)}>Show preview</Link>
                    </div>
                </>
                : ""
            }
                    ...
                    <Modal.Body>
                        <div className='promocode_content signout invite request recomandationdwn' >
                            ...
                            <span>
                                ...
                                <a href={api + "/public/assets/images/users/" + list[0]?.recommendation_response} download target="_blank" id='btn_pdf'>
                                    <svg width="14" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M10 14V15.25C10 15.6642 9.66422 16 9.25 16H0.75C0.335781 16 0 15.6642 0 15.25V3.75C0 3.33578 0.335781 3 0.75 3H3V12.25C3 13.215 3.78503 14 4.75 14H10ZM10 3.25V0H4.75C4.33578 0 4 0.335781 4 0.75V12.25C4 12.6642 4.33578 13 4.75 13H13.25C13.6642 13 14 12.6642 14 12.25V4H10.75C10.3375 4 10 3.6625 10 3.25ZM13.7803 2.28034L11.7197 0.219656C11.579 0.0790133 11.3882 1.03999e-06 11.1893 0L11 0V3H14V2.81066C14 2.61175 13.921 2.42099 13.7803 2.28034V2.28034Z" fill="#A98D4B" />
                                    </svg>
                                    Download 
                                </a>
                            </span>
                            <p >
                                <br />
                                <iframe style={{ border: "none" }} width='100%' height='450px' src={"https://view.officeapps.live.com/op/embed.aspx?src=" + api + "/public/assets/images/users/" + list[0]?.recommendation_response + "&embedded=true"}></iframe>
                            </p>
                        </div>
                    </Modal.Body>
                </Modal > : ""}
