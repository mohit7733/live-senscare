...
function Job_application_detail(props) {
    ...
    console.log(new Date(list && list[0] && list[0].created_at), list && list[0] && list[0].created_at);
                        ...
                        <div className='detail_invit'>
                            <p>
                                {list && list[0] && list[0].read_status == 0 ?
                                    ...
                                    : ""}
                                {list && list[0] && list[0].profile_headline != null ? list && list[0] && list[0].profile_headline : ""}
                                <span className='date'>{list && list[0] && list[0].created_at ? new Date(list && list[0] && list[0].created_at).toLocaleDateString('en-US', { weekday: 'short' }) : ""}, {list && list[0] && list[0].created_at ? month[new Date(list && list[0] && list[0].created_at).getMonth()] : ""}, {new Date(list && list[0] && list[0].created_at).getDate()}, {new Date(list && list[0] && list[0].created_at).getFullYear()}, {new Date(list && list[0] && list[0].created_at).toLocaleString([], { hour: 'numeric', minute: 'numeric', hour12: true })}</span></p>
                            <h2>
                                Dear <span>{message}</span>,
                            </h2>
                            <h2>
                                Congratulations, <Link to={"/profile-provider/" + list[0]?.user_id} > {list && list[0] && list[0].first_name}</Link> has just applied to your Job post.
                            </h2>
                                                ...
                                                <div class="looking_for_candidate_box">
                                                    <div class="first_sec">
                                                        <div class="image_sec">
                                                            ...
                                                            <div class="heart_sec">
                                                                <Favorite_profile id={data.user_id} username={data.first_name} />
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="second_sec">
                                                        <div class="heading">
                                                            <h3>{list2?.jobstatus?.JobStatus != 1 ? "" : <span class="new-tag3"> Closed</span>}{data.profile_headline != null ? data.profile_headline : ""} </h3>
                                                            {
                                                                list2?.jobstatus?.JobStatus != 1 ?
                                                                    <button style={hired != "" || data.applyjob_hiredstatus == 1 ? { opacity: "0.5" } : {}} onClick={e => accept(data.Appjob_ID)} disabled={hired != "" || data.applyjob_hiredstatus == 1 ? true : false}>{hired != "" || data.applyjob_hiredstatus == 1 ?
                                                                        "Hired" :
                                                                        " Hire"}</button>
                                                                    : ""
                                                            }
                                                            {data.plateformsocialmedia == "Yes" ?
                                                                <Facebook_share link={window.location.origin + "/profile-provider/" + data.user_id} />
                                                                : ""}
                                                        </div>
                                                        <div class="post_general">
                                                            <h6><Link to={"/profile-provider/" + list[0]?.user_id} >{data.first_name != null ? data.first_name + " " + data.last_name + " " : ""}</Link> ({data.dob != undefined ? new Date().getFullYear() - parseInt(data.dob.substr(data.dob.lastIndexOf('\\') + 1).split('-')[0]) : ""})</h6>
                                                            <p>
                                                                {list2.reviewAvg >= 0 ?
                                                                    <>
                                                                        {[...Array(list2.reviewAvg)].map((star, index) => {
                                                                            index += 1;
                                                                            return (
                                                                        ...
                                                                        {[...Array(5 - list2.reviewAvg)].map((star, index) => {
                                                                            index += 1;
                                                                            return (
                                                    ...
                                                    {
                                                        list2?.jobstatus?.JobStatus != 0 ?
                                                            <div class="view_profile_btn">
                                                                <Link to={""} onClick={e => setview(data.user_id)}>Send message</Link>
                                                                {/* onClick={e => setupdate(true)} */}
                                                                <Link to={"/profile-provider/" + data.user_id} >Visit profile</Link>
                                                            </div>
                                                            : ""
                                                    }
                                                </div>
                                                    ...
                                                    <>
                                                        <div class="looking_for_candidate_boxs" style={{ display: "block" }}>
                                                            <div class="looking_for_candidate_box">
                                                                <div class="second_sec">
                                                                    <div class="heading">
                                                                        <h3>{data.profile_headline ? data.profile_headline : ""} </h3>
                                                                        <button style={hired != "" || data.applyjob_hiredstatus == 1 ? { opacity: "0.5" } : {}} onClick={e => accept(data.Appjob_ID)} disabled={hired != "" || data.applyjob_hiredstatus == 1 ? true : false}>{hired != "" || data.applyjob_hiredstatus == 1 ? "Hired" : "Hire"}</button>
                                                                        {data.plateformsocialmedia == "Yes" ?
                                                                            <Facebook_share link={window.location.origin + "/profile-provider/" + data.user_id} />
                                                                            : ""}
                                                                    </div>
                                                                ...
                                                                <div class="view_profile_btn visiterbtn">
                                                                    ...
                                                                    <Link to="/search-providers" style={{
                                                                        ...
                                                                        padding: "5px 0"
                                                                            ...
                                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M11.6942 12.8252C10.4625 13.8106 8.9 14.3998 7.19991 14.3998C3.22351 14.3998 0 11.1763 0 7.19991C0 3.22351 3.22351 0 7.19991 0C11.1763 0 14.3998 3.22351 14.3998 7.19991C14.3998 8.8998 13.8107 10.4621 12.8255 11.6938L15.7661 14.6343C16.0785 14.9467 16.0785 15.4533 15.7661 15.7657C15.4537 16.0781 14.9471 16.0781 14.6347 15.7657L11.6942 12.8252ZM1.59998 7.19991C1.59998 4.10715 4.10715 1.59998 7.19991 1.59998C10.2927 1.59998 12.7998 4.10715 12.7998 7.19991C12.7998 8.70993 12.2022 10.0804 11.2305 11.0875C11.2042 11.108 11.1789 11.1302 11.1548 11.1544C11.1306 11.1785 11.1083 11.2039 11.0879 11.2302C10.0807 12.202 8.7101 12.7998 7.19991 12.7998C4.10715 12.7998 1.59998 10.2927 1.59998 7.19991Z" fill="#7D2B8B" />
                                                                            <circle cx="7.19948" cy="7.20144" r="5.59987" fill="white" />
                                                                        </svg> Search for similar candidate </Link>
                                                                </div>
