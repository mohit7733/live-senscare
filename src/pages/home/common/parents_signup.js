...
function Parents_signup() {
    ...
    }, [error, refresh, contact_code, setcode])

    const signup = () => {
        if (form_logins.username != '' & form_logins.email != '' & form_logins.password != '' & form_logins.c_password != '' & form_logins.first_name != '' & form_logins.last_name != '' & form_logins.dob != '' & form_logins.phone != '' & contact_code.code != '' & form_logins.address != '' & form_logins.city != '' & form_logins.zip != '' & form_logins.country != '' & form_logins.hearAboutUs != '') {
                ...
                <div className='container' style={{ maxWidth: "1920px", padding: "0 40px", }}>
                    <div className='signup_section'>
                        ...
                        <div className={'more_about provider ' + (stap == "stap1" ? "" : "none")}>
                            ...
                            <ul  style={{margin:"0 21% 30px"}}>
                                {/* <li className={category == "parents" ? "active" : "" + nonselect == '' ? "" : "bordererror"} onClick={e => {
                                    setcategory("parents")
                                    setnonselect('')
                                }}>
                                    <span>
                                        <img src={category == "parents" ? './images/parents_fill.svg' : './images/parents.svg'} />
                                        <h4>Parent</h4>
                                    </span>
                                </li>
                                <li className={category == "school" ? "active" : "" + nonselect == ' ' ? " " : "bordererror"} onClick={e => {
                                    setcategory("school")
                                    setnonselect('')
                                    
                                }}>
                                    <span>
                                        <img src={category == "school" ? './images/school_fill.svg' : './images/school.svg'} />
                                        <h4>School</h4>
                                    </span>
                                </li> */}
                                <li className={`category-item ${category === "parents" && nonselect !== 'parents' ? "active" : ""} ${category !== "parents" && nonselect === 'parents' ? "bordererror" : ""}`} onClick={e => {
                                    setcategory("parents");
                                    setnonselect('');
                                }}>
                                    <span>
                                ...
                                <li className={`category-item ${category === "school" && nonselect !== 'school' ? "active" : ""} ${category !== "school" && nonselect === 'school' ? "bordererror" : ""}`} onClick={e => {
                                    setcategory("school");
                                    setnonselect('');
                                }}>
                                    <span>
                            ...
                            <button onClick={e => {
                                category != '' ? setstap("stap2") : setnonselect('Please select yourself.')
                            }}>Next</button>
                        </div>
                        <div className={'describe more_about ' + (stap == "stap2" ? "" : "none")}>
                            ...
                            <button onClick={e => {
                                Object.keys(describe).length >= 1 ? setstap("stap3") : setnonselect('Please select yourself.')
                            }}>Next</button>
                        </div>
                        ...
                        <div className={'signupdetail abslute ' + (stap == "stap1" || stap == "stap2" || stap == "stap3" ? "" : "none")} >
                            ...
                            <ul>
                                <li><img src='./images/thanks_right.svg' /> <span>Add your job post.</span></li>
                                <li><img src='./images/thanks_right.svg' /> <span>Browse a candidate's profile.</span></li>
                                <li><img src='./images/thanks_right.svg' /> <span>Find an ideal candidate.</span></li>
                            </ul>
                        </div>
