...
function Parents_signup() {
  const { t } = useTranslation("parentsSignUp");
  var today = new Date();
      ...
      <div className="container-fluid">
        <div className="container">
          <div className="signup_section">
            ...
            <div
              className={
                "more_about provider " + (stap == "stap1" ? "" : "none")
              }
            >
              ...
              <button
                onClick={(e) => {
                  category != ""
                    ? setstap("stap2")
                    : setnonselect("Please select yourself.");
                }}
              >
                {t("Next")}
              </button>
            ...
            >
              ...
              <form>
                ...
                <div className="form_group">
                  ...
                  />
                  <span className="errorfield">{t(error.last_name)}</span>
                </div>
