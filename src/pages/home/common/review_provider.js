...
function Review_provider() {
    ...
    const list = () => {
        ...
        fetch(api + "/api/v1/reviewnotifications?" + (refine.threedays != "" ? "threedays=" + refine.threedays : refine.withinweek != "" ? "withinweek=" + refine.withinweek : refine.twofourday != "" ? "twofourday=" + refine.twofourday : refine.withinmonth != "" ? "withinmonth=" + refine.withinmonth : ""), requestOptions)
    ...
    const delete_in = () => {
        ...
        fetch(api + (localStorage.getItem("user_type") == "parents" ? "/api/v1/deleteparentsview" : "/api/v1/deleteproviderreview"), requestOptions)
            ...
            {view == "" ?
                <>
                    <div class="main-header">
                        <h2 className='border'>New Reviews</h2>
                        <div class="mail-header-bar">
                            <p>{interview.length} New Reviews</p>
                                                ...
                                                <td class="view-message  dont-show">
                                                    ...
                                                    <span onClick={e => {
                                                        ...
                                                        <span class="username-text" onClick={e => {
                                                            navigate("/search-providers/" + slugdata.id + "/" + data.id)
                                                            setview(data.id)
                                                        }}> {data.SenderName} </span> - {data.review_title}
                                                    </span>
                                                </td>
