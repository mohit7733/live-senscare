...
function Profession_change(props) {
    ...
    const describeselect = (a, b) => {
        if (Object.keys(describe).length < 2) {
            ...
            Object.keys(detail.service_type).filter((e) => e == a)[0] ? setnewprofession({}) : setnewprofession({ ...newprofession, [a]: b });
            setinactiveprofessional({ ...inactiveprofessional, [a]: b })
            setdetail({ ...detail, service_type: { ...detail.service_type, [a]: b } })
            delete jobelete[a];
            ...
            .then(result => {
                ...
                result.data.job[0] ?
                    setTimeout(() => {
                        ...
                        setjobalready({ ...jobalready, id: result.data.job[0].id, id2: result.data.job[1] ? result.data.job[1].id : "", plateformonsocialmedia: result.data.job[0].plateformonsocialmedia != "" ? result.data.job[0].plateformonsocialmedia : "Yes", plateformonsocialmedia2: result.data.job[1] ? result.data.job[1].plateformonsocialmedia : "" })
    ...
    const profile_update = (status) => {
        console.log(Object.values(activeprofession)[0]);
        if (Object.values(activeprofession)[0]) {
            setdetailparents({ ...detailparents, jobs: detail.job[0] && detail.job[0].job_type == Object.values(activeprofession)[0] ? detail.job[0].title : detail.job[1] && detail.job[1].job_type == Object.values(activeprofession)[0] ? detail.job[1].title : "", jobs_description: detail.job[0] && detail.job[0].job_type == Object.values(activeprofession)[0] ? detail.job[0].description : detail.job[1] && detail.job[1].job_type == Object.values(activeprofession)[0] ? detail.job[1].description : "" })
            ...
            detailparents.tutorexp == "" ? formdata.append("nanyperhrrate", usd.min + "-" + usd.max) :
            ...
            formdata.append("inactive_service", Object.keys(jobelete).length > 0 ? JSON.stringify(jobelete) : "");
            detailparents.tutorstartdate2 == "" ? formdata.append("nanyperhrrate", usd.min + "-" + usd.max) : formdata.append("tutorstartdate", detailparents.tutorstartdate2);
            ...
            if (jobpost && Object.keys(activeprofession).length > 0) {
                ...
                detailparents.jobs != "" ? formdata.append("jobs[0][title]", detailparents.jobs) : formdata.append("about", detail.about)
                detailparents.jobs != "" ? formdata.append("jobs[0][description]", detailparents.jobs_description) : formdata.append("about", detail.about)
                detailparents.jobs != "" ? formdata.append("jobs[0][plateformonsocialmedia]", jobalready.plateformonsocialmedia ? jobalready.plateformonsocialmedia : "Yes") : formdata.append("about", detail.about);
                detailparents.jobs != "" ? formdata.append("jobs[0][job_type]", Object.values(activeprofession)[0]) : formdata.append("about", detail.about);

                jobfiletrf[0]?.job_type == Object.values(activeprofession)[0] ? formdata.append("jobs[0][job_id]", jobfiletrf[0]?.id) : jobfiletrf[1]?.job_type == Object.values(activeprofession)[0] ? formdata.append("jobs[0][job_id]", jobfiletrf[1]?.id) : formdata.append("about", detail.about);
            ...
            fetch(api + "/api/v1/updateparents", requestOptions)
                ...
                .then(result => {
                    ...
                    setTimeout(() => {
                        ...
                        if ((activeprofession.tab1 ? usd.max != 0 : activeprofession.tab2 ? usd3.max != 0 : activeprofession.tab4 ? usd2.max != 0 : activeprofession.tab3 ? usd4.max != 0 : status) && status == "preferences") {
                        ...
                        if (Object.keys(activeprofession).length == qcount && status && Object.keys(activeprofession).length >= 0) {
                            setjobpost(true)
                        } else {
                            setqcount(qcount + 1)
                        }
    ...
    useEffect(() => {
        console.log(usd, usd2, usd3, usd4);
    }, [usd, usd2, usd3, usd4])
    return (
        <>
            {
            ...
            {showflogin ?
                <Modal show={showflogin} className="professional_select profchange" onHide={handleCloselogin_first}>
                    <Modal.Body>
                        <div className={'describe more_about '}>
                            <img src={window.location.origin + "/images/sign_logo.svg"} />
                            <h2>It looks like you need a new service.</h2>
                            ...
                            <div className='process_guid '>
                                <ul>
                                    <li className={describe && describe.tab1 == "Nanny" ? "active" : "" + nonselect == '' ? "" : "bordererror"} >
                                        ...
                                        <Link to="" onClick={e => {
                                            ...
                                            <img src={window.location.origin + (describe && describe.tab1 == "Nanny" ? '/images/nanny_fill.svg' : '/images/nanny.svg')} />
                                            <span>Nanny</span>
                                        ...
                                        <div class="personal_preferences">
                                            <label class="switchedit">
                                                ...
                                                }} checked={Object.keys(inactiveprofessional).filter((e) => e == "tab1")[0] ? true : false} />
                                                <span class="slideredit roundedit"></span>
                                            </label>
                                        </div>
                                    </li>
                                    <li className={describe && describe.tab2 == "Special Education Teacher" ? "active" : "" + nonselect == '' ? "" : "bordererror"} >
                                        <div className='checkededit'>
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M0.5 10C0.5 4.75329 4.75329 0.5 10 0.5C15.2467 0.5 19.5 4.75329 19.5 10C19.5 15.2467 15.2467 19.5 10 19.5C4.75329 19.5 0.5 15.2467 0.5 10Z" fill="white" stroke="#636363" stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                        ...
                                        <Link to="" onClick={e => {
                                            ...
                                            <img src={window.location.origin + (describe && describe.tab2 == "Special Education Teacher" ? '/images/teacher_fill.svg' : '/images/teacher.svg')} />
                                        ...
                                        <div class="personal_preferences">
                                            <label class="switchedit">
                                                ...
                                                }} checked={Object.keys(inactiveprofessional).filter((e) => e == "tab2")[0] ? true : false} />
                                                <span class="slideredit roundedit"></span>
                                            </label>
                                        </div>
                                    </li>
                                    <li className={describe && describe.tab3 == "Special Education Paraprofessional" ? "active" : "" + nonselect == '' ? "" : "bordererror"} >
                                        <div className='checkededit'>
                                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M0.5 10C0.5 4.75329 4.75329 0.5 10 0.5C15.2467 0.5 19.5 4.75329 19.5 10C19.5 15.2467 15.2467 19.5 10 19.5C4.75329 19.5 0.5 15.2467 0.5 10Z" fill="white" stroke="#636363" stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                        ...
                                        <Link to="" onClick={e => {
                                            ...
                                            <img src={window.location.origin + (describe && describe.tab3 == "Special Education Paraprofessional" ? '/images/education_fill.svg' : '/images/education.svg')} />
                                        ...
                                        <div class="personal_preferences">
                                            <label class="switchedit">
                                                ...
                                                }} checked={Object.keys(inactiveprofessional).filter((e) => e == "tab3")[0] ? true : false} />
                                                <span class="slideredit roundedit"></span>
                                            </label>
                                        </div>
                                    </li>
                                    <li className={describe && describe.tab4 == "Tutor" ? "active" : "" + nonselect == '' ? "" : "bordererror"}  ><div className='checkededit'>
                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M0.5 10C0.5 4.75329 4.75329 0.5 10 0.5C15.2467 0.5 19.5 4.75329 19.5 10C19.5 15.2467 15.2467 19.5 10 19.5C4.75329 19.5 0.5 15.2467 0.5 10Z" fill="white" stroke="#636363" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                        <input type={"checkbox"} onClick={e => {
                                        ...
                                        <Link to="" onClick={e => {
                                            ...
                                            <img src={window.location.origin + (describe && describe.tab4 == "Tutor" ? '/images/tutor_fill.svg' : '/images/tutor.svg')} />
                                            <span>Tutor</span>
                                        </Link>
                                        <div class="personal_preferences">
                                            <label class="switchedit">
                                                ...
                                                }} checked={Object.keys(inactiveprofessional).filter((e) => e == "tab4")[0] ? true : false} />
                                                <span class="slideredit roundedit"></span>
                                            </label>
                                        </div>
                                    </li>
                                </ul>
                                <p><svg width="32" height="16" viewBox="0 0 32 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M24 0H8C3.584 0 0 3.584 0 8C0 12.416 3.584 16 8 16H24C28.416 16 32 12.416 32 8C32 3.584 28.416 0 24 0Z" fill="#A98D4B" />
                                    <path d="M24.7995 13.5984C21.7008 13.5984 19.1995 11.0971 19.1995 7.99844C19.1995 4.89977 21.7008 2.39844 24.7995 2.39844C27.8981 2.39844 30.3995 4.89977 30.3995 7.99844C30.3995 11.0971 27.8981 13.5984 24.7995 13.5984Z" fill="white" />
                                </svg>
                                 Serves to deactivate a profession as only two professions can be active simultaneously </p>
                                <p>
                                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M0.5 10C0.5 4.75329 4.75329 0.5 10 0.5C15.2467 0.5 19.5 4.75329 19.5 10C19.5 15.2467 15.2467 19.5 10 19.5C4.75329 19.5 0.5 15.2467 0.5 10Z" fill="white" stroke="#7D2B8B" stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                   Serves to select the profession for which you want to create a new job post </p>
                                <div className='noteedit'>
                                    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M7.99128 0C3.58009 0 0 3.584 0 8C0 12.416 3.58009 16 7.99128 16C12.4025 16 15.9826 12.416 15.9826 8C15.9826 3.584 12.4025 0 7.99128 0ZM8.76751 11.9984H7.16925V10.3984H8.76751V11.9984ZM7.16925 8.8H8.76751V4H7.16925V8.8Z" fill="#7D2B8B" />
                                    </svg>
                            ...
                            <button className='back_sign' onClick={handleCloselogin_first} >Cancel</button>
                            <button className='back_sign' onClick={e => {
                                setTimeout(() => {
                                    // activeprofession.tab1 ? setnanny(true) : setnanny(false);
                                    // activeprofession.tab2 ? setteacher(true) : setteacher(false);
                                    // activeprofession.tab3 ? setprofessional(true) : setprofessional(false);
                    ...
                    <Modal.Body>
                        <div className='promocode_content younger confirmchnage'>
                            ...
                            <div class="button text-center">
                                ...
                                <div class="pull-right">
                                    <button class="btn confirm" onClick={handleClose}>No</button>
                                </div>
                            </div>
                        </div>
                    </Modal.Body>
                ...
                <Modal show={tuter} onHide={handleClose4} className="question_new">
                    <Modal.Body>
                        <div className='younger'>
                            ...
                            <p >You can edit your info in settings section later</p>
                                    ...
                                    <div className='tutor parents'>
                                        ...
                                        <div className='col-6 sideby'>
                                            <div className='form_group full'>
                                                ...
                                                <div class="select">
                                                    <select value={detailparents.tutorexp != "" ? detailparents.tutorexp :
                                                       <input placeholder="Choose from the list"  />} onChange={e => {
                                            ...
                                            <div className='form_group full qualification'>
                                                ...
                                                <div className='checkbox'>
                                                    <ul onClick={e => seterrorfield({ ...errorfield, tutorliketoteach: "" })}>
                                                        ...
                                                        <li className='aline'><input type="checkbox" name="" defaultChecked={qualifications.Other ? true : false} /><span>
                                                            Other<input placeholder="Type here" type="text" onChange={e => {
                                                                if (e.target.checked) {
                                            ...
                                            <div className='form_group full'>
                                                ...
                                                <label>Start date<span className={errorfield.tutorstartdate2 != "" ? "starred" : ""}>*</span></label>
                                                ...
                                                setdetailparents({ ...detailparents, tutorstartdate2: e.target.value })
                                                    ...
                                                    <DatePicker className={errorfield.tutorstartdate2 != "" ? "bordererror" : ""} minDate={today} selected={detailparents.tutorstartdate2 != null && detailparents.tutorstartdate2 != "" ? new Date(detailparents.tutorstartdate2) : today} onChange={(date: Date) => {
                                                        seterrorfield({ ...errorfield, tutorstartdate2: "" })
                                                        setdetailparents({ ...detailparents, tutorstartdate2: date.getFullYear() + "-" + String(date.getMonth() + 1).padStart(2, '0') + "-" + String(date.getDate()).padStart(2, '0') })
                                                    }} />
                                                </div>
                                                {/* <div className='errorfield'>{error.message}</div>*/}
                                            </div>
                            ...
                            <div class="button text-center">
                                <div class="pull-right">
                                    <button class="btn" onClick={e => handleClose4()}>Back</button>
                                </div>
                                <div class="pull-right">
                                    <button class="btn confirm" onClick={e => {
                                        if (detailparents.tutorexp != "" && (qualifications.English || qualifications.Serbian || qualifications.Mathematics || qualifications.Physics || qualifications.Chemistry || qualifications.Other) && detailparents.tutorintrestedonlinecls != "" && usd2.max > 5 && detailparents.tutorstartdate2 != "") {
                                            // setqcount(qcount + 1)
                                            handleClose4()
                                            // setjobpost(true)
                                            setTimeout(() => {
                ...
                <Modal show={teacher} onHide={handleClose3} className="question_new">
                    <Modal.Body>
                        <div className='younger'>
                                    ...
                                    <div className='tutor parents'>
                                        ...
                                        <div className='col-6 sideby'>
                                            <div className='form_group full'>
                                                ...
                                                <div class="select">
                                                    <select value={detailparents.tutorexp != "" ? detailparents.tutorexp :
                                                        "Choose from the list" } onChange={e => {
                                                            seterrorfield({ ...errorfield, tutorexp: "" })
                                                            setdetailparents({ ...detailparents, tutorexp: e.target.value })
                                                        }}>
                            ...
                            <div class="button text-center">
                                <div class="pull-right">
                                    <button class="btn" onClick={e => handleClose3()}>Back</button>
                                </div>
                                <div class="pull-right">
                                    <button class="btn confirm"
                                        onClick={e => {
                                            if (detailparents.tutorexp != "" && usd3.max > 5 && detailparents.childneediep != "" && detailparents.tutorstartdate2 != "") {
                                                // setqcount(qcount + 1)
                                                handleClose3()
                                                // setjobpost(true)
                                                setTimeout(() => {
            ...
            {professional ?
                <Modal show={professional} onHide={handleClose2} className="question_new">
                    <Modal.Body>
                        <div className='younger'>
                            ...
                            <div class="button text-center">
                                <div class="pull-right">
                                    <button class="btn" onClick={e => handleClose2()}>Back</button>
                                </div>
                                <div class="pull-right">
                                    <button class="btn confirm" onClick={e => {
                                        if (detailparents.tutorexp != "" && usd4.max > 5 && detailparents.tutorstartdate2 != "") {
                                            // setqcount(qcount + 1)
                                            handleClose2()
                                            // setjobpost(true)
                                            setTimeout(() => {
                ...
                <Modal show={nanny} onHide={handleClose1} className="question_new">
                    <Modal.Body>
                        <div className='younger'>
                                            ...
                                            <div className='iconsec'>
                                                ...
                                                <div className='icon '>
                                                    <div className='form_group' style={{ marginBottom: "0" }}>
                                                        <label>I need<span className={errorfield.childtransportation != "" || errorfield.occasionaltraveling != "" || errorfield.lighthousework != "" || errorfield.cookingforkids != "" ? "starred" : ""}>*</span></label>
                                                    </div>
                                                    <ul>
                                                        <li onClick={e => seterrorfield({ ...errorfield, childtransportation: "" })} >Child transportation
                                                            <div className='icons'>
                                                        ...
                                                        <li onClick={e => seterrorfield({ ...errorfield, occasionaltraveling: "" })} >Occasional traveling
                                                            <div className='icons'>
                                                        ...
                                                        <li onClick={e => seterrorfield({ ...errorfield, lighthousework: "" })} >Light housework
                                                            <div className='icons'>
                                                        ...
                                                        <li onClick={e => seterrorfield({ ...errorfield, cookingforkids: "" })} >Cooking for kids
                                                            <div className='icons'>
                            ...
                            <div class="button text-center">
                                <div class="pull-right">
                                    <button class="btn" onClick={e => handleClose1()}>Back</button>
                                </div>
                                <div class="pull-right">
                                    <button class="btn confirm" onClick={e => {
                                        if (detailparents.tutorexp != "" && usd.max > 5 && habit.licence && habit.family && habit.housework && habit.kids && detailparents.liveinnany != "" && detailparents.tutorstartdate2 != "") {
                                            // setqcount(qcount + 1)
                                            handleClose1()
                                            // setjobpost(true)
                                            setTimeout(() => {
                ...
                <Modal show={jobpost} onHide={e => {
                    ...
                    <Modal.Body>
                        <div className='younger'>
                            ...
                            <br></br>
                            <p ><b>Create new Job post</b></p>
                            <div className='Profile_complete'>
                                <div className='detail work-experience job_performance job_post setp4' >


                                    {activeprofession && Object.keys(activeprofession).length == 2 ?
                                        <>
                                            <div className='form_group full'>
                                                <label><strong>Details for {Object.values(activeprofession)[1]} position </strong></label>
                                                <br />
                                                <label>Job post title<span className={errorfield.jobs2 != "" ? "starred" : ""}>*</span></label>
                                                <textarea placeholder={'Hello, we are a family of three and we love outdoor activities. We also have an adorable cat.'} rows={2} maxlength="70" name='message' onChange={e => {
                                                    seterrorfield({ ...errorfield, jobs2: "" })
                                                    setjobalready({ ...jobalready, job_type2: Object.values(activeprofession)[1] })
                                                    setdetailparents({ ...detailparents, jobs2: e.target.value })
                                                }} defaultValue={detailparents.jobs2}></textarea>

                                                {/* <div className='errorfield'>{error.message}</div>*/}
                                                <span>Number of characters {(70 - (detailparents.jobs2 != "" ? detailparents.jobs2.length : 0))}</span>
                                            </div>
                                            <div className='form_group full sec'>
                                                <label>Job description<span className={errorfield.jobs_description2 != "" ? "starred" : ""}>*</span></label>
                                                {activeprofession ? <textarea placeholder={
                                                    activeprofession ? Object.keys(activeprofession)[1] == "tab1" ? "My name is Jelena and I am looking for a reliable, responsible and passionate nanny for my 3-year-old son. We are an easy going family of 3 members, and we love to engage in outdoor activities. Nanny would care for my son when I run errands, help with meal preparation for him and take him to the local park (walking distance). We need a nanny for Monday through Friday from 8 A.M. to 12 P.M." :
                                                        Object.keys(activeprofession)[1] == "tab2" ? "My name is Jelena and I am looking for a reliable, responsible and passionate special education teacher to work with for my 3-year-old son. We are an easy going family of 3 members, and we love to engage in outdoor activities. We need someone to work with our son in the development of fine motor and language skills.                                            " :
                                                            Object.keys(activeprofession)[1] == "tab3" ? "My name is Jelena and I am looking for a reliable, responsible and passionate special education paraprofessional to work with for my 3-year-old son. We are an easy going family of 3 members, and we love to engage in outdoor activities. We need someone to work with our son in the development of fine motor and language skills and possibly accompany him to the school                   .                                            "
                                                                : Object.keys(activeprofession)[1] == "tab4" ? "My name is Jelena and I am looking for a reliable, responsible and experienced English tutor for my 9-year-old son. Our son needs help in reading and writing. Also, we are open for online classes.    " : "" : ""
                                        ...
                                        : ""}
                                    <div className='form_group full'>
                                        <label><strong>Details for {activeprofession ? Object.values(activeprofession)[0] : ""} position </strong></label>
                                        <br />
                                        <label>Job post title<span className={errorfield.jobs != "" ? "starred" : ""}>*</span></label>
                                        {activeprofession ?
                                            <textarea placeholder={"Experienced " + (activeprofession ? Object.values(activeprofession)[0] : "") + " with 10 years of experience"} rows={2} maxlength="70" name='message' onChange={e => {
                                                seterrorfield({ ...errorfield, jobs: "" })
                                                setdetailparents({ ...detailparents, jobs: e.target.value })
                                                setjobalready({ ...jobalready, job_type: Object.values(activeprofession)[0] })
                                            }} defaultValue={detail.job[0] && detail.job[0].job_type == Object.values(activeprofession)[0] ? detailparents.jobs : detail.job[1] && detail.job[1].job_type == Object.values(activeprofession)[0] ? detailparents.jobs : ""}></textarea> : ""}
                                        {/* <div className='errorfield'>{error.message}</div>*/}
                                        {console.log(detailparents.jobs)}
                                        <span>Number of characters {(70 - ((typeof detailparents.jobs) != "number" ? detailparents.jobs.length : 0))}</span>
                                    </div>
                                    <div className='form_group full sec'>
                                        <label>Job description<span className={errorfield.jobs_description != "" ? "starred" : ""}>*</span></label>
                                        {activeprofession ? <textarea placeholder={
                                            activeprofession ? Object.keys(activeprofession)[0] == "tab1" ? "My name is Jelena and I am looking for a reliable, responsible and passionate nanny for my 3-year-old son. We are an easy going family of 3 members, and we love to engage in outdoor activities. Nanny would care for my son when I run errands, help with meal preparation for him and take him to the local park (walking distance). We need a nanny for Monday through Friday from 8 A.M. to 12 P.M." :
                                                Object.keys(activeprofession)[0] == "tab2" ? "My name is Jelena and I am looking for a reliable, responsible and passionate special education teacher to work with for my 3-year-old son. We are an easy going family of 3 members, and we love to engage in outdoor activities. We need someone to work with our son in the development of fine motor and language skills.                                            "
                                                    : Object.keys(activeprofession)[0] == "tab3" ? "My name is Jelena and I am looking for a reliable, responsible and passionate special education paraprofessional to work with for my 3-year-old son. We are an easy going family of 3 members, and we love to engage in outdoor activities. We need someone to work with our son in the development of fine motor and language skills and possibly accompany him to the school                   .                                            "
                                                        : Object.keys(activeprofession)[0] == "tab4" ? "My name is Jelena and I am looking for a reliable, responsible and experienced English tutor for my 9-year-old son. Our son needs help in reading and writing. Also, we are open for online classes.    " : "" : ""
                                        ...
                                        }} defaultValue={detail.job[0] && detail.job[0].job_type == Object.values(activeprofession)[0] ? detailparents.jobs_description : detail.job[1] && detail.job[1].job_type == Object.values(activeprofession)[0] ? detailparents.jobs_description : ""}></textarea> : ""}
                                        {/* <div className='errorfield'>{error.message}</div>*/}
                                        <span>Number of characters {(300 - (detailparents.jobs_description.length))}</span>
                                    ...
                                    <div className='job_note' id="job_note" >
                                        ...
                                        <p>
                                            Your old profile information will be applied to this job post, too. <br />
                                            Please update your profile  <Link to="/search-parents/Profile" onClick={e => {
                                                localStorage.setItem("edittime", "editall")
                                                localStorage.setItem("search", "Profile")
                                            }} target={"_blank"}> here </Link>  if you have had some changes in the meantime.
                                        </p>
                                    </div>
                            ...
                            <div class="button text-center">
                                <div class="pull-right">
                                    <button class="btn" onClick={e => handleClose5()}>Back</button>
                                </div>
                                <div class="pull-right">
                                    <button class="btn confirm" onClick={e => {
                                        if (detailparents.jobs != "" && detailparents.jobs_description != "" && (activeprofession && Object.keys(activeprofession).length == 2 ? detailparents.jobs2 != "" && detailparents.jobs_description2 != "" && jobalready.plateformonsocialmedia2 && jobalready.plateformonsocialmedia : detailparents.jobs != "")) {
                                            setcount2(false)
                                            setTimeout(() => {
                                                handleClose5()
                ...
                <Modal show={livenow} onHide={e => window.location.reload()}>
                    <Modal.Body>
                        <div className='promocode_content login_first'>
                            <Link to="" onClick={e => window.location.reload()}>+ </Link>
                            <h2>Congratulations! Your post is live now.</h2>
                            <img src={window.location.origin + '/images/create_profile.png'} />
                            <p className='pro'>SensCare wishes you to find the best provider! See your post <Link to="/search-parents/job-post" target="_blank" onClick={e => {
