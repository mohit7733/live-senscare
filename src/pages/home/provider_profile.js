...
function Profile_provider() {
    ...
    const [subtab, setsubtab] = useState(localStorage.getItem("search") && localStorage.getItem("search") != "" ? localStorage.getItem("search") : "")
    ...
    const custom = (e) => {
        if (catopen) {
            ...
            let y = window.document.getElementById("leftdataback")
            y.style.background = "#FAFAFA"
            setcatopen(false)
    ...
    const jobs_list_send = () => {
        ...
        fetch(api + "/api/v1/currentactivejobs?providerid=" + slugdata.id, requestOptions)
        .then(response => {
            if (!response.ok) {
    ...
    const profiledata = () => {
        ...
        fetch(api + "/api/" + (localStorage.getItem("token") != null ? "v1/favotheruserprofileview" : "otheruserprofileview"), requestOptions)
            .then(response => response.json())
            .then(result => {
                ...
                setusd({
                    ...
                    max: result.data.nanyperhrrate != null ? result.data.nanyperhrrate.substr(result.data.nanyperhrrate.lastIndexOf('\\') + 1).split('-')[1] : 0
                })
                settutorusd({
                ...
                setusd3({
                    ...
                    max: result.data.seterhrrate != null ? result.data.seterhrrate.substr(result.data.seterhrrate.lastIndexOf('\\') + 1).split('-')[1] : 0
                })
                setusd4({
                    min: result.data.seperhrrate != null ? result.data.seperhrrate.substr(result.data.seperhrrate.lastIndexOf('\\') + 1).split('-')[0] : 0,
                    max: result.data.seperhrrate != null ? result.data.seperhrrate.substr(result.data.seperhrrate.lastIndexOf('\\') + 1).split('-')[1] : 0
                })
    ...
    const provider_list = () => {
        ...
        fetch(api + "/api/jobslisting?keyword=" + search.keyword + "&distance=" + search.distance + "&lat=" + latlong.lat + "&lng=" + latlong.lng + "&city=" + search.city + "&zip=" + search.zip + "&tutorintrestedin[]=" + search.tutorintrestedin + "&tutorintrestedin[]=" + search.tutorintrestedin1 + "&tutorintrestedin[]=" + search.tutorintrestedin2 + "&tutorworkwithnochild=" + children + "&rates=" + (usd.min + "-" + usd.max) + "&workingabroad=" + search.workingabroad + "&tutorintrestedinschool=" + search.tutorintrestedinschool + (cat.data1 != "" ? "&jobcategory[]=" + cat.data1 : "&jobcategory[]=") + (cat.data2 != "" ? "&jobcategory[]=" + cat.data2 : "&jobcategory[]=") + (cat.data3 != "" ? "&jobcategory[]=" + cat.data3 : "&jobcategory[]=") + (cat.data4 != "" ? "&jobcategory[]=" + cat.data4 : "&jobcategory[]=") + "&tutorprefchildage=" + search.tutorprefchildage + "&carorlicence=" + search.carorlicence + "&withinweek=" + search.withinweek + "&withinmonth=" + search.withinmonth + "&jobposted=" + search.jobposted, requestOptions)
            .then(response => response.json())
            .then(result => {
                // console.log(result)
                // setlist(result.data)
    ...
    var settings2 = {
        dots: false,
        infinite: true,
        slidesToShow: profile.reviewData?.length > 2 ? 3 : profile.reviewData?.length,
        arrows: true,
        slidesToScroll: 1,
        autoplay: false,
        autoplaySpeed: 2000,
        ...
        <>
...

            {
                status ? <div className='popup_status' id="popup_status">
                    ...
                    Congratulations, you successfully sent an interview invite!
                </div> : ""
            }
            {
                status2 ? <div className='popup_status' id="popup_status">

                    Congratulations. You successfully requested a document!
                </div> : ""
            }
                                            ...
                                            advance_search != false ?
                                                <div className='filters_search detail work-experience' id="filtern" style={profile.about == "" || profile.about == null || !localStorage.getItem("token") || !localStorage.getItem("id") || localStorage.getItem("refine") ? { display: 'block' } : { display: 'none' }} >
                                                    ...
                                                    <div className='form_group full border'>
                                                        <label>
                                                            Hourly rate{profile && profile.country == "Serbia" ? "(RSD)" : "(USD)"}</label>
                                                        ...
                                                        <span className="price">{profile && profile.country == "Serbia" ? usd.min * 100 + " - " + usd.max * 100 : usd.min + " - " + usd.max}</span>
                                                        {/* <div className='errorfield'>{error.message}</div> */}
                                                    </div>
                                                    ...
                                                    <div className='job_performance'>
                                                        <div className='form_group   full border'>
                                                            ...
                                                            <div className='text customselect '>
                                                                {children_age ?
                                                                    <span className='keyword' onClick={e => custom2("cate5", "over2")} style={{
                                                            ...
                                                            <div className='customselect inp'>
                                                                ...
                                                                <div className='overflow' id='over2' onClick={e => custom2("cate5", "over2")}></div>
                                                                <div className='option' id='cate5'>

                                                                    <p ><input type="checkbox" onClick={a => selectoption2("0 - 1 years")} /><h3>{"0 - 1 years"}</h3><span></span></p>
                                                                    <p ><input type="checkbox" onClick={a => selectoption2("4 - 7 years")} /><h3>{"4 - 7 years"} </h3><span></span></p>
                                                                    <p ><input type="checkbox" onClick={a => selectoption2("8 - 10 years")} /><h3>{"8 - 10 years"}  </h3><span></span></p>
                                                                    <p ><input type="checkbox" onClick={a => selectoption2("11 - 15 years")} /><h3>{"11 - 15 years"} </h3><span></span></p>
                                                                    <p ><input type="checkbox" onClick={a => selectoption2("16+  years")} /><h3>{"16+  years"} </h3><span></span></p>
                                                                </div>
                                                    ...
                                                    <div className='form_group full qualification'>
                                                        ...
                                                        <div className='checkbox create'>
                                                            <ul>
                                                                <li><input type="checkbox" name="b" onClick={e => {
                                                                    setsearch({ ...search, carorlicence: e.target.checked })
                                                                }} /><span>

                                                                        Without transportation </span></li>
                                                                <li><input type="checkbox" name="b" onClick={e => {
                                                                    setsearch({ ...search, jobposted: e.target.checked })
                                                                }} /><span>

                                                                        Jobs posted within a week</span></li>
                                                                <li><input type="checkbox" name="b" onClick={e => {
                                                                    if (e.target.checked) {
                                                                ...
                                                                <li><input type="checkbox" name="b" onClick={e => {
                                                                    if (e.target.checked) {
                                                                        setsearch({ ...search, tutorintrestedinschool: "Yes" })
                                                                    } else {
                                                                        setsearch({ ...search, tutorintrestedinschool: "" })
                                                                    }
                                                                }} /><span>
                                                    ...
                                                    <button onClick={e => {
                                                        localStorage.setItem("filter", JSON.stringify({ category: category, distance: search.distance, zip: search.zip, city: search.city, cat: cat }))
                                                        provider_list()
...
/>
                                                    <div className='overflow' id='over3' onClick={e => custom3("cate9", "over3")} style={recommend != "" ? { display: "block" } : { display: "none" }}></div>
                                                    <div className='option' id='cate9' style={recommend != "" ? { display: "block" } : { display: "none" }}>
                ...
                <div className="container" style={{ overflow: "hidden" }}>
                    <div className="body_section searchbody " style={subtab != "" ? { minHeight: "auto", marginBottom: "100px", float: "left", width: "100%" } : {}}>
                                ...
                                <>
                                    <div className="profile_box">
                                        <div className="profile_box_social">
                                            <div className="profile_box_social_sec1">
                                                {localStorage.getItem("user_type") == "parents" ?
                                                    <Facebook_share link={window.location.origin + "/profile-parents/" + selfprofile.id} />
                                                    :
                                                    <Facebook_share link={window.location.origin + "/profile-provider/" + selfprofile.id} />
                                                }
                                                {
                                                ...
                                                {
                                                    selfprofile.facebookverify != null || selfprofile.linkdinverify != null ?
                                            ...
                                            {localStorage.getItem("user_type") == "parents" ?
                                                ...
                                                <div className="profile_box_social_sec2">
                                                    {
                                                        selfprofile.service_type && selfprofile.service_type.tab1 == "Nanny" ? <img src={window.location.origin + "/images/nany_pur.svg"} alt="" /> : ""}
                                                    {
                                                        selfprofile.service_type && selfprofile.service_type.tab2 ? <img src={window.location.origin + "/images/special_education.svg"} alt="" /> : ""}
                                                    {
                                                        selfprofile.service_type && selfprofile.service_type.tab3 ? <img src={window.location.origin + "/images/professional.svg"} alt="" /> : ""}
                                                    {
                                                        selfprofile.service_type && selfprofile.service_type.tab4 ? <img src={window.location.origin + "/images/tutorform.svg"} alt="" /> : ""
                                                    }
                                                </div>
                                            }
                                        </div>
                                        <div className="profile_pic_sec">
                                            ...
                                            <div className="profile_pic">
                                                <img src={api + "/public/assets/images/users/" + selfprofile.file_path} width="80" height="80" alt="" />
                                        ...
                                        <div className="profile_detail">
                                            <p>{selfprofile.first_name + ' ' + selfprofile.last_name} ({selfprofile.dob != undefined ? new Date().getFullYear() - parseInt(selfprofile.dob.substr(selfprofile.dob.lastIndexOf('\\') + 1).split('-')[0]) : ""})</p>
                                            <div className="profilestart_video">
                                                <a>
                                                    <img src={window.location.origin + "/images/video.svg"} alt="" />
                                                </a>
                                                <span className='tooltipu'><strong>
                                                    Upgrade</strong>
                                                    to post media. </span>
                                                {selfprofile.reviewAvg >= 0 ?
                                                    <>
                                                        {[...Array(selfprofile.reviewAvg)].map((star, index) => {
                                                            index += 1;
                                                            return (
                                                        ...
                                                        {[...Array(5 - selfprofile.reviewAvg)].map((star, index) => {
                                                            index += 1;
                                                            return (
                                        ...
                                        <div className="profile_functions">
                                            <div className="members">
                                                <h5>{(new Date().getFullYear() - new Date(selfprofile.created_at).getFullYear()) > 0 ? (new Date().getFullYear() - new Date(selfprofile.created_at).getFullYear()) + " YRS" : 0 + " YRS"} </h5>
                                                <h6>
                                                    Member</h6>
                                            </div>
                                    ...
                                    <div className="silde_bar_dropdowns">
                                        <button type="button" className="side_drop_collapse" onClick={e => setprofilesection(profilesection != "notifications" ? "notifications" : "")}><img src={window.location.origin + "/images/notification.svg"} alt="" />
                                            <h4>
                                                Notifications<span> (<Count_notification />)</span></h4>
                                        </button>
                                        ...
                                        <div className="side_drop_collapse_box_content Document_main side_drop_collapse" style={profilesection == "fav" ? { display: 'block' } : { display: 'none' }}>
                                            <ul style={profilesection != "" ? { display: "block" } : { display: "none" }}>
                                                ...
                                                }} className={subtab == "who-visited-me" ? "active upgrade" : "upgrade"}>
                                                    Who Visited Me <span><Link to={""}
                        ...
                        {subtab == "" && profile?.username ?
                            <div className='Account  editview profileshow' style={{ width: "calc(100% - 22.5%)" }}>
                                <h2>
                                    Profile Overview  <Link to={localStorage.getItem("back") ? "/search-providers/" + localStorage.getItem("back") : "/search-providers"}><svg width="17" height="8" viewBox="0 0 17 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div className='profile_full left_side_section '>
                                        <div className="profile_box">
                                            ...
                                            <div className="profile_detail">
                                                ...
                                                <p>{profile.first_name + ' ' + profile.last_name} ({profile.dob != undefined ? new Date().getFullYear() - parseInt(profile.dob.substr(profile.dob.lastIndexOf('\\') + 1).split('-')[0]) : ""}) <a className="heart_sec">
                                                    {localStorage.getItem("user_type") == "parents" && selfprofile.id != profile.id ?
                                                        <Favorite_profile id={profile.id} username={profile.username} heart2={profile.favornotprofile} />
                                                        : ""
                                                    }
                                                </a></p>
                                                <div className="profilestart_video">
                                                    ...
                                                    {profile.reviewAvg >= 0 ?
                                                        profile.invitationData && [profile.invitationData].filter((e) => e.ParentId == selfprofile.id)[0]?.inviteStatus == 1 && profile.checkreviewstatus != true || profile.checkapplyornot == true ?
                                                            <>
                                                                {[...Array(profile.reviewAvg)].map((star, index) => {
                                                                    index += 1;
                                                                    return (
                                                                        <svg onClick={e => setreviewmodel(true)} width="12" height="12" style={{ marginLeft: "3px" }} viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M6.00002 0C6.20763 0 6.39724 0.123352 6.48913 0.318198L8.0478 3.6231L11.5335 4.15633C11.7388 4.18776 11.9094 4.33847 11.9734 4.54514C12.0374 4.7518 11.9838 4.97859 11.8351 5.13018L9.31339 7.70087L9.90853 11.3326C9.94363 11.5468 9.8595 11.7633 9.69151 11.891C9.52352 12.0187 9.30082 12.0355 9.11704 11.9344L6.00002 10.2188L2.88299 11.9344C2.69922 12.0355 2.47651 12.0187 2.30852 11.891C2.14054 11.7633 2.0564 11.5468 2.0915 11.3326L2.68664 7.70087L0.164889 5.13018C0.0161881 4.97859 -0.0374153 4.7518 0.026609 4.54514C0.0906331 4.33847 0.261186 4.18776 0.466582 4.15633L3.95224 3.6231L5.5109 0.318198C5.6028 0.123352 5.79241 0 6.00002 0Z" fill="#A98D4B" />
                                                                        </svg>
                                                                ...
                                                                {[...Array(5 - profile.reviewAvg)].map((star, index) => {
                                                                    index += 1;
                                                                    return (
                                                                        <svg onClick={e => setreviewmodel(true)} width="12" height="12" viewBox="0 0 12 12" style={{ marginLeft: "3px" }} fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                            <path d="M7.59557 3.83638C7.66654 3.98687 7.80772 4.09219 7.97219 4.11735L11.4578 4.65058C11.4643 4.65157 11.4855 4.65971 11.4958 4.6931C11.5067 4.72833 11.4952 4.76275 11.4782 4.78004L8.95646 7.35073C8.8449 7.46445 8.79421 7.62453 8.81997 7.78173L9.41511 11.4135C9.42135 11.4516 9.40435 11.4812 9.38889 11.493L9.69151 11.891L9.38889 11.493C9.38189 11.4983 9.37628 11.4997 9.37253 11.4999C9.36881 11.5002 9.36417 11.4997 9.35814 11.4964L6.24111 9.78072C6.091 9.6981 5.90903 9.6981 5.75892 9.78072L2.64189 11.4964C2.63586 11.4997 2.63122 11.5002 2.6275 11.4999C2.62375 11.4997 2.61815 11.4983 2.61115 11.493L2.30852 11.891L2.61114 11.493C2.59568 11.4812 2.57868 11.4516 2.58492 11.4135L3.18006 7.78173C3.20582 7.62453 3.15513 7.46446 3.04358 7.35073L0.521824 4.78004C0.504873 4.76276 0.4933 4.72833 0.504215 4.6931C0.514559 4.65971 0.535772 4.65157 0.542192 4.65059L0.466582 4.15633L0.542193 4.65058L4.02785 4.11735C4.19232 4.09219 4.33349 3.98687 4.40447 3.83638L5.96313 0.531479C5.97646 0.503231 5.9951 0.5 6.00002 0.5C6.00494 0.5 6.02358 0.503231 6.0369 0.531479L7.59557 3.83638Z" stroke="#A98D4B" stroke-linecap="round" stroke-linejoin="round" />
                                                                        </svg>
                                                                    );
                                                                })}
                                        ...
                                        <div className='quarybtn' >
                                            {!localStorage.getItem("token") || !localStorage.getItem("id") ? <Link to="/signup" className='message'>Interview invite</Link> :
                                                profile.invitationData && [profile.invitationData].filter((e) => e.ParentId == selfprofile.id)[0]?.inviteStatus == 1 || profile.checkapplyornot == true ?
                                                    <button className='message' onClick={e => {
                                                        navigate("/search-providers/message-inbox/" + profile.id)
                                                        ...
                                                        Send message</button>
                                                    : profile.invitationData && [profile.invitationData].filter((e) => e.ParentId == selfprofile.id)[0]?.inviteStatus == 0 || ecomen != "" ?
                                                        <button className={'message'} style={{ opacity: "0.5" }}>Interview Requested</button> :
                                                        profile.invitationData && [profile.invitationData].filter((e) => e.ParentId == selfprofile.id)[0]?.inviteStatus == 2 ? <button className='message'>Interview Declined</button>
                                                            : <button className={'message'} onClick={e => {
                                                                selfprofile.user_type == "parents" && !selfprofile.job[0] ? setShowfprovider2(true) : setinterviewinvite(true)
                                                            }} disabled={selfprofile.id == profile.id || selfprofile.user_type == "provider" ? true : false} style={selfprofile.id == profile.id || selfprofile.user_type == "provider" ? { opacity: "0.5" } : {}}>Interview invite</button>
                                            }
                                            <button style={selfprofile.id == profile.id || selfprofile.user_type == "provider" || profile.checkdocreqstatus ? { opacity: "0.5" } : {}} className='ask' onClick={e => {
                                                selfprofile.user_type == "parents" && !selfprofile.job[0] ? setShowfprovider2(true) : setrequest(true)
                                            }} disabled={selfprofile.id == profile.id || selfprofile.user_type == "provider" || profile.checkdocreqstatus ? true : false}>Request documents</button>
                                        </div>
                                    </div>
                                    <p>
                                        <h4>
                                        ...
                                        <div className='quarybtn' >
                                            {!localStorage.getItem("token") || !localStorage.getItem("id") ? <Link to="/signup" className='message'>Interview invite</Link> :
                                                profile.invitationData && [profile.invitationData].filter((e) => e.ParentId == selfprofile.id)[0]?.inviteStatus == 1 || profile.checkapplyornot == true ?
                                                    ...
                                                    profile.invitationData && [profile.invitationData].filter((e) => e.ParentId == selfprofile.id)[0]?.inviteStatus == 0 || ecomen != "" ?
                                                        <button className={'message'} style={{ opacity: "0.5" }}>Interview Requested</button> :
                                                        profile.invitationData && [profile.invitationData].filter((e) => e.ParentId == selfprofile.id)[0]?.inviteStatus == 2 ? <button className='message' style={{ opacity: "0.5" }}>Interview Declined</button>
                                                            :
                                                            <button className={'message'} onClick={e => {
                                                                selfprofile.user_type == "parents" && !selfprofile.job[0] ? setShowfprovider2(true) : setinterviewinvite(true)
                                                            }} disabled={selfprofile.id == profile.id || selfprofile.user_type == "provider" ? true : false} style={selfprofile.id == profile.id || selfprofile.user_type == "provider" ? { opacity: "0.5" } : {}}>Interview invite</button>
                                            }
                                            <button style={selfprofile.id == profile.id || selfprofile.user_type == "provider" || profile.checkdocreqstatus ? { opacity: "0.5" } : {}} className='ask' onClick={e => setrequest(true)} disabled={selfprofile.id == profile.id || selfprofile.user_type == "provider" || profile.checkdocreqstatus ? true : false}>Request documents</button>
                                ...
                                <div className={ssubtab.security == "active" ? "active personal" : "personal"} >
                                    ...
                                    {ssubtab.security == "active" ?
                                        <div className='editkids security mg'>
                                            <label style={{ float: 'left', width: "50%" }}>Verified accounts <span><strong>
                                                <div className='social_verify'>
                                                    <svg className={profile.facebookverify == "true" ? "active" : ""} width="40" height="40" viewBox="0 0 40 40" fill="#fff" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <svg className={profile.linkdinverify == "true" ? "active" : ""} width="40" height="40" viewBox="0 0 42 42" fill="#fff" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            {profile.backgroundstatus == "Yes" ?
                                                <label style={{ float: 'left', width: "50%", clear: "none", marginTop: "18px" }}><span><strong><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    Background check </strong></span> </label>
                                                : ""}
                                        </div>
                                        : ""}
                                </div>
                                <div className={ssubtab.Reviews == "active" ? "active personal" : "personal"} >
                                    <h3 onClick={e => setssubtab({ ...ssubtab, Reviews: ssubtab.Reviews == "" ? "active" : "" })}>
                                        Reviews</h3>
                                    {ssubtab.Reviews == "active" ?
                                        profile.reviewData.length > 0 ?
                                            <Slider ref={sliderRef} {...settings2} id="Slider-4" className='slider_test reviewshow'>
                                                                    ...
                                                                    <div className='right_content'>
                                                                        ...
                                                                        <span>
                                                                            {[...Array(data.rating)].map((star, index) => {
                                                                                index += 1;
                                                                                return (
                                                                                    <svg width="12" height="12" style={{ marginRight: "5px" }} viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                        <path fill-rule="evenodd" clip-rule="evenodd" d="M6.00002 0C6.20763 0 6.39724 0.123352 6.48913 0.318198L8.0478 3.6231L11.5335 4.15633C11.7388 4.18776 11.9094 4.33847 11.9734 4.54514C12.0374 4.7518 11.9838 4.97859 11.8351 5.13018L9.31339 7.70087L9.90853 11.3326C9.94363 11.5468 9.8595 11.7633 9.69151 11.891C9.52352 12.0187 9.30082 12.0355 9.11704 11.9344L6.00002 10.2188L2.88299 11.9344C2.69922 12.0355 2.47651 12.0187 2.30852 11.891C2.14054 11.7633 2.0564 11.5468 2.0915 11.3326L2.68664 7.70087L0.164889 5.13018C0.0161881 4.97859 -0.0374153 4.7518 0.026609 4.54514C0.0906331 4.33847 0.261186 4.18776 0.466582 4.15633L3.95224 3.6231L5.5109 0.318198C5.6028 0.123352 5.79241 0 6.00002 0Z" fill="#A98D4B" />
                                                                                    </svg>
                                                                                );
                                                                            })}
                                                                        ...
                                                                        <span className='date'>{new Date(data.updated_at).getDate()}/{new Date(data.updated_at).getMonth() + 1}/{new Date(data.updated_at).getFullYear()}
                                                                        </span>
                                ...
                                <div className={ssubtab.About == "active" ? "active personal" : "personal"} >
                                    ...
                                    {ssubtab.About == "active" ?
                                        <div className='editkids aboutdetail'>
                                            <div className='left2'>
                                                <label><span className='half'>
                                                    First Name </span><span><strong>{profile.first_name}</strong></span></label>
                                                <label><span className='half'>
                                                    Last Name </span><span><strong>{profile.last_name}</strong></span></label>
                                                {/* <label><span className='half'>
                                                    Date of birth </span><span><strong>{profile.dob}</strong></span></label> */}
                                            </div>
                                            <div className='right2'>
                                                <label><span className='half'>
                                                    City  </span><span><strong>{profile.city}</strong></span></label>
                                                <label><span className='half'>
                                                    ZIP code </span><span><strong>{profile.zip}</strong></span></label>
                                                <label><span className='half'>
                                                    Country </span><span><strong>{profile.country}</strong></span></label>
                                            </div>
                                        </div>
                                        : ""}
                                </div>
                                <div className={ssubtab.Job == "active" ? "active personal" : "personal"} >
                                    <h3 onClick={e => setssubtab({ ...ssubtab, Job: ssubtab.Job == "" ? "active" : "" })}>
                                        Education</h3>
                                    {ssubtab.Job == "active" ?
                                        <div className='editkids '>
                                            <div className='educationun'>
                                                <div className="left2">
                                                    <label><span className='half'>
                                                        Education Level </span><span className=''><strong>{profile.educationlevel}</strong></span></label>
                                                    <label><span className='half'>
                                                        School/ university </span><span><strong>{profile.school} </strong></span></label>
                                                    <label><span className='half'>
                                                        Year awarded </span><span><strong>
                                                            {profile.yearawarded} </strong></span></label>
                                                </div>
                                                <div className="right2">
                                                    <label>
                                        ...
                                        <div className='editkids editabout'>
                                            {profile.service_type && profile.service_type.tab1 ?
                                                <div className='nannyediy'>
                                                    ...
                                                    <label>
                                                        Years of work experience <span className='cir'>{profile.nanyyearexp}</span></label>
                                                    <br />
                                                    <br />
                                                </div>
                                                : ""}
                                            {profile.service_type && profile.service_type.tab2 ?
                                                <div className='nannyediy'>
                                                    <h2 className="border"><img src={window.location.origin + '/images/special_education.svg'} />Special education teacher  </h2>
                                                    <label>
                                                    ...
                                                    <label>
                                                        Years of work experience <span className='cir'>{profile.setyearexp}</span></label>
                                                    <br />
                                                    <br />
                                                </div>
                                                : ""}
                                            ...
                                            {profile.service_type && profile.service_type.tab3 ?
                                                <div className='nannyediy'>
                                                    <h2 className="border"><img src={window.location.origin + '/images/professional.svg'} />Special education paraprofessional  </h2>
                                                    <label>
                                                        Experience in Special Education Field </label>
                                                    <label><br /> <span>
                                                        {
                                                            profile.sepallapplicable != null && profile.sepallapplicable.map((e) => {
                                                                return (
                                                                    <strong>
                                                                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M0 10C0 4.47715 4.47715 0 10 0C15.5228 0 20 4.47715 20 10C20 15.5228 15.5228 20 10 20C4.47715 20 0 15.5228 0 10Z" fill="#A98D4B" />
                                                    ...
                                                    <label>
                                                        Years of work experience <span className='cir'>{profile.sepworkexp}</span></label>
                                                    <br />
                                                    <br />
                                                </div>
                                                : ""}
                                            ...
                                            {profile.service_type && profile.service_type.tab4 ?
                                                <div className='nannyediy'>
                                                    ...
                                                    <label>
                                                        Years of work experience <span className='cir'>{profile.tutorexp}</span></label>
                                                    <br />
                                                    <br />
                                        ...
                                        <div className='editkids editabout'>
                                            {profile.service_type && profile.service_type.tab1 ?
                                                <div className='nannyediy'>
                                                    <h2 className="border"><img src={window.location.origin + "/images/nany_pur.svg"} /> Nanny</h2>
                                                    <label>
                                                        Rate per hour<span><strong><b>{selfprofile.country == "Serbia" ? (usd.min * 100 + " - " + usd.max * 100) : ("$" + usd.min + " - " + usd.max)}</b></strong></span></label>
                                                    <br />
                                                    <br />
                                                </div>
                                                : ""}
                                            {profile.service_type && profile.service_type.tab2 ?
                                                <div className='nannyediy'>
                                                    <h2 className="border"><img src={window.location.origin + '/images/special_education.svg'} />Special education teacher </h2>
                                                    <label>
                                                        Rate per hour<span><strong><b>{selfprofile.country == "Serbia" ? usd3.min * 100 + " - " + usd3.max * 100 : "$" + usd3.min + " - " + usd3.max}</b></strong></span></label>
                                                    <br />
                                                    <br />
                                                </div>
                                                : ""}
                                            ...
                                            {profile.service_type && profile.service_type.tab3 ?
                                                <div className='nannyediy'>
                                                    <h2 className="border"><img src={window.location.origin + '/images/professional.svg'} /> Special education paraprofessional </h2>
                                                    <label>
                                                        Rate per hour<span><strong><b>{selfprofile.country == "Serbia" ? usd4.min * 100 + " - " + usd4.max * 100 : "$" + usd4.min + " - " + usd4.max}</b></strong></span></label>
                                                    <br />
                                                    <br />
                                                </div>
                                                : ""}
                                            ...
                                            {profile.service_type && profile.service_type.tab4 ?
                                                <div className='nannyediy'>
                                                    <h2 className="border"><img src={window.location.origin + '/images/tuter.svg'} />
                                                        Tutor</h2>
                                                    <label>
                                                        Rate per hour<span><strong><b>{selfprofile.country == "Serbia" ? tutorusd.min * 100 + " - " + tutorusd.max * 100 : "$" + tutorusd.min + " - " + tutorusd.max}</b></strong></span></label>
                                                    <h4>
                                                    ...
                                                    <label>
                                                        Providing online classes<span><strong><b><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            {profile.tutorintrestedonlinecls ? profile.tutorintrestedonlinecls : ""}</b></strong></span></label>
                                                    <br />
                                                    <br />
                                            ...
                                            <div className='preferred_school_jobs tutor'>
                                                ...
                                                <label>
                                                    <span>
                                                        {
                                                            profile.tutorallapplicable != null && profile.tutorallapplicable.map((e) => {
                                                                return (
                                                                    <>
                                                ...
                                                <label>
                                                    Years of experience as a teacher <span className='cir'>{profile.yearofexpasteacher}</span></label>
                                                <br />
                                                <br />
                                            </div>
                                            <div className='gernaledt'>
                                                ...
                                                <div className='left2'>
                                                    <label>
                                                        Preferred number of children to work with <span className='cir'>{profile.nanyworkwithnochild} </span></label>
                                                    <label>
                                                        Preferred child’s age<span><strong><b>{profile.nanyprefchildage != null && profile.nanyprefchildage.map((e, index) => {
                                                            return e.name + (profile.nanyprefchildage.length - 1 >= index + 1 ? ", " : "")
                                                        })}</b></strong></span></label>
                                                </div>
                                                <div className='right2'>
                                                    <label>
                                                        Start date<span><strong><b>{profile.nanystartdate} </b></strong></span></label>
                                                    <label>
                                                        Frequency<span><strong><b>{profile.nanyintrestedin} </b></strong></span></label>
                                                </div>
                                            </div>
                                        </div>
                                        : ""
                                ...
                                <div className={ssubtab.availability == "active" ? "active personal" : "personal"} >
                                    <h3 onClick={e => setssubtab({ ...ssubtab, availability: ssubtab.availability == "" ? "active" : "" })}>
                                        Availability</h3>
                                        ...
                                        <div className='calendershow'>
                                            <div className='calander'>
                                                ...
                                                <div className='calanderfull progilecl'>
                                                    {
                                                        calandertype == 1 ?
                                                            <Calander data={calender_data} data1={profile.fulltime} data2={"fulltime"} profile={"profile"} />
                                                            : ""
                                                    }{
                                                        calandertype == 2 ?
                                                            <Calander data={calender_data} data1={profile.beforeschool} data2={"beforeschool"} profile={"profile"} />
                                                            : ""
                                                    }{
                                                        calandertype == 3 ?
                                                            <Calander data={calender_data} data1={profile.afterschool} data2={"afterschool"} profile={"profile"} />
                                                            : ""
                                                    }{
                                                        calandertype == 4 ?
                                                            <Calander data={calender_data} data1={profile.overnight} data2={"overnight"} profile={"profile"} />
                                                            : ""
                                                    }
                                                    {
                                                        calandertype == 5 ?
                                                            <Calander data={calender_data} data1={profile.weekends} data2={"weekends"} profile={"profile"} />
                                                            : ""
                                                    }
                                                </div>
                                                    ...
                                                    <div className='form_group full' >
                                                        ...
                                                        {profile.englishlevel ?
                                                            <div className='language'>
                                                                ...
                                                                <ul>
                                                                    <li
                                                                        className={profile.englishlevel == "Beginner" ? "active" : ""}>Beginner</li>
                                                                    <li
                                                                        className={profile.englishlevel == "Intermediate" ? "active" : ""}>Intermediate</li>
                                                                    <li
                                                                        className={profile.englishlevel == "Fluent" ? "active" : ""}>Fluent</li>
                                                                    <li
                                                                        className={profile.englishlevel == "Native" ? "active" : ""}>Native</li>
                                                                </ul>
                                                            </div>
                                                            : ""}
                                                        {profile.frenchlevel ?
                                                            <div className='language'>
                                                                ...
                                                                <ul>
                                                                    <li
                                                                        className={profile.frenchlevel == "Beginner" ? "active" : ""}>Beginner</li>
                                                                    <li
                                                                        className={profile.frenchlevel == "Intermediate" ? "active" : ""}>Intermediate</li>
                                                                    <li
                                                                        className={profile.frenchlevel == "Fluent" ? "active" : ""}>Fluent</li>
                                                                    <li
                                                                        className={profile.frenchlevel == "Native" ? "active" : ""}>Native</li>
                                                                </ul>
                                                            </div>
                                                            : ""}
                                                        {profile.italianlevel ?
                                                            <div className='language'>
                                                                ...
                                                                <ul>
                                                                    <li
                                                                        className={profile.italianlevel == "Beginner" ? "active" : ""}>Beginner</li>
                                                                    <li
                                                                        className={profile.italianlevel == "Intermediate" ? "active" : ""}>Intermediate</li>
                                                                    <li
                                                                        className={profile.italianlevel == "Fluent" ? "active" : ""}>Fluent</li>
                                                                    <li
                                                                        className={profile.italianlevel == "Native" ? "active" : ""}>Native</li>
                                                                </ul>
                                                            </div>
                                                            : ""}
                                                        {profile.germanlevel ?
                                                            <div className='language'>
                                                                ...
                                                                <ul>
                                                                    <li
                                                                        className={profile.germanlevel == "Beginner" ? "active" : ""}>Beginner</li>
                                                                    <li
                                                                        className={profile.germanlevel == "Intermediate" ? "active" : ""}>Intermediate</li>
                                                                    <li
                                                                        className={profile.germanlevel == "Fluent" ? "active" : ""}>Fluent</li>
                                                                    <li
                                                                        className={profile.germanlevel == "Native" ? "active" : ""}>Native</li>
                                                                </ul>
                                                            </div>
                                                            : ""}
                                                        {profile.spanishlevel ?
                                                            <div className='language'>
                                                                ...
                                                                <ul>
                                                                    <li
                                                                        className={profile.spanishlevel == "Beginner" ? "active" : ""}>Beginner</li>
                                                                    <li
                                                                        className={profile.spanishlevel == "Intermediate" ? "active" : ""}>Intermediate</li>
                                                                    <li
                                                                        className={profile.spanishlevel == "Fluent" ? "active" : ""}>Fluent</li>
                                                                    <li
                                                                        className={profile.spanishlevel == "Native" ? "active" : ""}>Native</li>
                                                                </ul>
                                                            </div>
                                                            : ""}
                                                        {profile.chineselevel ?
                                                            <div className='language'>
                                                                ...
                                                                <ul>
                                                                    <li
                                                                        className={profile.chineselevel == "Beginner" ? "active" : ""}>Beginner</li>
                                                                    <li
                                                                        className={profile.chineselevel == "Intermediate" ? "active" : ""}>Intermediate</li>
                                                                    <li
                                                                        className={profile.chineselevel == "Fluent" ? "active" : ""}>Fluent</li>
                                                                    <li
                                                                        className={profile.chineselevel == "Native" ? "active" : ""}>Native</li>
                                                                </ul>
                                                            </div>
                                                            : ""}
                                                        {profile.otherlevel ?
                                                            <div className='language'>
                                                                <strong>Other language : {profile.otherlangname ? profile.otherlangname : ""}</strong>
                                                                <ul>
                                                                    <li
                                                                        className={profile.otherlevel == "Beginner" ? "active" : ""}>Beginner</li>
                                                                    <li
                                                                        className={profile.otherlevel == "Intermediate" ? "active" : ""}>Intermediate</li>
                                                                    <li
                                                                        className={profile.otherlevel == "Fluent" ? "active" : ""}>Fluent</li>
                                                                    <li
                                                                        className={profile.otherlevel == "Native" ? "active" : ""}>Native</li>
                                                                </ul>
                                                            </div>
                                                            : ""}
                                                    </div>
                                            ...
                                            {profile.service_type && profile.service_type.tab1 ?
                                                <div className='icon'>
                                                    <ul>
                                                        ...
                                                        <li ><span>Traveling with family</span>
                                                            <div className='icons'>
                                                                {habit.family == "false" ?
                                                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="#7D2B8B" xmlns="http://www.w3.org/2000/svg">
                                                                        <circle cx="20" cy="20" r="19.5" stroke="#7D2B8B" />
                                                ...
                                                : ""}
                                            <div className='nannyediy'>
                                                {profile.service_type && profile.service_type.tab1 && profile.livewithfamily ?
                                                    <div className='abrod'>
                                                        <label className='abrodd'>
                                                            ...
                                                            Living with the family <span>{profile.livewithfamily}</span></label>
                                                        <br />
                                                    </div> : ""}
                                                <div className='abrod'>
                                                    <label className='abrodd'>
                                                        ...
                                                        Work abroad <span>{profile.workingabroad} </span></label>
                                                </div>
                                            </div>
                ...
                <div className='mobilemenubottom'>
                    <div className="side_drop_collapse_box_content" onClick={e => {
                        localStorage.removeItem("side")
                        setprofilesection("")
                    }} style={profilesection == "notifications" ? { display: 'block' } : { display: 'none' }} >
                        <span onClick={e => {
                            localStorage.removeItem("side")
                            setprofilesection("")
                        }}></span>
                        {localStorage.getItem("user_type") == "parents" ?
                            <Notification_tab_parents setsubtab={setsubtab} subtab={subtab} profilesection={profilesection} />
                            :
                            <Notification_tab_provider setsubtab={setsubtab} subtab={subtab} profilesection={profilesection} />
                        }
                    ...
                    <div className="side_drop_collapse_box_content" style={profilesection == "Job_history" ? { display: 'block' } : { display: 'none' }} onClick={e => {
                        ...
                        <span onClick={e => setprofilesection(profilesection != "Job_history" ? "Job_history" : "")}></span>
                        {localStorage.getItem("user_type") == "parents" ?
                            <Job_history_tap_parents setsubtab={setsubtab} subtab={subtab} /> :
                            <Job_history_tap setsubtab={setsubtab} subtab={subtab} />
                        }
                    ...
                    <ul>
                        ...
                        }}><svg viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" width="20" height="22"><path fill-rule="evenodd" clip-rule="evenodd" d="M0 1.55556V12.4444C0 13.3 0.692222 14 1.55556 14H12.4444C13.3 14 14 13.3 14 12.4444V1.55556C14 0.7 13.3 0 12.4444 0H1.55556C0.692222 0 0 0.7 0 1.55556ZM9.33332 4.66573C9.33332 5.95684 8.2911 6.99906 6.99999 6.99906C5.70888 6.99906 4.66666 5.95684 4.66666 4.66573C4.66666 3.37462 5.70888 2.3324 6.99999 2.3324C8.2911 2.3324 9.33332 3.37462 9.33332 4.66573ZM7.0001 8.47839C5.44455 8.47839 2.33344 9.33395 2.33344 10.8895V11.6673H11.6668V10.8895C11.6668 9.33395 8.55566 8.47839 7.0001 8.47839Z" fill="#A98D4B"></path></svg>
                        ...
                        <Modal.Body>
                            <div className='promocode_content cancelmembership reportthanks'>
                                <div className=''>
                                    ...
                                    <br />
                                    <p className={"second"}><b>SensCare is taking your safety very seriously. Please allow us up to 48hrs to further investigate this inquiry. </b>  </p>
                                    <br />
                                    <p className='giveus'>In the meantime, please visit our  <Link to="/safety-center">Safety center</Link>and  <Link to="/faq">FAQ</Link> for more info. </p>
                    ...
                    <Modal show={survay} onHide={e => setsurvay(false)}>
                        <Modal.Body>
                            <div className='promocode_content cancelmembership report'>
                                <Link to="" onClick={e => setsurvay(false)}>+ </Link>
                                <svg onClick={e => setsurvay(true)} width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M20.6667 20.3333C20.6667 21.8 19.4667 23 18 23H13.1333C12.4133 23 11.7333 22.7133 11.2333 22.2067L6 16.8867C6 16.8867 6.6404 16.2201 6.86667 16.0533C7.09293 15.8866 7.19614 15.8784 7.39333 15.86C7.59052 15.8416 7.67333 15.9 7.79333 15.9667C7.82 15.9733 10.6667 17.6067 10.6667 17.6067V9.66667C10.6667 9.11333 11.1133 8.66667 11.6667 8.66667C12.22 8.66667 12.6667 9.11333 12.6667 9.66667V14.3333H13.3333V8C13.3333 7.44667 13.78 7 14.3333 7C14.8867 7 15.3333 7.44667 15.3333 8V14.3333H16V8.66667C16 8.11333 16.4467 7.66667 17 7.66667C17.5533 7.66667 18 8.11333 18 8.66667V14.3333H18.6667V10.6667C18.6667 10.1133 19.1133 9.66667 19.6667 9.66667C20.22 9.66667 20.6667 10.1133 20.6667 10.6667V20.3333Z" fill="#7D2B8B" />
                                </svg>
                                <h2>Report User</h2>
                                <div className='cancelmembershipp'>
                                    <p><b>In order to process your request, we need a little bit more information from you.</b></p>
                                    <div className="onepxline"></div>
                                    <p className={report.error != "" ? "active second" : "second"}>What is the reason you want to report this profile?  </p>
                                    <br />
                                    <ul>
                                        <li><input type={"radio"} id="survay" name='survay' onClick={e => setreport({ ...report, resion: "User sent an unsolicited message", error: "" })} /><span>User sent an unsolicited message </span></li>
                                        <li><input type={"radio"} id="survay" name='survay' onClick={e => setreport({ ...report, resion: "Security and verification issue", error: "" })} /><span> Security and verification issue</span></li>
                                    </ul>
                                    <p className='giveus'>Give us more details</p>
                                    <div className='comment'>
                                        <textarea className={report.resion == "other" && report.other == "" ? "bordererror" : ""} maxlength="70" onChange={e => setreport({ ...report, other: e.target.value, error: "" })}></textarea>
                                        <span >Number of characters  {70 - report.other.length}</span>
                                    </div>
                                    <div className="button text-center">
                                        <div className="pull-right">
                                            <button className="btn" onClick={e => reportset()}>Report User</button>
                                        </div>
                                        <div className="pull-right">
                                            <button className="btn confirm" onClick={e => setsurvay(false)}>Cancel</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <Modal show={false} onHide={e => setinterviewinvite(false)
                        ...
                        <Modal.Body>
                            <div className='promocode_content signout invite'>
                                ...
                                <p>Are you sure you want to send an Interview invite to <span style={{ color: "#A98D4B" }}>{profile.first_name + ' ' + profile.last_name}</span>? </p>
                                <div className="button text-center ">
                                    <div className="pull-right">
                                        <button className="btn" onClick={e => setinterviewinvite(false)}>Cancel</button>
                                    </div>
                                    <div className="pull-right">
                                        <button className="btn confirm" onClick={e => interview_invite()}>Send invite</button>
                                    </div>

                                </div>
                                {profile.anyallergies == "Yes" || profile.medicalcondition == "Yes" ?
                                    <div className="noteedit">
                                        <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.96979 0C4.55861 0 0.978516 3.584 0.978516 8C0.978516 12.416 4.55861 16 8.96979 16C13.381 16 16.9611 12.416 16.9611 8C16.9611 3.584 13.381 0 8.96979 0ZM9.76781 11.9984H8.16956V10.3984H9.76781V11.9984ZM8.16956 8.8H9.76781V4H8.16956V8.8Z" fill="#A98D4B"></path></svg>
                                        <span> <b>Note: </b> Our record indicates that the provider might have an allergy and/or medical condition  that you may want to discuss about during the interview.</span></div>
                                    : ""}
                            </div>
                        </Modal.Body>
                    </Modal > : ""
                    ...
                    <Modal show={interviewinvite} onHide={e => setinterviewinvite(false)
                        ...
                        <Modal.Body>
                            <div className='promocode_content signout invite request request2'>
                                ...
                                <ul>
                                    <li>
                                        <span>Send invite for:</span>
                                    </li>
                                    {
                                        jobs_list_profession.map((data, index) => {
                                           {console.log("Data for job ", index, ":", data);} 
                                            return (
                                                <li style={data.invitestatus == 1 ? { opacity: 0.6 } : {}} key={index}>
                                                    <input disabled={data.invitestatus == 1 ? true : false} type="radio" name="profession" onClick={e => setjob_id(data.id)} />
                                                    <span>{data.job_type == "Special Education Paraprofessional" ? "Paraprofessional" : data.job_type == "Special Education Teacher" ? "SPED teacher" : data.job_type}</span>
                                                </li>
                                            )
                                        })
                                    }
                                ...
                                <div className="button text-center ">
                                    ...
                                    <div className="pull-right">
                                        <button className="btn confirm" onClick={e => interview_invite()}>Send</button>
                                    </div>
                                </div>
                                {/* {profile.anyallergies == "Yes" || profile.medicalcondition == "Yes" ? */}
                                <div className="noteedit">
                                    <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M8.96979 0C4.55861 0 0.978516 3.584 0.978516 8C0.978516 12.416 4.55861 16 8.96979 16C13.381 16 16.9611 12.416 16.9611 8C16.9611 3.584 13.381 0 8.96979 0ZM9.76781 11.9984H8.16956V10.3984H9.76781V11.9984ZM8.16956 8.8H9.76781V4H8.16956V8.8Z" fill="#A98D4B"></path></svg>
                                    <span> <b>Note: </b> Our record indicated that the provider might have an allergy and/or medical condition  that you may want to discuss about during the meeting.</span></div>
                                {/* : ""} */}
                            </div>
                        </Modal.Body>
                    </Modal > : ""
                    ...
                    <Modal show={request} onHide={e => setrequest(false)
                        ...
                        <Modal.Body>
                            <div className='promocode_content signout invite request'>
                                ...
                                <p>To get to know your candidates better, send them a request for additional documents. </p>
                                <ul>
                                    <li>
                                        <input type="checkbox" name="" onClick={e => document_select("CV")} />
                                        <span>CV</span>
                                    </li>
                                    <li>
                                        <input type="checkbox" name="" onClick={e => document_select("Background check")} />
                                        <span>Background check</span>
                                    </li>
                                    <li>
                                        <input type="checkbox" name="" onClick={e => document_select("Recommendations")} />
                                        <span>Recommendations</span>
                                    </li>
                                    <li>
                                        <input type="checkbox" name="" onClick={e => document_select("Certificates")} />
                                        <span>Certificates</span>
                                    </li>
                                </ul>
                                <div className="button text-center ">
                                    <div className="pull-right">
                                        <button className="btn" onClick={e => setrequest(false)}>Cancel</button>
                                    </div>
                                    <div className="pull-right">
                                        <button className="btn confirm" onClick={e => recommendations()}>Send</button>
                                    </div>
            ...
            <Modal show={showflogin2} onHide={e => setshowflogin2(false)}>
                <Modal.Body>
                    <div className='promocode_content login_first'>
                        <Link to="" onClick={e => showflogin2(false)}>+ </Link>
            ...
            <Modal show={showfprovider2} onHide={e => setShowfprovider2(false)}>
                <Modal.Body>
                    <div className='promocode_content login_first'>
                        <Link to="" onClick={e => setShowfprovider2(false)}>+ </Link>
                                    ...
                                    <ul>
                                        <li>
                                            {photo != "" ?
                                                ...
                                                :
                                                <>
                                                    <img src={api + "/public/assets/images/users/" + selfprofile.file_path} alt="preview image" />
                                                    {/* <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            }
            {
                reviewmodel ?
                    <Modal show={reviewmodel} onHide={e => setreviewmodel(false)
                        ...
                        <Modal.Body>
                            <Send_review setrequest={setreviewmodel} slugdata={slugdata.id} username={profile.first_name + ' ' + profile.last_name} />
                        </Modal.Body>
                    </Modal > : ""
            }
            <Footer />
