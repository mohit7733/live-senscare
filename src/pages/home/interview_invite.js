...
export default function Interview_invite() {
                        ...
                        <tbody>
                            {
                                interview.map((data) => {
                                    return (
                                        <tr class={data.jobStatus != 1 ? data.parent_readstatus == 0 ? "unread" : "" : "close"} >
                                            <td class="view-message  dont-show">
                                                ...
                                                <span onClick={e => {
                                                    ...
                                                    <span class="username-text" onClick={e => {
                                                        navigate("/search-parents/" + slugdata.id + "/" + data.id)
                                                        setview(data.id)
                                                    }}> {data.ProviderName} </span>has just  {data.status == 1 ? "accepted" : data.status == 2 ? "declined" : "panding"} your interview invite
                                                </span>
                                            </td>
