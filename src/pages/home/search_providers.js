  ...
  const provider_list = (distance) => {
    ...
    fetch(
      api +
        ...
        (providerage.data1 != ""
          ? "&nanyprefchildage[]=" + providerage.data1
          : "&nanyprefchildage[]=") +
        (providerage.data2 != ""
          ? "&nanyprefchildage[]=" + providerage.data2
          : "&nanyprefchildage[]=") +
        (providerage.data3 != ""
          ? "&nanyprefchildage[]=" + providerage.data3
          : "&nanyprefchildage[]=") +
        (providerage.data4 != ""
          ? "&nanyprefchildage[]=" + providerage.data4
          : "&nanyprefchildage[]=") +
        "&carorlicence=" +
        search.carorlicence +
        "&backgroundstatus=" +
                          ...
                          <div className="children_number">
                            <ul>
                              ...
                              <li
                                ...
                                className={
                                  children2.data3 == t("twins") ? "active" : ""
                                }
                              >
                                {t("Twins")}
                              </li>
                              ...
                              <div className="option" id="cate5">
                                ...
                                <p>
                                  <input
                                    type="checkbox"
                                    onClick={(a) => {
                                      selectoption2(t("Older than 40 years"));
                                      if (a.target.checked) {
                                        setproviderage({
                                          ...providerage,
                                          data4: t("Older than 40 years"),
                                        });
                                      } else {
                                        setproviderage({
                                          ...providerage,
                          ...
                          <div className="checkbox create">
                            <ul>
                              <li>
                                ...
                                <span>
                                  {" "}
                                  {t("Has car or valid driver licence")}
                                </span>
                              </li>
                              <li>
                                <input
                ...
                <div className="distance">
                  <div className="distance_input">
                    ...
                    >
                      ...
                      {/* <option selected>{t("Distance")}</option>
                      <option value={5}>
                        5{" "}
                              ...
                              <div className="form_group   full">
                                <div className="customselect inp">
                                  ...
                                  <div
                                    className="overflow"
                                    id="over119"
                                    onClick={(e) => custom("cate8", "over119")}
                                  ></div>
                          ...
                          >
                            ...
                            <div className="nany_social">
                              ...
                              {data.docsStatus == "Yes" ? (
                                <img
                                  src={
                                    window.location.origin + "/images/ok.svg"
                                  }
                                  alt=""
                                />
                              ) : (
                        ...
                        <div className="second_sec">
                          <div className="post">
                            {data.service_type != null ? (
                              Object.values(data.service_type)[0] == "Nanny" || "Dadilja" ? (
                                <img
                                  src={
                                    window.location.origin +
            ...
            {subtab == "" ? (
              <div className="right_side_section">
                <div className="looking_for_candidate">
                  <h2>
                    {t("These are experienced candidates from your area")}
                  </h2>
                      ...
                      <div className="sortby">
                        ...
                        <div className="sortby_select">
                          <select name="" id="" onChange={(e) => short_by(e)}>
                            ...
                            <option value="Reviews">{t("Review")}</option>
                            <option value="Distance">{t("Distances.")}</option>
                            ...
                            <div className="second_sec">
                              ...
                              <div className="post_detail">
                                ...
                                <div className="post_fet">
                                  ...
                                  {/* <h5>
                                    {data.nanyintrestedin != null
                                    let nanyintrestedin = detail.nanyintrestedin; // Initialize the variable

                                    if (language === "sr") {
                                      switch (detail.nanyintrestedin) {
                                        case "Occasionally":
                                        ...
                                        case "Full time":
                                          ...
                                          break;
                                        default:
                                          nanyintrestedin = detail.nanyintrestedin;
                                      }
                                    }
                                  ...
                                  <h5>
                                    {data.nanyintrestedin != null
                                      ? (() => {
                                          let nanyintrestedin =
                                            data.nanyintrestedin; // Initialize the variable
          ...
          <Modal.Body>
            <div className="promocode_content cancelmembership">
              ...
              <div className="cancelmembershipp">
                ...
                <p className="second">
                  {t(
                    " Please tell us the reason you want to disable or delete your profile?"
                  )}
                </p>
                <br />
                <ul>
                  ...
                  <li>
                    <input
                      ...
                      onClick={(e) =>
                        setsurvaydata({
                          ...survaydata,
                          resion: "I didn't find a job",
                        })
                      }
                    />
                    <span> {t("I didn't find a job")}</span>
                  </li>
                  <li>
                    <input
                      type={"radio"}
                      ...
                      onClick={(e) =>
                        setsurvaydata({
                          ...survaydata,
                          resion: "I found a job somewhere else",
                        })
                      }
                    />
                    <span> {t("I found a job somewhere else")}</span>
                  </li>
                  <li>
                    <input
                      type={"radio"}
