...
function Search_parents() {
    ...
    }, [profile, list, category, error, speak, profilesection, password, deletewarning, photo])
    ...
    const provider_list = () => {
        ...
        fetch(api + "/api/" + (localStorage.getItem("token") == null ? "highratedjobs" : "v1/authhighratedjobs"), requestOptions)
            .then(response => response.json())
            .then(result => {
                console.log(result, " <<<<<<<<<<<<<<<<<<<<<<<<<<")
                let x = []
        ...
        if (e.target.value == "Reviews") {
            ...
            const sortedData = [...list2].sort((a, b) => {
                if (a.nanyperhrrate !== null && b.nanyperhrrate) {
                    return parseInt(b.nanyperhrrate.substr(b.nanyperhrrate.lastIndexOf('\\') + 1).split('-')[0]) - parseInt(a.nanyperhrrate.substr(a.nanyperhrrate.lastIndexOf('\\') + 1).split('-')[0])
                }
            });
            setlist(sortedData)
                            ...
                            <div className="filter_search">
                                <div className="advance_search_filter">
                                    <div className={"advance_search_filter_input Profile_complete " + (!catopen ? "op" : "")}>
                                        <span id="my-adv-filter" onClick={e => custom("filterdata")} >Advanced search</span>
                                        {advance_search !== false ?
                                            <div className='filters_search detail work-experience' id='filterdata' style={profile.about == "" || profile.about == null || !localStorage.getItem("token") ? { display: 'block' } : { display: 'none' }}>
                                                ...
                                                <div className='job_performance'>
                                                    <div className='form_group   full border'>
                                                        ...
                                                        <div className='customselect inp'>
                                                            {/* <TranslateComponent text='' className='keyword' type="text" value={children_age.map((e) => {
                                                                return <TranslateComponent text={e.name +","} /> 
                                                            })} /> */}
                                                            <div className='overflow' id='over2' onClick={e => custom2("cate5", "over2")} style={{ left: "-50%", top: "-51vh" }}></div>
                                                            <div className='option' id='cate5'>

                                                                <p ><input type="radio" onClick={a => selectoption2("0 - 1 years")} /><h3>0 - 1 years</h3><span></span></p>
                                                                <p ><input type="radio" onClick={a => selectoption2("4 - 7 years")} /><h3>4 - 7 years </h3><span></span></p>
                                                                <p ><input type="radio" onClick={a => selectoption2("8 - 10 years")} /><h3>8 - 10 years </h3><span></span></p>
                                                                <p ><input type="radio" onClick={a => selectoption2("11 - 15 years")} /><h3>11 - 15 years </h3><span></span></p>
                                                                <p ><input type="radio" onClick={a => selectoption2("16+  years")} /><h3>16+  years </h3><span></span></p>
                                                            </div>
                                                ...
                                                <div className='form_group full qualification'>
                                                    ...
                                                    <div className='checkbox create'>
                                                        <ul>
                                                            ...
                                                            }} /><span>Without transportation </span></li>
                                                            <li><input type="radio" name="" onClick={e => {
                                                                setsearch({ ...search, jobposted: e.target.checked })
                                                            }} /><span>Jobs posted within a week </span></li>
                                                            <li><input type="radio" name="" onClick={e => {
                                                                if (e.target.checked) {
                                        ...
                                        <div className='job_performance'>
                                            <div className='form_group   full'>
                                                <div className='customselect inp' >
                                                    ...
                                                    />
                                                    <div className='overflow' id='over3' onClick={e => custom2("cate6", "over3")} ></div>
                                                    <div className='option' id='cate6' >
                                                        ...
                                                        }} checked={cat.data1 == "Nanny" ? true : false} /><h3>
                                                        ...
                                                        }} checked={cat.data2 == "Special education teacher" ? true : false} /><h3>
                                                                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <circle cx="15" cy="15" r="15" fill="#fff" />
                                                                    <circle cx="15" cy="15" r="15" fill="#fff" />
                                                        ...
                                                        }} checked={cat.data3 == "Special education paraprofessional" ? true : false} /><h3>
                                                                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <circle cx="15" cy="15" r="15" fill="#fff" />
                                                        ...
                                                        }} checked={cat.data4 == "Tutor" ? true : false} /><h3>
                                                                <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <circle cx="15" cy="15" r="15" fill="#fff" />
                                                                    <circle cx="15" cy="15" r="15" stroke="#fff" />
                                            ...
                                            <div className='job_performance'>
                                                <div className='form_group   full'>
                                                    <div className='customselect inp' >
                                                        ...
                                                        <div className='overflow' id='over4' onClick={e => custom2("cate7", "over4")} ></div>
                                                            ...
                                                            <div className='job_performance'>
                                                                <div className='form_group   full'>
                                                                    <div className='customselect inp' >
                                                                        ...
                                                                        <div className='overflow' id='over5' onClick={e => custom("cate8", "over5")} ></div>
                                                                        ...
                                                                        <span onClick={e => custom("cate8", "over5")}>
                                                                            <svg width="10" height="6" viewBox="0 0 10 6" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                                <path d="M5.22299 0.247873L9.54938 5.05497C9.72313 5.24803 9.58612 5.55566 9.32639 5.55566L0.673609 5.55566C0.413877 5.55566 0.27687 5.24803 0.450621 5.05497L4.77701 0.247873C4.89618 0.115459 5.10382 0.115459 5.22299 0.247873Z" fill="#7D2B8B" />
                                                                            </svg>
                                                                        </span>
                                                        ...
                                                        <div className='filters_search detail work-experience' id='filterdata' >
                                                            ...
                                                            <button onClick={e => {
                                                                ...
                                                                // }, 300);
                                                                    ...
                                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M9.00005 2.20704C5.13404 2.20704 2.00001 5.34107 2.00001 9.20708C2.00001 13.0731 5.13404 16.2071 9.00005 16.2071C12.8661 16.2071 16.0001 13.0731 16.0001 9.20708C16.0001 5.34107 12.8661 2.20704 9.00005 2.20704ZM0 9.20708C0 4.23649 4.02946 0.207031 9.00005 0.207031C13.9706 0.207031 18.0001 4.23649 18.0001 9.20708C18.0001 14.1777 13.9706 18.2071 9.00005 18.2071C4.02946 18.2071 0 14.1777 0 9.20708Z" fill="#fff" />
                                                                    <path fill-rule="evenodd" clip-rule="evenodd" d="M13.9433 14.1503C14.3338 13.7598 14.967 13.7598 15.3575 14.1503L19.7075 18.5003C20.0981 18.8909 20.0981 19.524 19.7075 19.9146C19.317 20.3051 18.6838 20.3051 18.2933 19.9146L13.9433 15.5645C13.5528 15.174 13.5528 14.5408 13.9433 14.1503Z" fill="#fff" />
                ...
                {subtab == "" ?
                    <>
                        <div className="mobile_looking_for_candidate">
                            <h2>{!localStorage.getItem("token") && !localStorage.getItem("id") ? "These families and schools are looking for candidates like you" : "These are job offers in your area"}</h2>
                        </div>
                                        ...
                                        return (
                                            <div className="mobile_looking_for_candidate_box">
                                                <div className="head_part">
                                                    ...
                                                    }}>{data.title !== null ? data.title : ""} </h3>
                                                    {data.plateformonsocialmedia == "Yes" ?
                                                        <Facebook_share link={window.location.origin + "/profile-parents/" + data.id} />
                                                        : ""}
                                                </div>
                                                ...
                                                <div className="main_sec">
                                                    <div className="first_sec">
                                                        <div className="image_sec" >
                                                            <img onClick={e => {
                                                                navigate("/profile-parents/" + data.id)
                                                            }} src={data.file_path !== null ? api + "/public/assets/images/users/" + data.file_path : window.location.origin + "/img/nany_img.png"} alt="" />
                                                            <div className="heart_sec">
                                                                {localStorage.getItem("user_type") !== "parents" ?
                                                                    <Favorite_select id={data.jobId} username={data.first_name} heart2={data.favorNot} />
                                                                    : ""
                                                                }
                                                    ...
                                                    <div className="second_sec">
                                                        ...
                                                        {data.service_type !== null && Object.values(data.service_type)[1] ?
                                                            <>
                                                                <div className="post">
                                                                    ...
                                                                    <h5>{data.service_type !== null ? Object.values(data.service_type)[1] == "Special Education Paraprofessional" ? "Paraprofessional" : Object.values(data.service_type)[1] == "Special Education Teacher" ? "SPED teacher" : Object.values(data.service_type)[1] : ""}
                                                                        {/* {Object.values(data.service_type) + ","} */}
                                                                    </h5>
                                                                </div>
                                                                <div className="post">
                                                        ...
                                                        <div className="post">
                                                            ...
                                                            <h5>{data.tutorintrestedin !== null ? data.tutorintrestedin : "Full time"} </h5>
                                                        </div>
                                                        <div className="post">
                                    ...
                                    {edit == "" ?
                                        <div className='detail'>
                                            <ul>
                                                ...
                                                <li><span className='main'>
                                                    Last Name</span><span className='data'>{profile.last_name}</span></li>
                            ...
                            {ssubtab.payment == "active" ?
                                <div className='cardstype'>
                                    ...
                                    <div className='activeplan'>
                                        <ul>
                                            <li>
                                                <label>Current membership plan <span>{membership ? membership : "Plannotactive"} </span></label>
                    ...
                    <div className="body_section searchbody" style={subtab !== "" ? { minHeight: "auto", marginBottom: "100px", float: "left", width: "100%" } : {}} >
                                ...
                                <>
                                    ...
                                    <div className="silde_bar_dropdowns">
                                        ...
                                        <button type="button" className="side_drop_collapse" onClick={e => setprofilesection(profilesection !== "message" ? "message" : "")}><img src={window.location.origin + "/images/message.svg"} alt="" />
                                            <h4>Messages<span> (<Count_message />)</span></h4>
                                        </button>
                                        ...
                                        <button type="button" className="side_drop_collapse" onClick={e => setprofilesection(profilesection == "" ? "setting" : "")}><img src={window.location.origin + "/images/setting.svg"} alt="" />
                                            <h4>Settings</h4>
                                        </button>
                                        <div className="side_drop_collapse_box_content" style={profilesection == "setting" ? { display: 'block' } : { display: 'none' }}>
                                            <ul>
                        ...
                        {subtab == "" ?
                            <div className="right_side_section" >
                                <div className="looking_for_candidate">
                                    <h2>{!localStorage.getItem("token") && !localStorage.getItem("id") ? "These families and schools are looking for candidates like you" : "These are job offers in your area"}
                                    </h2>
                                    <div className="looking_for_candidate_filter_sec">
                                        <div className="result">
                                            <p>{list.length} <span>
                                                result{list.length > 1 ? "s" : ""}</span></p>
                                        </div>
                                                ...
                                                return (
                                                    <div className="looking_for_candidate_boxs">
                                                        <div className="looking_for_candidate_box">
                                                            <div className="first_sec">
                                                                <div className="image_sec" >
                                                                    ...
                                                                    <div className="heart_sec">
                                                                        {localStorage.getItem("user_type") !== "parents" ?
                                                                            <Favorite_select id={data.jobId} heart2={data.favorNot} username={data.first_name} />
                                                                            : ""
                                                                        }
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div className="second_sec">
                                                                ...
                                                                <div className="post_detail">
                                                                        ...
                                                                        <>
                                                                            ...
                                                                            <div className="post_pay">
                                                                                ...
                                                                                {profile && profile.country == "Serbia" ? <h5>{data.tutorperhrrate ?
                                                                                    ...
                                                                                    : ""}
                                                                                    /hour </h5>
                                                                                    : <h5>${data.tutorperhrrate ? data.tutorperhrrate : ""}
                                                                                        /hour </h5>
                                                                                }
                                                                            </div>
                                                                            <div className="vi"></div>
                                                                    ...
                                                                    <div className="post_fet">
                                                                        <img src={window.location.origin + "/images/post_fet.svg"} alt="" />
                                                                        <h5>{data.tutorintrestedin !== null ? data.tutorintrestedin : ""} </h5>
                                                                    </div>
                                                                    <div className="vi"></div>
                                                                ...
                                                                ) : ""}   {data.description !== null && data.description.length > 100 ? <span onClick={e => {
                                                                    setplink(true)
                                                        ...
                                                        <p id={"plink" + index} className="hide">
                                                            Please refer to our  <Link to="/faq"> FAQ</Link> and  <Link to="/safety-center">Safety center</Link> to read safety tips.</p>
...

                                    {
                                        list.length == 0 && noresult !== "" ?
                                            <div className="noresult">
                                                <h3>
                                                    Sorry your search returned no results.</h3>
                                ...
                                <div className="mob_update_to_premium">
                                    ...
                                    // }}
                                    >
                                        Upgrade to premium</Link> <span><img src={window.location.origin + "/images/upgrade_right_side.svg"} alt="" /></span></h2>
                                    <h3>
                                        Appear higher in search results and find your perfect
                                        {localStorage.getItem("user_type") == "parents" ? " candidate" : " job today"}</h3>
                                </div>
                                <div className="update_to_premium">
                                    <h2><img src={window.location.origin + "/images/upgrade_icon.svg"} alt="" />
                                        Appear higher in search results and find your perfect
                                ...
                                <div className={"interested_fam  " + (interested.length < 5 ? "main-header" : "")} >
                                    {/* <h2>
                                        No Results </h2> */}
                                    {interested?.length > 0 ? <p>
                                        View popular candidates in your area</p> : ""}
                                                ...
                                                interested?.map((data, index) => {
                                                    ...
                                                    if (data.status == 0) {
                                                        return (<div className="interested_fam_box " style={{ marginBottom: "30px" }}>
                                                            <div className="image_sec">
                                                                <img src={data2.file_path !== null ? api + "/public/assets/images/users/" + data2.file_path : window.location.origin + "/img/nany_img.png"} alt="" />
                                                                <div className="heart_sec">
                                                                    {localStorage.getItem("user_type") !== "parents" ?
                                                                        <Favorite_select id={data.id} username={data2.first_name} heart2={data.favornotprofile} />
                                                                        : ""}
                                                                </div>
                                                            </div>
                                                            <div className="general_sec">
                                                                ...
                                                                <div className="detail_sec">
                                                                    ...
                                                                    {profile && profile.country == "Serbia" ? <p>{data2.nanyperhrrate !== null ?
                                                                        ...
                                                                        : data2.tutorperhrrate ?
                                                                            ...
                                                                            : ""} /hour</p>
                                                                        : <p>${data2.nanyperhrrate !== null ? data2.nanyperhrrate : data2.tutorperhrrate ? data2.tutorperhrrate : ""}/hour </p>
                                                                    }
                                                                </div>
                                                                <div className="detail_sec">
                                                                    <img src={window.location.origin + "/images/post_rang.svg"} alt="" />
                                                                    <p>{data2.nanyyearexp !== null ? data2.nanyperhrrate : data2.setyearexp !== null ? data2.setyearexp : data2.tutorexp !== null ? data2.tutorexp : data2.yearofexpasteacher !== null ? data2.yearofexpasteacher : "0"}
                                                                        yrs of exp </p></div>
                                                                <div className="detail_sec">
                                                                    <img src={window.location.origin + "/images/post_loc.svg"} alt="" />
                        ...
                        {subtab == "my-profile" ?
                            <div className='Account daskshow'>
                                        ...
                                        <>
                                            <div className='withoutedit'>
                                                ...
                                                {edit == "" ?
                                                    <div className='detail'>
                                                        <ul>
                                                            <li className='disabledata'><span className='main'>
                                                                First Name</span><span className='data'>{profile.first_name}</span></li>
                                                            <li><span className='main'>
                                                                Address</span><span className='data'>{profile.address}</span></li>
                                                            <li><span className='main'>
                                                                Last Name</span><span className='data'>{profile.last_name}</span></li>
                                                            <li><span className='main'>
                                                                City</span><span className='data'>{profile.city}</span></li>
                                                            <li className='disabledata'><span className='main'>
                                                                Date of birth</span><span className='data'>{profile.dob}</span></li>
                                                            <li><span className='main'>
                                                                ZIP code</span><span className='data'>{profile.zip}</span></li>
                                                            <li><span className='main'>
                                                                Mobile</span><span className='data'>{(contact_code.code == "" ? profile.countrycode : contact_code.code) + "-" + profile.phone}</span></li>
                                                            <li><span className='main'>
                                                                Country</span><span className='data'>{profile.country}</span></li>
                                                            <li><span className='main'>
                                                                Email </span><span className='data'>{profile.email}</span></li>
                                                        </ul>
                                                    </div>
                                                    :
                                                    <div className="panel-body">
                                                                    ...
                                                                    <div className="row coln">
                                                                        <div className="col-md-6">
                                                                            ...
                                                                            <label className="label" for="city">
                                                                                City</label>
                                                                            <input type="text" className="form-control" id="city" data-required onChange={e => setprofile({ ...profile, city: e.target.value })} value={profile.city} />
                                                                        </div>
                                                        ...
                                                        <div className="button text-center">
                                                            ...
                                                            <div className="pull-right">
                                                                <button className="btn confirm" onClick={e => updateprofile()}>
                                                                    Save changes</button>
                                                            </div>
                                ...
                                <div className={ssubtab.payment == "active" ? "active personal" : "personal"} >
                                    <h3 onClick={e => setssubtab({ ...ssubtab, payment: ssubtab.payment == "" ? "active" : "" })}>
                                        Payment and Membership</h3>
                                    {ssubtab.payment == "active" ?
                                        <div className='cardstype'>
                                            <div className='paymenttype'>
                                                <ul>
                                            ...
                                            <div className='savecard'>
                                                <ul>
                                                    <li>
                                                        ...
                                                        <label for="c"> <input type="radio" id='c' name='c' /><span>
                                                            Set as default</span></label>
                                                        <span>
                                                            Card name</span>
                                                        <p>
                                                            Bankname card ****4589</p>
                                                        <span>
                                                            Expires on</span>
                                                        <p>04/2022</p>
                                                        <button>
                                                    ...
                                                    <li>
                                                        <label for="d"> <input type="radio" id='d' name='c' /><span>
                                                            Set as default</span></label>
                                                        <span>
                                                            Card name</span>
                                                        <p>
                                                    ...
                                                    <li>
                                                        <label for="e"> <input type="radio" id='e' name='c' /><span>
                                                            Set as default</span></label>
                                                        <span>
                                                            Card name</span>
                                                        <p>
                                            ...
                                            <div className='activeplan'>
                                                <ul>
                                                    <li>
                                                        <label>
                                                            Current membership plan <span> {membership ? membership : "Plan not active"} </span></label>
                                                        <button onClick={e => setcancelmembership(true)}>
                                                            Cancel plan</button>
                                                        <NavLink to={""}
                                                        // {localStorage.getItem("user_type") == "parents" ? "/parents-membership" : "/provider-membership"} target="_blank"
                                                        >  <button >
                                                                Change plan</button></NavLink>
                                                    </li>
                                                    <li>
                                                        <label>
                                                            Subscription</label>
                                ...
                                <div className={ssubtab.delete == "active" ? "active personal" : "personal"} >
                                    <h3 onClick={e => setssubtab({ ...ssubtab, delete: ssubtab.delete == "" ? "active" : "" })}>
                                        Deactivate/ Delete account</h3>
                                    {ssubtab.delete == "active" ?
                                        <div className='activeplan deletedeactivate'>
                                            <ul>
                                                <li>
                                                    <label>
                                                        Current account status plan <span>{profile.account_status == "ENABLE" ? "Active" : "Inactive"}</span></label>
                        ...
                        <div className='promocode_content younger reset reset2' style={{ paddingBottom: "40px" }}>
                            ...
                            <div className="pdng" >
                                    ...
                                    <div className='form_group'>
                                        ...
                                        {error.n_password || error.n_password ?
                                            <div className='password_rule errorfield '>
                                                <p>
                                                    Your password must be between 8-15 characters long and contain<br />
                                ...
                                <div className='buttons reset3'>
                                    <button className='rest' disabled={!verfied} onClick={changepassword}>
                                        Change</button>
                ...
                <Modal show={showsuccess} onHide={e => setshowsuccess(false)}>
                    <Modal.Body>
                        <div className='promocode_content successpass'>
                            ...
                            <p>
                                Your password is updated. Log in with your new password.</p>
                        ...
                        <div className='promocode_content younger reset reset2 paymentedit' style={{ paddingBottom: "40px" }}>
                                ...
                                <form>
                                    <div className="row">
                                        ...
                                        <div className="form-group col-md-6">
                                            ...
                                            <div className="field-box">
                                                <div className="row coln">
                                                    <div className='bgremove' onClick={e => setcountryedit(!countryedit)}></div>
                                        ...
                                        <div className="form-group col-md-6">
                                            <div className="field-box">
                                                <label className="label" for="cardnumber">
                                                    Card Number</label>
                                                <input type="number" placeholder="1234 56789" className="form-control" id="cardnumber"
                                            ...
                                            <div className="field-box">
                                                <div className="row coln">
                                                    <div className="col-md-6">
                                                        ...
                                                        <input type="number" placeholder="MM/YY" className="form-control" id="expdate"
                                            ...
                                            <div className="row coln field-box">
                                                ...
                                                <div className="col-md-6">
                                                    ...
                                                    <label className="label" for="zipCode">
                                                        ZIP Code</label>
                                                    <input type="number" placeholder="12533665" className="form-control" id="zipCode" />
                            ...
                            <div className="panel-body mobileshow" style={{ padding: "30px" }}>
                                ...
                                <form>
                                    ...
                                    <div className="save-info field-box">
                                        <input type="checkbox" id="option1" name="option1" value="" />
                                        <label><img className="tickicon1" src={window.location.origin + "/images/check.svg"} alt="" />
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="form-group col-md-6">
                                            <div className="field-box">
                                                <label className="label" for="cardname">
                                                    Name on card</label>
                                                <input placeholder="Name" type="text" className="form-control" id="cardname" data-required />
                                            </div>
                                            <div className="field-box">
                                                <label className="label" for="billaddress">
                                                    Billing address</label>
                                                <input placeholder="Address" type="text" className="form-control" id="billaddress" />
                                            </div>
                                            <div className="field-box">
                                                <div className="row coln">
                                                    <div className="col-md-6" style={{ position: 'relative' }}>
                                        ...
                                        <div className="form-group col-md-6">
                                            <div className="field-box">
                                                <label className="label" for="cardnumber">
                                                    Card Number</label>
                                                <input placeholder="1234 56789" type="number" className="form-control" id="cardnumber"
                                                    maxLength="16" data-required />
                                            </div>
                                            <div className="field-box">
                                                <div className="row coln">
                                                    <div className="col-md-6">
                                                        ...
                                                        <label className="label" for="expdate">
                                                            Expiration Date</label>
                                                        <input placeholder="MM/YY" type="number" className="form-control" id="expdate"
                                                            maxLength="4" data-required />
                                            ...
                                            <div className="row coln field-box">
                                                <div className="col-md-6">
                                                    ...
                                                    <label className="label" for="city">
                                                        City</label>
                                                    <input placeholder="New York" type="text" className="form-control" id="city" data-required />
                        ...
                        <div className='promocode_content cancelmembership'>
                            ...
                            <div className='cancelmembershipp'>
                                <p><span>
                                    ...
                                    Are you sure you want to cancel? If you cancel your membership, you will lose your discount offers via Senscare Loyalty Program.</p>
                                <div className="button text-center">
                                    <div className="pull-right">
                                        <button className="btn" onClick={e => setcancelmembership(false)}>
                                            Confirm</button>
                                    </div>
                                    <div className="pull-right">
                                        <button className="btn confirm" onClick={e => setcancelmembership(false)}>
                                            Close</button>
                                    </div>
                                </div>
                            </div>
                ...
                <Modal show={disableaccoutn} onHide={e => setdisableaccoutn(false)}>
                    <Modal.Body>
                        <div className='promocode_content cancelmembership'>
                            ...
                            <div className='cancelmembershipp'>
                                <p>
                                    By disabling your account, your profile will be on temporary hold. </p>
                                <div className="button text-center">
                                    <div className="pull-right">
                                    ...
                                    <div className="pull-right">
                                        <button className="btn confirm" onClick={e => setdisableaccoutn(false)}>
                                            Cancel</button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <Modal.Body>
                        <div className='promocode_content cancelmembership deletemodel'>
                            ...
                            <div className='cancelmembershipp'>
                                ...
                                <ul>
                                    <li><img className="crossicon" src={window.location.origin + "/images/cancel.svg"} alt="" />
                                        All your contacts will be inaccessible. </li>
                                    <li><img className="crossicon" src={window.location.origin + "/images/cancel.svg"} alt="" />
                                        All your employment history will be deleted.</li>
                                    <li><img className="crossicon" src={window.location.origin + "/images/cancel.svg"} alt="" />
                                        All your messages, its favorites, and reviews will be erased.</li>
                                    <li><img className="crossicon" src={window.location.origin + "/images/cancel.svg"} alt="" />
                                        None of your recommendations will be available for download.</li>
                                </ul>
                                <div className="button text-center">
                                    <div className="pull-right">
                                        <button className="btn" onClick={e => {
                                    ...
                                    <div className="pull-right">
                                        <button className="btn confirm" onClick={e => setdeletewarning(false)}>
            ...
            <Modal show={survay} onHide={e => emailsurvay()}>
                <Modal.Body>
                    <div className='promocode_content cancelmembership'>
                        ...
                        <div className='cancelmembershipp'>
                            <p><b>
                                In order to make our service better for our clients, we need a little bit more information from you.</b></p>
                            <div className="onepxline"></div>
                            <p className='second'>
                                Please tell us the reason you want to disable or delete your profile?</p>
                            <br />
                            <ul>
                                <li><input type={"radio"} id="survay" name='survay' onClick={e => setsurvaydata({ ...survaydata, resion: "It’s too expensive" })} /><span>
                                    It’s too expensive </span></li>
                                <li><input type={"radio"} id="survay" name='survay' onClick={e => setsurvaydata({ ...survaydata, resion: "I didn't find a candidate" })} /><span>
                                    I didn't find a candidate</span></li>
                                <li><input type={"radio"} id="survay" name='survay' onClick={e => setsurvaydata({ ...survaydata, resion: "I found a candidate somewhere else" })} /><span>
                                    I found a candidate somewhere else
                                </span></li>
                                <li><input type={"radio"} id="survay" name='survay' onClick={e => setsurvaydata({ ...survaydata, resion: "other" })} /><span>
                                    Other</span></li>
                            </ul>
                            <div className='comment'>
                                ...
                                <span >
                                    Number of characters {70 - survaydata.other.length}</span>
                            </div>
                            <div className="button text-center">
                                <div className="pull-right">
                            ...
                            <div className='promocode_content cancelmembership deletemodel'>
                                ...
                                <div className='cancelmembershipp'>
                                    ...
                                    <div className="button text-center">
                                        ...
                                        <div className="pull-right">
                                            <button className="btn confirm" onClick={e => setaccountdelete(false)}>
                                                Cancel</button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <Modal show={sorry} className="sorryto" onHide={e => window.location.replace("/")}>
                        <Modal.Body>
                            <div className='promocode_content cancelmembership '>
                                ...
                                <h2><img src='./images/return.png' /><br />
                                    We are sorry to see you go!</h2>
                                <p>
                                    You can <Link to={'/signup'}>
                                        come back</Link>
                                    anytime.</p>
                            </div>
                        </Modal.Body>
            ...
            <Modal show={showflogin} onHide={e => setshowflogin(false)}>
                <Modal.Body>
                    <div className='promocode_content login_first'>
                        <Link to="" onClick={e => setshowflogin(false)}>+ </Link>
                        <h2>
                            Complete your profile and find the perfect candidate</h2>
                        <img src='./images/landing.png' />
                        <p>
                            Answer a few questions to help you find the candidates that are just right for you!</p>
                        <button><Link to={"/complete-parents-profile"} >
                            Complete Profile</Link ></button>
                    </div>
                </Modal.Body>
            </Modal>
            <Modal show={showfprovider2} onHide={e => setShowfprovider2(false)}>
                <Modal.Body>
                    <div className='promocode_content login_first'>
                        ...
                        <h2>
                            Complete your profile and get a perfect job</h2>
                        <img src='./images/landing.png' />
                        <p>
                            Answer a few questions to make it easier to find jobs that are just made for you!</p>
                        <button><Link to={"/complete-provider-profile"} >
                            Complete Profile</Link ></button>
                    </div>
                </Modal.Body>
            </Modal>
                            ...
                            <div className='promocode_content cancelmembership uploadphoto'>
                                <div className=''>
                                    ...
                                    <div className="button text-center">
                                        ...
                                        <div className="pull-right">
                                            <button className="btn confirm" onClick={e => profile_update()}>
                                                Upload photo</button>
                                        </div>
                                    </div>
                                    <br />
